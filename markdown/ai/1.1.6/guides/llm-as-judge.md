---
title: "LLM Response Evaluation with LLM-as-a-Judge"
source: "ROOT:guides/llm-as-judge.adoc"
---
...
Research [shows](https://arxiv.org/pdf/2306.05685) that sophisticated judge models can align with human judgment up to 85%, which is actually higher than human-to-human agreement (81%).

Spring AI’s [Recursive Advisors](../api/advisors-recursive.md) provide an elegant framework for implementing LLM-as-a-Judge patterns, enabling you to build self-improving AI systems with automated quality control.

> [!TIP]
> Find the full example implementation in the [evaluation-recursive-advisor-demo](https://github.com/spring-projects/spring-ai-examples/tree/main/advisors/evaluation-recursive-advisor-demo).

<a id="_understanding_llm_as_a_judge"></a>
...
<a id="_choosing_the_right_judge_model"></a>
...
The [Judge Arena Leaderboard](https://huggingface.co/spaces/AtlaAI/judge-arena) tracks the performance of various models specifically for judging tasks.

<a id="_implementation_with_recursive_advisors"></a>

## Implementation with Recursive Advisors

Spring AI’s [ChatClient](../api/chatclient.md) provides a fluent API ideal for implementing LLM-as-a-Judge patterns.
Its [Advisors system](../api/advisors.md) allows you to intercept, modify, and enhance AI interactions in a modular, reusable way.

The [Recursive Advisors](../api/advisors-recursive.md) take this further by enabling looping patterns that are perfect for self-refining evaluation workflows:
...
<a id="_the_selfrefineevaluationadvisor"></a>

## The SelfRefineEvaluationAdvisor

![Self Refine Evaluation Advisor](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.6/spring-ai-docs/src/main/antora/modules/ROOT/images/https://raw.githubusercontent.com/spring-io/spring-io-static/refs/heads/main/blog/tzolov/20251031/spring-ai-evaluation-advisor.png)
...
(Based on the article: [Using LLM-as-a-judge for an automated and versatile evaluation](https://huggingface.co/learn/cookbook/en/llm_judge#3-improve-the-llm-judge))
...
<a id="_key_implementation_features"></a>
...
Using Spring AI’s [structured output](../api/structured-output-converter.md) capabilities, the evaluation results are parsed into an `EvaluationResponse` record with rating (1-4), evaluation rationale, and specific feedback for improvement.
...
Set `spring.ai.chat.client.enabled=false` to enable [Working with Multiple Chat Models](../api/chatclient.md#_working_with_multiple_chat_models).
...
> [!TIP]
> The complete runnable demo with configuration examples, including different model combinations and evaluation scenarios, is available in the [evaluation-recursive-advisor-demo](https://github.com/spring-projects/spring-ai-examples/tree/main/advisors/evaluation-recursive-advisor-demo) project.

<a id="_best_practices"></a>

## Best Practices

![Spring AI Advisors Chain](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.6/spring-ai-docs/src/main/antora/modules/ROOT/images/https://raw.githubusercontent.com/spring-io/spring-io-static/refs/heads/main/blog/tzolov/20251031/spring-ai-advisors-chain2.png)

The critical success factors when implementing the LLM-as-a-Judge technique include:

- **Use dedicated judge models** for better performance (see [Judge Arena Leaderboard](https://huggingface.co/spaces/AtlaAI/judge-arena))
...
- [Advisors](../api/advisors.md)
- [ChatClient](../api/chatclient.md)
- [Structured Output](../api/structured-output-converter.md)
- [Model Evaluation](../api/testing.md)
...
- [LLM Response Evaluation with Spring AI Blog Post](https://spring.io/blog/2025/11/10/spring-ai-llm-as-judge)
- [Spring AI Recursive Advisors Blog](https://spring.io/blog/2025/11/04/spring-ai-recursive-advisors)
- [Evaluation Advisor Demo Project](https://github.com/spring-projects/spring-ai-examples/tree/main/advisors/evaluation-recursive-advisor-demo)
...
- [Judge’s Verdict: A Comprehensive Analysis of LLM Judge Capability Through Human Agreement](https://arxiv.org/abs/2510.09738v1)
- [LLMs-as-Judges: A Comprehensive Survey on LLM-based Evaluation Methods](https://arxiv.org/abs/2412.05579)
- [From Generation to Judgment: Opportunities and Challenges of LLM-as-a-judge (2024)](https://arxiv.org/abs/2411.16594)
- [LLM-as-a-Judge Resource Hub](https://llm-as-a-judge.github.io)
