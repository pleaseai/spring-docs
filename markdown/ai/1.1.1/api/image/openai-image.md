...
| spring.ai.openai.image.options.model | The model to use for image generation. | OpenAiImageApi.DEFAULT\_IMAGE\_MODEL |
...
| spring.ai.openai.image.options.response\_format | The format in which the generated images are returned. Must be one of URL or b64\_json. | - |
