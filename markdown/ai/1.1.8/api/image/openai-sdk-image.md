---
title: "OpenAI SDK Image Generation (Official)"
source: "ROOT:api/image/openai-sdk-image.adoc"
---
...
> [!NOTE]
> This implementation uses the official [OpenAI Java SDK](https://github.com/openai/openai-java) from OpenAI. For the alternative Spring AI implementation, see [OpenAI Image Generation](openai-image.md).
...
<a id="_image_model_properties"></a>
...
| Property | Description | Default |
| --- | --- | --- |
| spring.ai.openai-sdk.image.options.model | The model to use for image generation. Available models: `dall-e-2`, `dall-e-3`. See the [models](https://platform.openai.com/docs/models) page for more information. | `dall-e-3` |
...
> [!TIP]
> All properties prefixed with `spring.ai.openai-sdk.image.options` can be overridden at runtime by adding request-specific [Runtime Options](#image-options) to the `ImagePrompt` call.

<a id="image-options"></a>

## Runtime Options

The [OpenAiSdkImageOptions.java](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-openai-sdk/src/main/java/org/springframework/ai/openaisdk/OpenAiSdkImageOptions.java) provides the OpenAI configurations, such as the model to use, quality, size, style, and number of images to generate.
...
> [!TIP]
> In addition to the model specific [OpenAiSdkImageOptions](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-openai-sdk/src/main/java/org/springframework/ai/openaisdk/OpenAiSdkImageOptions.java) you can use a portable [ImageOptions](https://github.com/spring-projects/spring-ai/blob/main/spring-ai-model/src/main/java/org/springframework/ai/image/ImageOptions.java) instance, created with the [ImageOptionsBuilder#builder()](https://github.com/spring-projects/spring-ai/blob/main/spring-ai-model/src/main/java/org/springframework/ai/image/ImageOptionsBuilder.java).
...
The [OpenAiSdkImageModel](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-openai-sdk/src/main/java/org/springframework/ai/openaisdk/OpenAiSdkImageModel.java) implements the `ImageModel` and uses the official OpenAI Java SDK to connect to the OpenAI service.
...
> [!NOTE]
> The `spring-ai-openai-sdk` dependency provides access also to the `OpenAiSdkChatModel` and `OpenAiSdkEmbeddingModel`.
