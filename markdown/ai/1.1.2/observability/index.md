...
<a id="_input_data_deprecated"></a>

### Input Data (Deprecated)

> [!WARNING]
> The `spring.ai.chat.client.observations.include-input` property is deprecated, replaced by `spring.ai.chat.client.observations.log-prompt`. See [Prompt Content](#_prompt_content).
