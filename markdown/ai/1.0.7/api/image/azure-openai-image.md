...
| spring.ai.azure.openai.image.options.size\_width | The width of the generated images. | - |
| spring.ai.azure.openai.image.options.size\_height | The height of the generated images. | - |
...
| --- | --- | --- |
| Property | Description | Default |
| spring.ai.azure.openai.endpoint | The URL to connect to (e.g. [<your-resource>.openai.azure.com/](<https://%3Cyour-resource%3E.openai.azure.com/>)) | - |
...
The [AzureOpenAiImageOptions](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-azure-openai/src/main/java/org/springframework/ai/azure/openai/AzureOpenAiImageOptions.java) provides model configurations, such as the deployment name, model, and image size.
