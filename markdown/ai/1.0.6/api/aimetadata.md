---
title: "AI metadata"
source: "ROOT:api/aimetadata.adoc"
---
...
Your rate limits are directly determined by your plan when you signed up with your AI provider. For instance, you can review details on OpenAI’s [rate limits](https://platform.openai.com/docs/guides/rate-limits?context=tier-free) and [plans](https://openai.com/pricing#language-models) by following the links.
...
<a id="AiMetadata-GenerationMetadata"></a>
...
For AI providers like OpenAI, the rate limit metadata is returned in [HTTP headers](https://platform.openai.com/docs/guides/rate-limits/rate-limits-in-headers) from their (REST) API accessible through HTTP clients, like OkHttp.
...
<a id="AiMetadata-Usage"></a>

## Usage

As shown [above](#AiMetadata-GenerationMetadata), `Usage` data can be obtained from the `GenerationMetadata` object. The `Usage` interface is defined as:
