...
Below is a code example excerpted from [OpenAiChatModelIT.java](https://github.com/spring-projects/spring-ai/blob/v1.0.0/models/spring-ai-openai/src/test/java/org/springframework/ai/openai/chat/OpenAiChatModelIT.java#L469), illustrating the fusion of user text with an image using the `gpt-4o` model.
...
![OpenAiApi Chat API Diagram](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.0.6/spring-ai-docs/src/main/antora/modules/ROOT/images/openai-chat-api.jpg)
