...
> [!NOTE]
> By default, all models are disabled. You have to enable the chosen Bedrock models explicitly using the `spring.ai.bedrock.<model>.embedding.enabled=true` property.
...
- [Spring AI Bedrock Cohere Embeddings](embeddings/bedrock-cohere-embedding.md): `spring.ai.bedrock.cohere.embedding.enabled=true`
- [Spring AI Bedrock Titan Embeddings](embeddings/bedrock-titan-embedding.md): `spring.ai.bedrock.titan.embedding.enabled=true`
