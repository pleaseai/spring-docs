...
![spring ai perplexity integration](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-perplexity-integration.jpg)
...
Set the `spring.ai.openai.base-url` property to `api.perplexity.ai`.
