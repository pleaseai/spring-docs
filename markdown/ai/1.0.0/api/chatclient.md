...
In the meantime, you should use the [Structured Output Converter](structured-output-converter.md#StructuredOutputConverter) to convert the aggregated response explicity as shown below.
