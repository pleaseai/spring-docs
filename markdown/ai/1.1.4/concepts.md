...
![Model types](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-concepts-model-types.jpg)
...
![Embeddings](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-embeddings.jpg)
...
![Tokens](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-concepts-tokens.png)
...
![Structured Output Converter Architecture](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/structured-output-architecture.jpg)

The [Structured output conversion](api/structured-output-converter.md#_structuredoutputconverter) employs meticulously crafted prompts, often necessitating multiple interactions with the model to achieve the desired formatting.

<a id="_bringing_your_data_apis_to_the_ai_model"></a>
...
The Spring AI library helps you implement solutions based on the “stuffing the prompt” technique otherwise known as [Retrieval Augmented Generation (RAG)](#concept-rag).

![Prompt stuffing](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-prompt-stuffing.jpg)

- **[Tool Calling](#concept-fc)**: This technique allows registering tools (user-defined services) that connect the large language models to the APIs of external systems.
Spring AI greatly simplifies code you need to write to support [tool calling](api/tools.md).
...
1. Split the document’s parts further into parts whose size is a small percentage of the AI Model’s token limit.
...
![Spring AI RAG](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-rag.jpg)

- The [ETL Pipeline](api/etl-pipeline.md) provides further information about orchestrating the flow of extracting data from data sources and storing it in a structured vector store, ensuring data is in the optimal format for retrieval when passing it to the AI model.
- The [ChatClient - RAG](api/chatclient.md#_retrieval_augmented_generation) explains how to use the `QuestionAnswerAdvisor` to enable the RAG capability in your application.
...
The [Tool Calling](api/tools.md) mechanism addresses these shortcomings.
...
![The main sequence of actions for tool calling](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.1.4/spring-ai-docs/src/main/antora/modules/ROOT/images/tools/tool-calling-01.jpg)
...
Follow the [Tool Calling](api/tools.md) documentation for further information on how to use this feature with different AI models.

<a id="concept-evaluating-ai-responses"></a>
...
Follow the [Evaluation Testing](api/testing.md) documentation for further information.
