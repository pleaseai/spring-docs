...
source: "ROOT:api/chat/prompt-engineering-patterns.adoc"
---
...
Practical implementations of Prompt Engineering techniques based on the comprehensive [Prompt Engineering Guide](https://www.kaggle.com/whitepaper-prompt-engineering).
The guide covers the theory, principles, and patterns of effective prompt engineering, while here we demonstrate how to translate those concepts into working Java code using Spring AI’s fluent [ChatClient API](../chatclient.md).
The demo source code used in this article is available at: [Prompt Engineering Patterns Examples](https://github.com/spring-projects/spring-ai-examples/tree/main/prompt-engineering/prompt-engineering-patterns).

<a id="_1_configuration"></a>
...
<a id="_llm_provider_selection"></a>

### LLM Provider Selection

For prompt engineering, you will start by choosing a model.
Spring AI supports [multiple LLM providers](comparison.md) (such as OpenAI, Anthropic, Google Vertex AI, AWS Bedrock, Ollama and more), letting you switch providers without changing application code - just update your configuration.
...
Find detailed information for enabling each model in the [reference docs](../chatmodel.md).

<a id="_llm_output_configuration"></a>

### LLM Output Configuration

![chat options flow](https://raw.githubusercontent.com/spring-projects/spring-ai/v1.0.9/spring-ai-docs/src/main/antora/modules/ROOT/images/https://docs.spring.io/spring-ai/reference/_images/chat-options-flow.jpg)

Before we dive into prompt engineering techniques, it’s essential to understand how to configure the LLM’s output behavior. Spring AI provides several configuration options that let you control various aspects of generation through the [ChatOptions](../chatmodel.md#_chat_options) builder.
...
<a id="_output_length_maxtokens"></a>
...
<a id="_sampling_controls_top_k_and_top_p"></a>
...
<a id="_structured_response_format"></a>
...
<a id="_model_specific_options"></a>
...
<a id="_2_prompt_engineering_techniques"></a>
...
<a id="_2_1_zero_shot_prompting"></a>
...
<a id="_2_2_one_shot_few_shot_prompting"></a>
...
<a id="_2_3_system_contextual_and_role_prompting"></a>

### 2.3 System, contextual and role prompting

<a id="_system_prompting"></a>
...
<a id="_2_4_step_back_prompting"></a>
...
<a id="_2_5_chain_of_thought_cot"></a>
...
<a id="_2_7_tree_of_thoughts_tot"></a>
...
<a id="_2_8_automatic_prompt_engineering"></a>
...
1. Consider using self-consistency for critical decision-making
1. Leverage Spring AI’s entity mapping for type-safe responses
1. Use contextual prompting to provide application-specific knowledge
...
1. Zhou, Y., et al. (2022). "Large Language Models Are Human-Level Prompt Engineers." arXiv:2211.01910.
1. Zheng, Z., et al. (2023). "Take a Step Back: Evoking Reasoning via Abstraction in Large Language Models." arXiv:2310.06117.
1. Liu, P., et al. (2021). "What Makes Good In-Context Examples for GPT-3?" arXiv:2101.06804.
1. Shanahan, M., et al. (2023). "Role-Play with Large Language Models." arXiv:2305.16367.
...
1. [ChatClient API Reference](https://docs.spring.io/spring-ai/reference/api/chatclient.html)
1. [Google’s Prompt Engineering Guide](https://www.kaggle.com/whitepaper-prompt-engineering)
