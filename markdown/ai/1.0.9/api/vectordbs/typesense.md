---
title: "Typesense"
source: "ROOT:api/vectordbs/typesense.adoc"
---
...
- A running Typesense instance. The following options are available:
  ...
  - [Docker](https://hub.docker.com/r/typesense/typesense/) image *typesense/typesense:latest*
- If required, an API key for the [EmbeddingModel](../embeddings.md#available-implementations) to generate the embeddings stored by the `TypesenseVectorStore`.
...
You can leverage the generic portable [metadata filters](../vectordbs.md#metadata-filters) with Typesense store as well.
...
> [!NOTE]
> Those (portable) filter expressions get automatically converted into [Typesense Search Filters](https://typesense.org/docs/0.24.0/api/search.html#filter-parameters).
