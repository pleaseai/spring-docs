...
source: "ROOT:api/mcp/mcp-annotations-examples.adoc"
---
...
<a id="_complete_application_examples"></a>

## Complete Application Examples

<a id="_simple_calculator_server"></a>
...
<a id="_document_processing_server"></a>
...
<a id="_mcp_client_with_handlers"></a>
...
<a id="_async_examples"></a>

## Async Examples

<a id="_async_tool_server"></a>
...
<a id="_stateless_server_examples"></a>
...
<a id="_mcp_sampling_with_multiple_llm_providers"></a>
...
<a id="_sampling_server_implementation"></a>
...
<a id="_sampling_client_implementation"></a>
...
<a id="_client_application_setup"></a>
...
<a id="_key_features_demonstrated"></a>

### Key Features Demonstrated

1. **Multi-Model Sampling**: Server requests content from multiple LLM providers using model hints
1. **Annotation-Based Handlers**: Client uses `@McpSampling`, `@McpLogging`, and `@McpProgress` annotations
1. **Stateless HTTP Transport**: Uses the streamable protocol for communication
1. **Creative Content Generation**: Generates poems about weather data from different models
1. **Unified Response Handling**: Combines responses from multiple providers into a single result

<a id="_sample_output"></a>
...
<a id="_integration_with_spring_ai"></a>
...
- [Server Annotations Reference](mcp-annotations-server.md)
- [Client Annotations Reference](mcp-annotations-client.md)
- [Special Parameters Reference](mcp-annotations-special-params.md)
