---
title: "Moderation"
source: "ROOT:api/moderation/mistral-ai-moderation.adoc"
---
...
Follow this [link](https://docs.mistral.ai/capabilities/guardrailing/) for more information on the Mistral AI moderation model.

<a id="_prerequisites"></a>

## Prerequisites

1. Create an Mistral AI account and obtain an API key. You can sign up at [Mistral AI registration page](https://auth.mistral.ai/ui/registration) and generate an API key on the [API Keys page](https://console.mistral.ai/api-keys/).
1. Add the `spring-ai-mistral-ai` dependency to your project’s build file. For more information, refer to the [Dependency Management](../../getting-started.md#dependency-management) section.
...
| spring.ai.mistralai.moderation.base-url | The URL to connect to | [api.mistral.ai](https://api.mistral.ai) |
...
> [!TIP]
> All properties prefixed with `spring.ai.mistralai.moderation` can be overridden at runtime.
