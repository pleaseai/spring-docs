...
- [Anthropic Claude](chat/anthropic-chat.md#_multi_modal_support)
...
- [Ollama (e.g. LLaVA, BakLLaVA, Llama models)](chat/ollama-chat.md#_multimodal)
- [OpenAI (e.g. GPT models)](chat/openai-chat.md#_multimodal)
- [Google Gemini](chat/google-genai-chat.md#_multimodal)
