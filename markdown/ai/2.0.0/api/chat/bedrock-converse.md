...
1. **Cache Lifetime**: AWS Bedrock caches have a fixed 5-minute TTL (Time To Live).
...
For more information, see the [Structured Output Converter](../structured-output-converter.md) documentation.
...
![Multimodal Test Video](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/test.video.jpeg)
...
![Multimodal Test PNG](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/test.pdf.png)
