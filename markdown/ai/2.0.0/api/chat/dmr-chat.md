...
source: "ROOT:api/chat/dmr-chat.adoc"
---
...
Spring AI integrates with the Docker Model Runner by reusing the existing [OpenAI](openai-chat.md) backed `ChatClient`.
To do this, set the base URL to `localhost:12434/engines/v1` and select one of the provided [LLM models](https://hub.docker.com/u/ai).

Check the [DockerModelRunnerWithOpenAiChatModelIT.java](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-openai/src/test/java/org/springframework/ai/openai/chat/proxy/DockerModelRunnerWithOpenAiChatModelIT.java) tests
for examples of how to use the Docker Model Runner with Spring AI.

<a id="_prerequisite"></a>
...
- Set the base-url to `localhost:12434/engines/v1`
...
| Property | Description | Default |
| --- | --- | --- |
| spring.ai.openai.base-url | The URL to connect to. Must be set to `localhost:12434/engines/v1` | - |
...
| spring.ai.openai.chat.base-url | Optional overrides the `spring.ai.openai.base-url` to provide a chat specific url. Must be set to `localhost:12434/engines/v1` | - |
| spring.ai.openai.chat.api-key | Optional overrides the spring.ai.openai.api-key to provide chat specific api-key | - |
| spring.ai.openai.chat.model | The [LLM model](https://hub.docker.com/u/ai) to use | - |
