...
- **[ChatClient with ToolCallingAdvisor](../tools.md#_chatclient_tool_execution)** — the recommended approach for most use cases. `ToolCallingAdvisor` manages the tool-call loop transparently.
- **[User-controlled tool execution](../tools.md#_user_controlled_tool_execution)** — use `ToolCallingManager` directly when you need full control over the loop.
...
![Multimodal Test Image](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/multimodal.test.png)
...
![Ollama OpenAI API compatibility](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-ollama-over-openai.jpg)
...
![OllamaApi Chat Completion API Diagram](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/ollama-chat-completion-api.jpg)
