...
Spring AI supports [multiple LLM providers](comparison.md) (such as OpenAI, Anthropic, Google GenAI, AWS Bedrock, Ollama and more), letting you switch providers without changing application code - just update your configuration.
...
![chat options flow](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.0/spring-ai-docs/src/main/antora/modules/ROOT/images/https://docs.spring.io/spring-ai/reference/_images/chat-options-flow.jpg)
