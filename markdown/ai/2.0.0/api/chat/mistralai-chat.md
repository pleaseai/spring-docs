...
| spring.ai.mistralai.chat.response-format | An object specifying the format that the model must output. Setting to `{ "type": "json_object" }` enables JSON mode, which guarantees the message the model generates is valid JSON. Setting to `{ "type": "json_schema" }` with a supplied schema enables native structured outputs, which guarantees the model will match your supplied JSON schema. See the [Structured Output](#structured-output) section for more details. | - |
...
> [!TIP]
> All properties prefixed with `spring.ai.mistralai.chat` can be overridden at runtime by adding request-specific [Runtime Options](#chat-options) to the `Prompt` call.
...
- **[User-controlled tool execution](../tools.md#_user_controlled_tool_execution)** — use `DefaultToolCallingManager` directly when you need full control over the loop.
...
<a id="_using_responseformat_directly"></a>
...
<a id="_json_mode_vs_structured_output"></a>
...
For more information about structured outputs, see the [Structured Output Converter](../structured-output-converter.md) documentation.

<a id="_reasoning_models"></a>
...
<a id="_low_level_mistralocrapi_client"></a>

### Low-level MistralOcrApi Client

The [MistralOcrApi](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-mistral-ai/src/main/java/org/springframework/ai/mistralai/api/MistralOcrApi.java) provides a lightweight Java client for [Mistral AI OCR API](https://docs.mistral.ai/api/#tag/OCR).
...
Follow the [MistralOcrApi.java](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-mistral-ai/src/main/java/org/springframework/ai/mistralai/api/MistralOcrApi.java)'s JavaDoc for further information.

<a id="_mistralocrapi_sample"></a>

#### MistralOcrApi Sample

- The [MistralOcrApiIT.java](https://github.com/spring-projects/spring-ai/blob/main/models/spring-ai-mistral-ai/src/test/java/org/springframework/ai/mistralai/api/MistralOcrApiIT.java) tests provide some general examples of how to use the lightweight library.
