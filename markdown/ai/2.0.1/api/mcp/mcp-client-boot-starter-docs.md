...
The MCP Client Boot Starter supports customizable conversion of Spring AI’s [ToolContext](../tools.md#tool-context) to MCP tool-call metadata through the `ToolContextToMcpMetaConverter` interface.
