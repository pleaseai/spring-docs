---
title: "Neo4j"
source: "ROOT:api/vectordbs/neo4j.adoc"
---
...
The [Neo4j’s Vector Search](https://neo4j.com/docs/cypher-manual/current/indexes-for-vector-search/) allows users to query vector embeddings from large datasets.
...
- A running Neo4j (5.15+) instance. The following options are available:
  ...
  - [Docker](https://hub.docker.com/_/neo4j) image
  - [Neo4j Desktop](https://neo4j.com/download/)
  - [Neo4j Aura](https://neo4j.com/cloud/aura-free/)
  - [Neo4j Server](https://neo4j.com/deployment-center/) instance
- If required, an API key for the [EmbeddingModel](../embeddings.md#available-implementations) to generate the embeddings stored by the `Neo4jVectorStore`.
...
Please have a look at the list of [Configuration Properties](#neo4jvector-properties) for the vector store to learn about the default values and configuration options.
...
Read the [Neo4j Documentation](https://neo4j.com/docs/java-manual/current/client-applications/) for more in-depth information about the configuration of a custom driver.
...
You can leverage the generic, portable [metadata filters](../vectordbs.md#metadata-filters) with Neo4j store as well.
...
> [!NOTE]
> Those (portable) filter expressions get automatically converted into the proprietary Neo4j `WHERE` [filter expressions](https://neo4j.com/developer/cypher/filtering-query-results/).
