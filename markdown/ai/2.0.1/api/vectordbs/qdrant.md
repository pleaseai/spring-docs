...
| `spring.ai.vectorstore.qdrant.content-field-name` | The name of the field storing document content in Qdrant payloads. Useful when integrating with existing collections that use different field names (e.g., "page\_content", "text", "content"). | `doc_content` |
...
<a id="_working_with_existing_collections"></a>
...
<a id="_using_custom_content_field_names"></a>
