---
title: "Couchbase"
source: "ROOT:api/vectordbs/couchbase.adoc"
---
...
[Couchbase](https://docs.couchbase.com/server/current/vector-search/vector-search.html) is a distributed, JSON document database, with all the desired capabilities of a relational DBMS. Among other features, it allows users to query information using vector-based storage and retrieval.
...
> [!NOTE]
> Couchbase Vector search requires Couchbase Server 7.6 or later and Java SDK 3.6.0 or later.
...
> [!TIP]
> Refer to the [Artifact Repositories](../../getting-started.md#artifact-repositories) section to add Milestone and/or Snapshot Repositories to your build file.
...
Please have a look at the list of [configuration parameters](#couchbasevector-properties) for the vector store to learn about the default values and configuration options.
...
<a id="couchbasevector-properties"></a>
...
| `spring.ai.vectorstore.couchbase.scope-name` | The name of the Couchbase scope, parent of the collection. Search queries will be executed in the scope context. | *default* |
| `spring.ai.vectorstore.couchbase.collection-name` | The name of the Couchbase collection to store the Documents. | *default* |
...
More details about each in the [Couchbase Documentation](https://docs.couchbase.com/server/current/search/child-field-options-reference.html) on vector searches.

<a id="_metadata_filtering"></a>

## Metadata Filtering

You can leverage the generic, portable [metadata filters](https://docs.spring.io/spring-ai/reference/api/vectordbs.html#_metadata_filters) with the Couchbase store.
...
Read the [Couchbase Documentation](https://docs.couchbase.com/java-sdk/current/hello-world/start-using-sdk.html) for more in-depth information about the configuration of a custom Cluster instance.
