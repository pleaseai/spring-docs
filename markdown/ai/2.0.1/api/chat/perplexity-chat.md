...
![spring ai perplexity integration](https://raw.githubusercontent.com/spring-projects/spring-ai/v2.0.1/spring-ai-docs/src/main/antora/modules/ROOT/images/spring-ai-perplexity-integration.jpg)
...
| spring.ai.openai.chat.top-p | The nucleus sampling threshold, valued between 0 and 1 inclusive. For each subsequent token, the model considers the results of the tokens with top\_p probability mass. We recommend either altering top\_k or top\_p, but not both. Required range: `0 < x < 1` | 0.9 |
...
> [!NOTE]
> Perplexity does not support explicit tool calling. Instead, it integrates search results directly into responses. See [Tool Calling](../tools.md) for Spring AI’s general tool-calling architecture.
