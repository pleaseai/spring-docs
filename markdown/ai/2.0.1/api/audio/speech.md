...
<a id="streaming-consume-inputstream"></a>
...
> [!TIP]
> A complete, tested reference implementation, `FluxInputStream`, is available in `OpenAiAudioSpeechModelIT` in the `spring-ai-openai` module’s test sources.
