---
title: "Observability"
source: "ROOT:observability/index.adoc"
---
...
Refer to the [Spring Boot Metrics](https://docs.spring.io/spring-boot/reference/actuator/metrics.html) and
[Spring Boot Tracing](https://docs.spring.io/spring-boot/reference/actuator/tracing.html) documentation to enable metrics and tracing support in your application.
...
<a id="_prompt_and_completion_data"></a>
...
>
> See the [OpenAI chat docs](../api/chat/openai-chat.md#_observability) and [Anthropic chat docs](../api/chat/anthropic-chat.md#_observability) for details.
...
| `gen_ai.request.top_k` | The top\_k sampling setting for the model request. |
| `gen_ai.request.top_p` | The top\_p sampling setting for the model request. |
...
<a id="_chat_prompt_and_completion_data"></a>
...
<a id="_tool_call_arguments_and_result_data"></a>
...
<a id="_chat_model_metrics_model_provider_execution"></a>
...
<a id="_understanding_active_vs_completed"></a>
