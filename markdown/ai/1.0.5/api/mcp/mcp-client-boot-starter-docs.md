...
- [**File system (Roots) Access**](https://spec.modelcontextprotocol.io/specification/2024-11-05/client/roots/) - standardized way for clients to expose filesystem `roots` to servers.
...
- [**Logging Handlers**](https://spec.modelcontextprotocol.io/specification/2024-11-05/server/utilities/logging/) - standardized way for servers to send structured log messages to clients.
