...
<a id="_webmvc_server_transport"></a>
...
<a id="_webflux_server_transport"></a>
...
<a id="_syncasync_server_types"></a>
...
- [Spring AI Tools](../tools.md) are automatically converted to sync/async specifications based on server type
...
<a id="_root_change_consumers"></a>

### [Root Change Consumers](https://spec.modelcontextprotocol.io/specification/2024-11-05/client/roots/#root-list-changes)
