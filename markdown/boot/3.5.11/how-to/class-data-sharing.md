---
title: "Class Data Sharing and AOT Cache"
...
For an overview of Spring Boot support for CDS and AOT Cache, see [reference:packaging/class-data-sharing.adoc](../reference/packaging/class-data-sharing.md).
...
To enable CDS optimization in a generated Docker image, the buildpack environment variable `BP_JVM_CDS_ENABLED` should be set to `true` when building the image as described in the [Maven plugin](https://docs.spring.io/spring-boot/3.5.11/maven-plugin/build-image.html#build-image.examples.builder-configuration) and [Gradle plugin](https://docs.spring.io/spring-boot/3.5.11/gradle-plugin/packaging-oci-image.html#build-image.examples.builder-configuration) documentation.
...
<a id="howto.class-data-sharing.buildpacks-aot-cache"></a>
...
<a id="howto.class-data-sharing.dockerfiles-aot-cache"></a>
