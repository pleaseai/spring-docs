...
Spring Security provides comprehensive integration with Spring MVC Test, and this can also be used when testing controllers using the [`@WebMvcTest`](https://docs.spring.io/spring-boot/3.3.12/api/java/org/springframework/boot/test/autoconfigure/web/servlet/WebMvcTest.html) slice and [`MockMvc`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/test/web/servlet/MockMvc.html).
...
## Structure [`@Configuration`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/context/annotation/Configuration.html) Classes for Inclusion in Slice Tests
...
For a [`@WebMvcTest`](https://docs.spring.io/spring-boot/3.3.12/api/java/org/springframework/boot/test/autoconfigure/web/servlet/WebMvcTest.html) for an application with the above [`@Configuration`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/context/annotation/Configuration.html) class, you might expect to have the [`SecurityFilterChain`](https://docs.spring.io/spring-security/site/docs/6.3.x/api/org/springframework/security/web/SecurityFilterChain.html) bean in the application context so that you can test if your controller endpoints are secured properly.
...
This will load all the beans in `MyConfiguration` including the [`HikariDataSource`](https://javadoc.io/doc/com.zaxxer/HikariCP/5.1.0/com.zaxxer.hikari/com/zaxxer/hikari/HikariDataSource.html) bean which isn’t required when testing the web tier.
