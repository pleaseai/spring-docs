...
See [`BatchAutoConfiguration`](https://github.com/spring-projects/spring-boot/tree/v4.0.7/module/spring-boot-batch/src/main/java/org/springframework/boot/batch/autoconfigure/BatchAutoConfiguration.java) and  [`BatchJdbcAutoConfiguration`](https://github.com/spring-projects/spring-boot/tree/v4.0.7/module/spring-boot-batch-jdbc/src/main/java/org/springframework/boot/batch/jdbc/autoconfigure/BatchJdbcAutoConfiguration.java) for more details.
