...
> When using the Gradle plugin, [configure the task’s classpath to include the `developmentOnly` configuration](https://docs.spring.io/spring-boot/4.0.7/gradle-plugin/packaging.html#packaging-executable.configuring.including-development-only-dependencies).
...
| --- | --- |
| [`ActiveMQConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/activemq/autoconfigure/ActiveMQConnectionDetails.html) | Containers named "symptoma/activemq", "apache/activemq-classic" or "apache/activemq" |
| [`ArtemisConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/artemis/autoconfigure/ArtemisConnectionDetails.html) | Containers named "apache/activemq-artemis" or "apache/artemis" |
| [`CassandraConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/cassandra/autoconfigure/CassandraConnectionDetails.html) | Containers named "cassandra" |
| [`ElasticsearchConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/elasticsearch/autoconfigure/ElasticsearchConnectionDetails.html) | Containers named "elasticsearch" |
| [`HazelcastConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/hazelcast/autoconfigure/HazelcastConnectionDetails.html) | Containers named "hazelcast/hazelcast". |
| [`JdbcConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/jdbc/autoconfigure/JdbcConnectionDetails.html) | Containers named "clickhouse/clickhouse-server", "gvenzl/oracle-free", "gvenzl/oracle-xe", "mariadb", "mssql/server", "mysql", or "postgres" |
| [`LdapConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/ldap/autoconfigure/LdapConnectionDetails.html) | Containers named "osixia/openldap", "lldap/lldap" |
| [`MongoConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/mongodb/autoconfigure/MongoConnectionDetails.html) | Containers named "mongo" |
| [`Neo4jConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/neo4j/autoconfigure/Neo4jConnectionDetails.html) | Containers named "neo4j" |
| [`OtlpLoggingConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/opentelemetry/autoconfigure/logging/otlp/OtlpLoggingConnectionDetails.html) | Containers named "otel/opentelemetry-collector-contrib", "grafana/otel-lgtm" |
| [`OtlpMetricsConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/micrometer/metrics/autoconfigure/export/otlp/OtlpMetricsConnectionDetails.html) | Containers named "otel/opentelemetry-collector-contrib", "grafana/otel-lgtm" |
| [`OtlpTracingConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/micrometer/tracing/opentelemetry/autoconfigure/otlp/OtlpTracingConnectionDetails.html) | Containers named "otel/opentelemetry-collector-contrib", "grafana/otel-lgtm" |
| [`PulsarConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/pulsar/autoconfigure/PulsarConnectionDetails.html) | Containers named "apachepulsar/pulsar" |
| [`R2dbcConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/r2dbc/autoconfigure/R2dbcConnectionDetails.html) | Containers named "clickhouse/clickhouse-server", "gvenzl/oracle-free", "gvenzl/oracle-xe", "mariadb", "mssql/server", "mysql", or "postgres" |
| [`RabbitConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/amqp/autoconfigure/RabbitConnectionDetails.html) | Containers named "rabbitmq" |
| [`DataRedisConnectionDetails`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/data/redis/autoconfigure/DataRedisConnectionDetails.html) | Containers named "redis", "redis/redis-stack" or "redis/redis-stack-server" |
...
To do so, add the [`@ImportTestcontainers`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/testcontainers/context/ImportTestcontainers.html) annotation to your test configuration class:
...
When using devtools, you can annotate beans and bean methods with [`@RestartScope`](https://docs.spring.io/spring-boot/4.0.7/api/java/org/springframework/boot/devtools/restart/RestartScope.html).
