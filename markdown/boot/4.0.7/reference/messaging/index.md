...
Spring Boot also provides auto-configuration options for [`RabbitTemplate`](https://docs.spring.io/spring-amqp/docs/4.0.x/api/org/springframework/amqp/rabbit/core/RabbitTemplate.html) and RabbitMQ.
