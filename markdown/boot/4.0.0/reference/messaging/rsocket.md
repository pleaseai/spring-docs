...
For WebFlux application (that is of type [`WebApplicationType.REACTIVE`](https://docs.spring.io/spring-boot/4.0.0/api/java/org/springframework/boot/WebApplicationType.html#REACTIVE)), the RSocket server will be plugged into the Web Server only if the following properties match:
