...
- [Reference](https://docs.spring.io/spring-boot/4.0.0/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/4.0.0/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/4.0.0/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/4.0.0/gradle-plugin/api/java/index.html)
