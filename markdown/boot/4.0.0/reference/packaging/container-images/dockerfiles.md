...
> [!NOTE]
> If you’re using Java < 24, AOT cache is not available.
> You have to use CDS instead.

If you want to additionally enable the [AOT cache](../aot-cache.md#packaging.aot-cache.aot-cache), you can use this `Dockerfile`:
...
If you want to additionally enable [CDS](../aot-cache.md#packaging.aot-cache.cds), you can use this `Dockerfile`:
