...
1. Redis
1. JDBC
1. If neither Redis nor JDBC are available, we do not configure a [`SessionRepository`](https://docs.spring.io/spring-session/docs/4.0.x/api/org/springframework/session/SessionRepository.html).
