---
title: "Dockerfiles"
source: "reference:packaging/container-images/dockerfiles.adoc"
---

<a id="packaging.container-images.dockerfiles"></a>

# Dockerfiles

While it is possible to convert a Spring Boot uber jar into a Docker image with just a few lines in the `Dockerfile`, using the [layering feature](efficient-images.md#packaging.container-images.efficient-images.layering) will result in an optimized image.
...
> [!CAUTION]
> The `tools` mode can not be used with a [fully executable Spring Boot archive](../../../how-to/deployment/installing.md) that includes a launch script.
...
<a id="packaging.container-images.dockerfiles.aot-cache"></a>

## AOT cache

If you are using Java 25 or above, and want to additionally enable the [AOT cache](../class-data-sharing.md#packaging.class-data-sharing.aot-cache), you can use this `Dockerfile`:
...
<a id="packaging.container-images.dockerfiles.cds"></a>

## CDS

If you want to additionally enable [CDS](../class-data-sharing.md#packaging.class-data-sharing.cds), you can use this `Dockerfile`:
