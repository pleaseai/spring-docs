...
If you are using Java 25 or above, and want to additionally enable the [AOT cache](../aot-cache.md#packaging.aot-cache.aot-cache), you can use this `Dockerfile`:
