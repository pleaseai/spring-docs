...
> [!TIP]
> See [`ActiveMQProperties`](https://docs.spring.io/spring-boot/4.0.8/api/java/org/springframework/boot/activemq/autoconfigure/ActiveMQProperties.html) for more of the supported options.
> You can also register an arbitrary number of beans that implement [`ActiveMQConnectionFactoryCustomizer`](https://docs.spring.io/spring-boot/4.0.8/api/java/org/springframework/boot/activemq/autoconfigure/ActiveMQConnectionFactoryCustomizer.html) for more advanced customizations.
...
See [`ArtemisProperties`](https://docs.spring.io/spring-boot/4.0.8/api/java/org/springframework/boot/artemis/autoconfigure/ArtemisProperties.html) for more supported options.
...
The auto-configuration uses [`ConnectionFactoryUnwrapper`](https://docs.spring.io/spring-boot/4.0.8/api/java/org/springframework/boot/jms/ConnectionFactoryUnwrapper.html) to unwrap the native connection factory from the auto-configured one.
