...
> If you need to customize the task executor, consider implementing [`SchedulerFactoryBeanCustomizer`](https://docs.spring.io/spring-boot/4.0.8/api/java/org/springframework/boot/quartz/autoconfigure/SchedulerFactoryBeanCustomizer.html).
