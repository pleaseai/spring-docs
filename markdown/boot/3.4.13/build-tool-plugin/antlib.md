---
title: "Spring Boot AntLib Module"
source: "build-tool-plugin:antlib.adoc"
---

<a id="build-tool-plugins.antlib"></a>
...
```shell
$ ant -lib <directory containing spring-boot-antlib-3.4.13.jar>
```

> [!TIP]
> The “Using Spring Boot” section includes a more complete example of [using Apache Ant with `spring-boot-antlib`](../reference/using/build-systems.md#using.build-systems.ant).

<a id="build-tool-plugins.antlib.tasks"></a>
...
<a id="build-tool-plugins.antlib.tasks.exejar"></a>
...
<a id="build-tool-plugins.antlib.tasks.examples"></a>
...
<a id="build-tool-plugins.antlib.findmainclass"></a>
...
<a id="build-tool-plugins.antlib.findmainclass.examples"></a>
