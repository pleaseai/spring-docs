...
The [`SpringApplication`](https://docs.spring.io/spring-boot/3.5.10/api/java/org/springframework/boot/SpringApplication.html) entry point also has a Java API for setting additional profiles.
See the `setAdditionalProfiles()` method in [`SpringApplication`](https://docs.spring.io/spring-boot/3.5.10/api/java/org/springframework/boot/SpringApplication.html).
...
Profile-specific variants of both `application.properties` (or `application.yaml`) and files referenced through [`@ConfigurationProperties`](https://docs.spring.io/spring-boot/3.5.10/api/java/org/springframework/boot/context/properties/ConfigurationProperties.html) are considered as files and loaded.
