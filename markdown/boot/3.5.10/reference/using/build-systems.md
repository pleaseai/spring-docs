...
- [Reference](https://docs.spring.io/spring-boot/3.5.10/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.5.10/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/3.5.10/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.5.10/gradle-plugin/api/java/index.html)
