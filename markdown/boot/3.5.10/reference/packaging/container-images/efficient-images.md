...
For Maven, see the [packaging layered jar or war section](https://docs.spring.io/spring-boot/3.5.10/maven-plugin/packaging.html#packaging.layers) for more details on adding a layer index to the archive.
For Gradle, see the [packaging layered jar or war section](https://docs.spring.io/spring-boot/3.5.10/gradle-plugin/packaging.html#packaging-executable.configuring.layered-archives) of the Gradle plugin documentation.
