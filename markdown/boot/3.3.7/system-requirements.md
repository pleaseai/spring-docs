...
Spring Boot 3.3.7 requires at least [Java 17](https://www.java.com) and is compatible with versions up to and including Java 23.
[Spring Framework 6.1.16](https://docs.spring.io/spring-framework/reference/6.1/) or above is also required.
