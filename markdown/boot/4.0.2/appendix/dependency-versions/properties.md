...
Browse the [`spring-boot-dependencies` build.gradle](https://github.com/spring-projects/spring-boot/tree/v4.0.2/platform/spring-boot-dependencies/build.gradle) for a complete list of dependencies.
