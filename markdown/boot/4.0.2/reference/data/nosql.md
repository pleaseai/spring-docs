...
> [!TIP]
> You can also register an arbitrary number of beans that implement [`LettuceClientConfigurationBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/data/redis/autoconfigure/LettuceClientConfigurationBuilderCustomizer.html) for more advanced customizations.
> [`ClientResources`](https://javadoc.io/doc/io.lettuce/lettuce-core/6.8.2.RELEASE/io/lettuce/core/resource/ClientResources.html) can also be customized using [`ClientResourcesBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/data/redis/autoconfigure/ClientResourcesBuilderCustomizer.html).
> If you use Jedis, [`JedisClientConfigurationBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/data/redis/autoconfigure/JedisClientConfigurationBuilderCustomizer.html) is also available.
...
To access a Neo4j server, you can inject an auto-configured [`Driver`](https://javadoc.io/doc/org.neo4j.driver/neo4j-java-driver/6.0.2/org/neo4j/driver/Driver.html).
By default, the instance tries to connect to a Neo4j server at `localhost:7687` using the Bolt protocol.
The following example shows how to inject a Neo4j [`Driver`](https://javadoc.io/doc/org.neo4j.driver/neo4j-java-driver/6.0.2/org/neo4j/driver/Driver.html) that gives you access, amongst other things, to a [`Session`](https://javadoc.io/doc/org.neo4j.driver/neo4j-java-driver/6.0.2/org/neo4j/driver/Session.html):
...
The auto-configured [`Driver`](https://javadoc.io/doc/org.neo4j.driver/neo4j-java-driver/6.0.2/org/neo4j/driver/Driver.html) is created using `org.neo4j.driver.Config$ConfigBuilder`.
To fine-tune its configuration, declare one or more [`ConfigBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/neo4j/autoconfigure/ConfigBuilderCustomizer.html) beans.
Each will be called in order with the `org.neo4j.driver.Config$ConfigBuilder` that is used to build the [`Driver`](https://javadoc.io/doc/org.neo4j.driver/neo4j-java-driver/6.0.2/org/neo4j/driver/Driver.html).
...
If you have `co.elastic.clients:elasticsearch-rest5-client` on the classpath, Spring Boot will auto-configure and register a [`Rest5Client`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/Rest5Client.html) bean.
In addition to the properties described previously, to fine-tune the [`Rest5Client`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/Rest5Client.html) you can register an arbitrary number of beans that implement [`Rest5ClientBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/elasticsearch/autoconfigure/Rest5ClientBuilderCustomizer.html) for more advanced customizations.
To take full control over the client’s configuration, define a [`Rest5ClientBuilder`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/Rest5ClientBuilder.html) bean.

Additionally, a [`Sniffer`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/sniffer/Sniffer.html) can be auto-configured to automatically discover nodes from a running Elasticsearch cluster and set them on the [`Rest5Client`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/Rest5Client.html) bean.
You can further tune how [`Sniffer`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/sniffer/Sniffer.html) is configured, as shown in the following example:
...
If you use the `spring-boot-starter-elasticsearch` or have added `co.elastic.clients:elasticsearch-java` to the classpath, Spring Boot will auto-configure and register an [`ElasticsearchClient`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/elasticsearch/ElasticsearchClient.html) bean.

The [`ElasticsearchClient`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/elasticsearch/ElasticsearchClient.html) uses a transport that depends upon the previously described [`Rest5Client`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/low_level/Rest5Client.html).
Therefore, the properties described previously can be used to configure the [`ElasticsearchClient`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/elasticsearch/ElasticsearchClient.html).
Furthermore, you can define a [`Rest5ClientOptions`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/transport/rest5_client/Rest5ClientOptions.html) bean to take further control of the behavior of the transport.
...
To connect to Elasticsearch, an [`ElasticsearchClient`](https://javadoc.io/doc/co.elastic.clients/elasticsearch-java/9.2.3/index.html/co/elastic/clients/elasticsearch/ElasticsearchClient.html) bean must be defined,
...
>
> For more advanced driver customizations, you can register an arbitrary number of beans that implement [`DriverConfigLoaderBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/cassandra/autoconfigure/DriverConfigLoaderBuilderCustomizer.html).
> The `CqlSession` can be customized with a bean of type [`CqlSessionBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/cassandra/autoconfigure/CqlSessionBuilderCustomizer.html).
...
> To take more control, one or more [`ClusterEnvironmentBuilderCustomizer`](https://docs.spring.io/spring-boot/4.0.2/api/java/org/springframework/boot/couchbase/autoconfigure/ClusterEnvironmentBuilderCustomizer.html) beans can be used.
