...
The default layout is the most efficient, and it is [AOT cache](aot-cache.md#packaging.aot-cache.aot-cache) (and [CDS](aot-cache.md#packaging.aot-cache.cds)) friendly.
