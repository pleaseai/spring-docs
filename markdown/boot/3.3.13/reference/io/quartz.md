...
> If you need to customize the task executor, consider implementing [`SchedulerFactoryBeanCustomizer`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/autoconfigure/quartz/SchedulerFactoryBeanCustomizer.html).
