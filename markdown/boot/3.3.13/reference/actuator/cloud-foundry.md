...
The `/cloudfoundryapplication` path provides an alternative secured route to all [`@Endpoint`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/actuate/endpoint/annotation/Endpoint.html) beans.
