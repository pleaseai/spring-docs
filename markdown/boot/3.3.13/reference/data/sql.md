...
See [`DataSourceProperties`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/autoconfigure/jdbc/DataSourceProperties.html) API documentation for more of the supported options.
...
Additional connection pools can always be configured manually, using [`DataSourceBuilder`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/jdbc/DataSourceBuilder.html).
...
The following connection pools are supported by [`DataSourceBuilder`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/jdbc/DataSourceBuilder.html):
...
> [!TIP]
> You can customize entity scanning locations by using the [`@EntityScan`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/autoconfigure/domain/EntityScan.html) annotation.
