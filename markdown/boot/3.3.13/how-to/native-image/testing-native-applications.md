...
For example, you could use the Spring [`WebClient`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/web/reactive/function/client/WebClient.html) to call your application REST endpoints.
...
For example, you can continue to use the [`@SpringBootTest`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/test/context/SpringBootTest.html) annotation.
...
- Tests are analyzed in order to discover any [`ApplicationContext`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/context/ApplicationContext.html) instances that will be required.
...
- The native image also includes the JUnit [`TestEngine`](https://junit.org/junit5/docs/5.10.5/api/org.junit.platform.engine/org/junit/platform/engine/TestEngine.html) configured with a list of the discovered tests.
