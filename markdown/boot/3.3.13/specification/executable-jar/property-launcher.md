...
[`PropertiesLauncher`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/loader/launch/PropertiesLauncher.html) has a few special features that can be enabled with external properties (System properties, environment variables, manifest entries, or `loader.properties`).
...
The following rules apply to working with [`PropertiesLauncher`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/loader/launch/PropertiesLauncher.html):
...
Because of this, [`PropertiesLauncher`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/loader/launch/PropertiesLauncher.html) behaves the same as [`JarLauncher`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/loader/launch/JarLauncher.html) when no additional configuration is provided.
- `loader.path` can not be used to configure the location of `loader.properties` (the classpath used to search for the latter is the JVM classpath when [`PropertiesLauncher`](https://docs.spring.io/spring-boot/3.3.13/api/java/org/springframework/boot/loader/launch/PropertiesLauncher.html) is launched).
