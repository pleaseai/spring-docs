...
See [`JksSslBundleProperties`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/autoconfigure/ssl/JksSslBundleProperties.html) for the full set of supported properties.
...
See [`PemSslBundleProperties`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/autoconfigure/ssl/PemSslBundleProperties.html) for the full set of supported properties.
...
Spring Boot auto-configures a bean of type [`SslBundles`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/ssl/SslBundles.html) that provides access to each of the named bundles configured using the `spring.ssl.bundle` properties.

An [`SslBundle`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/ssl/SslBundle.html) can be retrieved from the auto-configured [`SslBundles`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/ssl/SslBundles.html) bean and used to create objects that are used to configure SSL connectivity in client libraries.
The [`SslBundle`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/ssl/SslBundle.html) provides a layered approach of obtaining these SSL objects:
...
In addition, the [`SslBundle`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/ssl/SslBundle.html) provides details about the key being used, the protocol to use and any option that should be applied to the SSL engine.

The following example shows retrieving an [`SslBundle`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/ssl/SslBundle.html) and using it to create an [`SSLContext`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/javax/net/ssl/SSLContext.html):
