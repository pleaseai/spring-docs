...
Spring Boot 3.5.13 requires at least [Java 17](https://www.java.com) and is compatible with versions up to and including Java 25.
[Spring Framework 6.2.17](https://docs.spring.io/spring-framework/reference/6.2/) or above is also required.
