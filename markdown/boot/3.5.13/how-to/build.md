...
When such a file is present, Spring Boot auto-configures a [`BuildProperties`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/info/BuildProperties.html) bean.
...
> [!TIP]
> See the [Spring Boot Maven Plugin documentation](https://docs.spring.io/spring-boot/3.5.13/maven-plugin/build-info.html) for more details.
...
> [!TIP]
> See the [Spring Boot Gradle Plugin documentation](https://docs.spring.io/spring-boot/3.5.13/gradle-plugin/integrating-with-actuator.html) for more details.
...
To override dependency versions with Maven, see [maven-plugin:using.adoc](https://docs.spring.io/spring-boot/3.5.13/maven-plugin/using.html) in the Maven plugin’s documentation.

To override dependency versions in Gradle, see [gradle-plugin:managing-dependencies.adoc#managing-dependencies.dependency-management-plugin.customizing](https://docs.spring.io/spring-boot/3.5.13/gradle-plugin/managing-dependencies.html#managing-dependencies.dependency-management-plugin.customizing) in the Gradle plugin’s documentation.
...
See the [plugin documentation](https://docs.spring.io/spring-boot/3.5.13/maven-plugin/packaging.html#packaging.repackage-goal) for full usage details.
...
To attach a remote debugger to a Spring Boot application that was started with Maven, you can use the `jvmArguments` property of the [maven plugin](https://docs.spring.io/spring-boot/3.5.13/maven-plugin/index.html).

See [this example](https://docs.spring.io/spring-boot/3.5.13/maven-plugin/run.html#run.examples.debug) for more details.
...
1. Use the appropriate launcher (such as [`JarLauncher`](https://docs.spring.io/spring-boot/3.5.13/api/java/org/springframework/boot/loader/launch/JarLauncher.html) for a jar file) as a `Main-Class` attribute in the manifest and specify the other properties it needs as manifest entries — principally, by setting a `Start-Class` property.
