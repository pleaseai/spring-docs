...
See [`KafkaProperties`](https://docs.spring.io/spring-boot/3.4.3/api/java/org/springframework/boot/autoconfigure/kafka/KafkaProperties.html) for more supported options.
...
Only a subset of the properties supported by Kafka are available directly through the [`KafkaProperties`](https://docs.spring.io/spring-boot/3.4.3/api/java/org/springframework/boot/autoconfigure/kafka/KafkaProperties.html) class.
