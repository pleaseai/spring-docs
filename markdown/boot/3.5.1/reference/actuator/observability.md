...
You can additionally register any number of [`ObservationRegistryCustomizer`](https://docs.spring.io/spring-boot/3.5.1/api/java/org/springframework/boot/actuate/autoconfigure/observation/ObservationRegistryCustomizer.html) beans to further configure the registry.
