...
To repackage an existing archive so that it becomes a self-contained executable archive, use [`Repackager`](https://docs.spring.io/spring-boot/3.4.8/api/java/org/springframework/boot/loader/tools/Repackager.html).
The [`Repackager`](https://docs.spring.io/spring-boot/3.4.8/api/java/org/springframework/boot/loader/tools/Repackager.html) class takes a single constructor argument that refers to an existing jar or war archive.
...
When repackaging an archive, you can include references to dependency files by using the [`Libraries`](https://docs.spring.io/spring-boot/3.4.8/api/java/org/springframework/boot/loader/tools/Libraries.html) interface.
We do not provide any concrete implementations of [`Libraries`](https://docs.spring.io/spring-boot/3.4.8/api/java/org/springframework/boot/loader/tools/Libraries.html) here as they are usually build-system-specific.

If your archive already includes libraries, you can use [`Libraries.NONE`](https://docs.spring.io/spring-boot/3.4.8/api/java/org/springframework/boot/loader/tools/Libraries.html#NONE).
