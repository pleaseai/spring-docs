...
> Check the [Maven](https://docs.spring.io/spring-boot/3.4.8/maven-plugin/build-image.html#build-image.docker-daemon) or [Gradle](https://docs.spring.io/spring-boot/3.4.8/gradle-plugin/packaging-oci-image.html#build-image.docker-daemon) Spring Boot plugin documentation for more details.
