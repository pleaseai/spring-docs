...
If you want to use the [`DefaultJmsListenerContainerFactoryConfigurer`](https://docs.spring.io/spring-boot/3.4.8/api/java/org/springframework/boot/autoconfigure/jms/DefaultJmsListenerContainerFactoryConfigurer.html) to reuse Spring Boot’s default, you can disable transacted sessions, as follows:
