...
source: "reference:packaging/efficient.adoc"
---

<a id="packaging.efficient"></a>

# Efficient Deployments

<a id="packaging.efficient.unpacking"></a>
...
The default layout is the most efficient, and it is [CDS](class-data-sharing.md#packaging.class-data-sharing.cds) and [AOT cache](class-data-sharing.md#packaging.class-data-sharing.aot-cache) friendly.
