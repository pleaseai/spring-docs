...
> [!TIP]
> See the [Spring Boot Maven Plugin documentation](https://docs.spring.io/spring-boot/3.3.1/maven-plugin/build-info.html) for more details.
...
> [!TIP]
> See the [Spring Boot Gradle Plugin documentation](https://docs.spring.io/spring-boot/3.3.1/gradle-plugin/integrating-with-actuator.html) for more details.
...
To override dependency versions with Maven, see [this section](https://docs.spring.io/spring-boot/3.3.1/maven-plugin/using.html) of the Maven plugin’s documentation.

To override dependency versions in Gradle, see [this section](https://docs.spring.io/spring-boot/3.3.1/gradle-plugin/managing-dependencies.html#managing-dependencies.dependency-management-plugin.customizing) of the Gradle plugin’s documentation.
...
See the [plugin documentation](https://docs.spring.io/spring-boot/3.3.1/maven-plugin/packaging.html#packaging.repackage-goal) for full usage details.
...
To attach a remote debugger to a Spring Boot application that was started with Maven, you can use the `jvmArguments` property of the [maven plugin](https://docs.spring.io/spring-boot/3.3.1/maven-plugin/index.html).

See [this example](https://docs.spring.io/spring-boot/3.3.1/maven-plugin/run.html#run.examples.debug) for more details.
