...
Spring Boot 3.3.1 requires [Java 17](https://www.java.com) and is compatible up to and including Java 22.
[Spring Framework 6.1.10](https://docs.spring.io/spring-framework/reference/6.1.10/) or above is also required.
