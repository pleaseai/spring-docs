...
Spring Boot Actuator provides dependency management and auto-configuration for [Micrometer](https://micrometer.io), an application metrics facade that supports [numerous monitoring systems](https://docs.micrometer.io/micrometer/reference), including:
...
> [!TIP]
> To learn more about Micrometer’s capabilities, see its [reference documentation](https://docs.micrometer.io/micrometer/reference), in particular the [concepts section](https://docs.micrometer.io/micrometer/reference/concepts).
...
To export metrics to SaaS [AppOptics](https://docs.micrometer.io/micrometer/reference/implementations/appOptics), your API token must be provided:
...
By default, metrics are exported to [Atlas](https://docs.micrometer.io/micrometer/reference/implementations/atlas) running on your local machine.
...
To export metrics to [Datadog](https://docs.micrometer.io/micrometer/reference/implementations/datadog), you must provide your API key:
...
Dynatrace offers two metrics ingest APIs, both of which are implemented for [Micrometer](https://docs.micrometer.io/micrometer/reference/implementations/dynatrace).
...
To export metrics to [Dynatrace](https://docs.micrometer.io/micrometer/reference/implementations/dynatrace), your API token, device ID, and URI must be provided:
...
You can find more information on how to set up the Dynatrace exporter for Micrometer in the [Micrometer documentation](https://docs.micrometer.io/micrometer/reference/implementations/dynatrace) and the [Dynatrace documentation](https://docs.dynatrace.com/docs/shortlink/micrometer-metrics-ingest).

<a id="actuator.metrics.export.elastic"></a>

### Elastic

By default, metrics are exported to [Elastic](https://docs.micrometer.io/micrometer/reference/implementations/elastic) running on your local machine.
...
By default, metrics are exported to [Ganglia](https://docs.micrometer.io/micrometer/reference/implementations/ganglia) running on your local machine.
...
By default, metrics are exported to [Graphite](https://docs.micrometer.io/micrometer/reference/implementations/graphite) running on your local machine.
...
Micrometer provides a default `HierarchicalNameMapper` that governs how a dimensional meter ID is [mapped to flat hierarchical names](https://docs.micrometer.io/micrometer/reference/implementations/graphite#_hierarchical_name_mapping).
...
To export metrics to SaaS [Humio](https://docs.micrometer.io/micrometer/reference/implementations/humio), you must provide your API token:
...
By default, metrics are exported to an [Influx](https://docs.micrometer.io/micrometer/reference/implementations/influx) v1 instance running on your local machine with the default configuration.
...
Micrometer provides a hierarchical mapping to [JMX](https://docs.micrometer.io/micrometer/reference/implementations/jmx), primarily as a cheap and portable way to view metrics locally.
...
Micrometer provides a default `HierarchicalNameMapper` that governs how a dimensional meter ID is [mapped to flat hierarchical names](https://docs.micrometer.io/micrometer/reference/implementations/jmx#_hierarchical_name_mapping).
...
By default, metrics are exported to [KairosDB](https://docs.micrometer.io/micrometer/reference/implementations/kairos) running on your local machine.
...
A New Relic registry periodically pushes metrics to [New Relic](https://docs.micrometer.io/micrometer/reference/implementations/new-relic).
...
By default, metrics are exported to [OpenTelemetry](https://docs.micrometer.io/micrometer/reference/implementations/otlp) running on your local machine.
...
[Prometheus](https://docs.micrometer.io/micrometer/reference/implementations/prometheus) expects to scrape or poll individual application instances for metrics.
...
If you use [Micrometer Tracing](https://docs.micrometer.io/tracing/reference), this will be auto-configured for you, but you can always create your own if you want.
...
SignalFx registry periodically pushes metrics to [SignalFx](https://docs.micrometer.io/micrometer/reference/implementations/signalFx).
...
To export metrics to SaaS [Stackdriver](https://docs.micrometer.io/micrometer/reference/implementations/stackdriver), you must provide your Google Cloud project ID:
...
By default, metrics are exported to a [StatsD](https://docs.micrometer.io/micrometer/reference/implementations/statsD) agent running on your local machine.
...
The Wavefront registry periodically pushes metrics to [Wavefront](https://docs.micrometer.io/micrometer/reference/implementations/wavefront).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.10/integration/observability.html#observability.jms).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.10/integration/observability.html#observability.http-server.servlet).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.10/integration/observability.html#observability.http-server.reactive).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.10/integration/observability.html#observability.http-client).
...
Please refer to the [Micrometer documentation](https://docs.micrometer.io/micrometer/reference/concepts#_the_timed_annotation).
...
For more details on the concepts behind `percentiles-histogram`, `percentiles`, and `slo`, see the [“Histograms and percentiles” section](https://docs.micrometer.io/micrometer/reference/concepts#_histograms_and_percentiles) of the Micrometer documentation.
