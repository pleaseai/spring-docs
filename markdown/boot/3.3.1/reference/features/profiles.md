...
See the `setAdditionalProfiles()` method in [SpringApplication](https://docs.spring.io/spring-boot/3.3.1/api/java/org/springframework/boot/SpringApplication.html).
