...
WebFlux is part of the Spring Framework and detailed information is available in its [reference documentation](https://docs.spring.io/spring-framework/reference/6.1.10/web/webflux.html).
...
“WebFlux.fn” is part of the Spring Framework and detailed information is available in its [reference documentation](https://docs.spring.io/spring-framework/reference/6.1.10/web/webflux-functional.html).
...
If you want to keep Spring Boot WebFlux features and you want to add additional [WebFlux configuration](https://docs.spring.io/spring-framework/reference/6.1.10/web/webflux/config.html), you can add your own `@Configuration` class of type `WebFluxConfigurer` but **without** `@EnableWebFlux`.
...
Before customizing error handling in Spring Boot directly, you can leverage the [RFC 7807 Problem Details](https://docs.spring.io/spring-framework/reference/6.1.10/web/webflux/ann-rest-exceptions.html) support in Spring WebFlux.
...
Applications can ensure that such exceptions are recorded with the observations by [setting the handled exception on the observation context](https://docs.spring.io/spring-framework/reference/6.1.10/integration/observability.html#observability.http-server.reactive).
...
See the [source code documentation](https://docs.spring.io/spring-boot/3.3.1/api/java/org/springframework/boot/web/reactive/server/ConfigurableReactiveWebServerFactory.html) for details.
...
You can learn more about the resource configuration on the client side in the [WebClient Runtime section](../io/rest-client.md#io.rest-client.webclient.runtime).
