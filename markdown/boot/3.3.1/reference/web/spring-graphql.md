...
Spring Boot detects such beans and adds them to the [GraphQlSource builder](https://docs.spring.io/spring-graphql/reference/1.3/#execution-graphqlsource).

Typically, however, applications will not implement `DataFetcher` directly and will instead create [annotated controllers](https://docs.spring.io/spring-graphql/reference/1.3/#controllers).
...
Spring GraphQL can [configure Querydsl and QueryByExample repositories as `DataFetcher`](https://docs.spring.io/spring-graphql/reference/1.3/#data).
...
Spring GraphQL provides a [Web Interception](https://docs.spring.io/spring-graphql/reference/1.3/#web-interception) model.
...
[Spring MVC](https://docs.spring.io/spring-framework/reference/6.1.10/web/webmvc-cors.html) and [Spring WebFlux](https://docs.spring.io/spring-framework/reference/6.1.10/web/webflux-cors.html) support CORS (Cross-Origin Resource Sharing) requests.
...
The Exception must be resolved to a list of `graphql.GraphQLError` objects, see [Spring GraphQL exception handling documentation](https://docs.spring.io/spring-graphql/reference/1.3/#execution-exceptions).
