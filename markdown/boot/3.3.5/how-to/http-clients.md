...
As described in [RestTemplate Customization](../reference/io/rest-client.md#io.rest-client.resttemplate.customization), you can use a `RestTemplateCustomizer` with `RestTemplateBuilder` to build a customized `RestTemplate`.
