...
> Enabling management beans provided by other libraries (for example [Log4j2](https://logging.apache.org/log4j/2.x/manual/jmx.html) or [Quartz](https://www.javadoc.io/doc/org.quartz-scheduler/quartz/2.3.2/constant-values.html#org.quartz.impl.StdSchedulerFactory.PROP_SCHED_JMX_EXPORT)) is independent.

See the [`JmxAutoConfiguration`](https://github.com/spring-projects/spring-boot/tree/v3.3.5/spring-boot-project/spring-boot-autoconfigure/src/main/java/org/springframework/boot/autoconfigure/jmx/JmxAutoConfiguration.java) class for more details.
