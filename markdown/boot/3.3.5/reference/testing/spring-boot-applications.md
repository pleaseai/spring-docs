...
> See the [`TypeExcludeFilter`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/context/TypeExcludeFilter.html) API documentation for details.
...
See the [`SpyBean`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/test/mock/mockito/SpyBean.html) API documentation for full details.
...
Data JPA tests may also inject a [`TestEntityManager`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/test/autoconfigure/orm/jpa/TestEntityManager.html) bean, which provides an alternative to the standard JPA `EntityManager` that is specifically designed for tests.
