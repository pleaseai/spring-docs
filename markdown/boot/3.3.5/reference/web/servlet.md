...
See [`WebProperties.Resources`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/autoconfigure/web/WebProperties.Resources.html) for more supported options.
...
`PathPatternParser` restricts usage of [some path pattern variants](https://docs.spring.io/spring-framework/reference/6.1/web/webmvc/mvc-controller/ann-requestmapping.html#mvc-ann-requestmapping-uri-templates).
...
[Global CORS configuration](https://docs.spring.io/spring-framework/reference/6.1/web/webmvc-cors.html#mvc-cors-global) can be defined by registering a `WebMvcConfigurer` bean with a customized `addCorsMappings(CorsRegistry)` method, as shown in the following example:
...
> If you need to register a `Filter` that interacts with other beans, consider using a [`DelegatingFilterProxyRegistrationBean`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/web/servlet/DelegatingFilterProxyRegistrationBean.html) instead.
...
> [!TIP]
> See the [`ServerProperties`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/autoconfigure/web/ServerProperties.html) class for a complete list.
...
See the [`ConfigurableServletWebServerFactory`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/web/servlet/server/ConfigurableServletWebServerFactory.html) API documentation for details.
