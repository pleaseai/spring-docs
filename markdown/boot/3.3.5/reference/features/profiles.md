...
See the `setAdditionalProfiles()` method in [`SpringApplication`](https://docs.spring.io/spring-boot/3.3.5/api/java/org/springframework/boot/SpringApplication.html).
