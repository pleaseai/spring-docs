...
The [`XAConnectionFactoryWrapper`](https://docs.spring.io/spring-boot/3.4.4/api/java/org/springframework/boot/jms/XAConnectionFactoryWrapper.html) and [`XADataSourceWrapper`](https://docs.spring.io/spring-boot/3.4.4/api/java/org/springframework/boot/jdbc/XADataSourceWrapper.html) interfaces can be used to support embedded transaction managers.
