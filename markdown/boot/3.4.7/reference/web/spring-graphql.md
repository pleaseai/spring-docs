...
- [`QuerydslPredicateExecutor`](https://docs.spring.io/spring-data/commons/docs/3.4.x/api/org/springframework/data/querydsl/QuerydslPredicateExecutor.html)
- [`ReactiveQuerydslPredicateExecutor`](https://docs.spring.io/spring-data/commons/docs/3.4.x/api/org/springframework/data/querydsl/ReactiveQuerydslPredicateExecutor.html)
- [`QueryByExampleExecutor`](https://docs.spring.io/spring-data/commons/docs/3.4.x/api/org/springframework/data/repository/query/QueryByExampleExecutor.html)
- [`ReactiveQueryByExampleExecutor`](https://docs.spring.io/spring-data/commons/docs/3.4.x/api/org/springframework/data/repository/query/ReactiveQueryByExampleExecutor.html)
