...
The core class used to support loading nested jars is [`NestedJarFile`](https://docs.spring.io/spring-boot/3.3.6/api/java/org/springframework/boot/loader/jar/NestedJarFile.html).
...
[`NestedJarFile`](https://docs.spring.io/spring-boot/3.3.6/api/java/org/springframework/boot/loader/jar/NestedJarFile.html) extends from [`JarFile`](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/util/jar/JarFile.html) and should work as a drop-in replacement.
