...
- [Reference](https://docs.spring.io/spring-boot/3.4.6/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.4.6/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/3.4.6/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.4.6/gradle-plugin/api/java/index.html)
