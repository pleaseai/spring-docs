...
- [Reference](https://docs.spring.io/spring-boot/3.5.8/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.5.8/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/3.5.8/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.5.8/gradle-plugin/api/java/index.html)
