...
source: "reference:native-image/advanced-topics.adoc"
---

<a id="native-image.advanced"></a>

# Advanced Native Images Topics

<a id="native-image.advanced.nested-configuration-properties"></a>
...
<a id="native-image.advanced.converting-executable-jars"></a>
...
<a id="native-image.advanced.converting-executable-jars.buildpacks"></a>
...
<a id="native-image.advanced.converting-executable-jars.native-image"></a>
...
<a id="native-image.advanced.using-the-tracing-agent"></a>
...
<a id="native-image.advanced.using-the-tracing-agent.launch"></a>
...
<a id="native-image.advanced.custom-hints"></a>
...
If you have classes which need binding (mostly needed when serializing or deserializing JSON), you can use [`@RegisterReflectionForBinding`](https://docs.spring.io/spring-framework/reference/6.1.8/core/aot.html#aot.hints.register-reflection-for-binding) on any bean.
...
<a id="native-image.advanced.custom-hints.testing"></a>
...
<a id="native-image.advanced.known-limitations"></a>
