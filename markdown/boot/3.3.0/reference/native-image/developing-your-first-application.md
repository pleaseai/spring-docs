...
source: "reference:native-image/developing-your-first-application.adoc"
---

<a id="native-image.developing-your-first-application"></a>
...
<a id="native-image.developing-your-first-application.sample-application"></a>

## Sample Application

We need an example application that we can use to create our native image.
For our purposes, the simple “Hello World!” web application that’s covered in the “[Developing Your First Spring Boot Application](../../tutorial/first-application/index.md)” section will suffice.
...
<a id="native-image.developing-your-first-application.buildpacks"></a>
...
<a id="native-image.developing-your-first-application.buildpacks.system-requirements"></a>
...
> Check the [Maven](https://docs.spring.io/spring-boot/3.3.0/maven-plugin/build-image.html#build-image.docker-daemon) or [Gradle](https://docs.spring.io/spring-boot/3.3.0/gradle-plugin/packaging-oci-image.html#build-image.docker-daemon) Spring Boot plugin documentation for more details.
...
<a id="native-image.developing-your-first-application.buildpacks.maven"></a>
...
<a id="native-image.developing-your-first-application.buildpacks.gradle"></a>
...
<a id="native-image.developing-your-first-application.buildpacks.running"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools.prerequisites"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools.prerequisites.linux-macos"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools.prerequisites.windows"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools.maven"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools.gradle"></a>
...
<a id="native-image.developing-your-first-application.native-build-tools.running"></a>
