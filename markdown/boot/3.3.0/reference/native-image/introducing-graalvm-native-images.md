...
source: "reference:native-image/introducing-graalvm-native-images.adoc"
---

<a id="native-image.introducing-graalvm-native-images"></a>
...
> [!TIP]
> If you just want to get started and experiment with GraalVM you can skip ahead to the “[Developing Your First GraalVM Native Application](developing-your-first-application.md)” section and return to this section later.

<a id="native-image.introducing-graalvm-native-images.key-differences-with-jvm-deployments"></a>
...
On top of those differences, Spring uses a process called [Spring Ahead-of-Time processing](#native-image.introducing-graalvm-native-images.understanding-aot-processing), which imposes further limitations.
...
<a id="native-image.introducing-graalvm-native-images.understanding-aot-processing"></a>
...
A closed-world assumption implies, besides [the limitations created by GraalVM itself](#native-image.introducing-graalvm-native-images.key-differences-with-jvm-deployments), the following restrictions:
...
<a id="native-image.introducing-graalvm-native-images.understanding-aot-processing.source-code-generation"></a>
...
<a id="native-image.introducing-graalvm-native-images.understanding-aot-processing.hint-file-generation"></a>
...
<a id="native-image.introducing-graalvm-native-images.understanding-aot-processing.proxy-class-generation"></a>
