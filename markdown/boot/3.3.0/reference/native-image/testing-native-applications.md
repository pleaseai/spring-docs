...
source: "reference:native-image/testing-native-applications.adoc"
---

<a id="native-image.testing"></a>
...
<a id="native-image.testing.with-the-jvm"></a>
...
<a id="native-image.testing.with-native-build-tools"></a>
...
You can also use Spring Boot [test slices](../testing/spring-boot-applications.md#testing.spring-boot-applications.autoconfigured-tests) to test only specific parts of your application.
...
<a id="native-image.testing.with-native-build-tools.maven"></a>
...
<a id="native-image.testing.with-native-build-tools.gradle"></a>
