...
(See the [relevant section](https://docs.spring.io/spring-framework/reference/6.1.8/integration/jms.html) of the Spring Framework reference documentation for details.)
...
> [!TIP]
> See [`ActiveMQProperties`](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/autoconfigure/jms/activemq/ActiveMQProperties.html) for more of the supported options.
...
See [`ArtemisProperties`](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/autoconfigure/jms/artemis/ArtemisProperties.html) for more supported options.
...
> [!NOTE]
> [`JmsMessagingTemplate`](https://docs.spring.io/spring-framework/docs/6.1.8/javadoc-api/org/springframework/jms/core/JmsMessagingTemplate.html) can be injected in a similar manner.
...
> [!TIP]
> See [the Javadoc of `@EnableJms`](https://docs.spring.io/spring-framework/docs/6.1.8/javadoc-api/org/springframework/jms/annotation/EnableJms.html) for more details.
