...
See [`KafkaProperties`](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/autoconfigure/kafka/KafkaProperties.html) for more supported options.
