...
See [`DataSourceProperties`](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/autoconfigure/jdbc/DataSourceProperties.html) for more of the supported options.
...
For more complex queries, you can annotate your method with Spring Data’s [`Query`](https://docs.spring.io/spring-data/jpa/docs/3.3.0/api/org/springframework/data/jpa/repository/Query.html) annotation.

Spring Data repositories usually extend from the [`Repository`](https://docs.spring.io/spring-data/commons/docs/3.3.0/api/org/springframework/data/repository/Repository.html) or [`CrudRepository`](https://docs.spring.io/spring-data/commons/docs/3.3.0/api/org/springframework/data/repository/CrudRepository.html) interfaces.
...
> For complete details, see the [Spring Data JPA reference documentation](https://docs.spring.io/spring-data/jpa/reference/3.3.0).
...
> [!NOTE]
> For more details, check the [Spring Data Envers reference documentation](https://docs.spring.io/spring-data/jpa/reference/3.3.0/envers.html).
...
If you are running a web application, Spring Boot by default registers [`OpenEntityManagerInViewInterceptor`](https://docs.spring.io/spring-framework/docs/6.1.8/javadoc-api/org/springframework/orm/jpa/support/OpenEntityManagerInViewInterceptor.html) to apply the “Open EntityManager in View” pattern, to allow for lazy loading in web views.
...
> [!TIP]
> For complete details of Spring Data JDBC, see the [reference documentation](https://docs.spring.io/spring-data/relational/reference/3.3.0).
...
You can follow the instructions in the [jOOQ user manual](https://www.jooq.org/doc/3.19.8/manual-single-page/#jooq-in-7-steps-step3).
...
For more complex queries, you can annotate your method with Spring Data’s [`Query`](https://docs.spring.io/spring-data/r2dbc/docs/3.3.0/api/org/springframework/data/r2dbc/repository/Query.html) annotation.
...
> [!TIP]
> We have barely scratched the surface of Spring Data R2DBC. For complete details, see the [Spring Data R2DBC reference documentation](https://docs.spring.io/spring-data/relational/reference/3.3.0).
