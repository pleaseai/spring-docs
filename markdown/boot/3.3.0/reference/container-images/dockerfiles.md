---
title: "Dockerfiles"
source: "reference:container-images/dockerfiles.adoc"
---

<a id="container-images.dockerfiles"></a>

# Dockerfiles

While it is possible to convert a Spring Boot uber jar into a docker image with just a few lines in the Dockerfile, we will use the [layering feature](efficient-images.md#container-images.efficient-images.layering) to create an optimized docker image.
...
> [!CAUTION]
> The `tools` mode can not be used with a [fully executable Spring Boot archive](../deployment/installing.md) that includes a launch script.
