...
> [!TIP]
> See the [reference documentation](https://docs.spring.io/spring-framework/reference/6.1.8/integration/email.html) for a detailed explanation of how you can use `JavaMailSender`.
...
See [`MailProperties`](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/autoconfigure/mail/MailProperties.html) for more details.
