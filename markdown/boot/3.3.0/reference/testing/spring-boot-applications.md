...
> See [the Javadoc](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/context/TypeExcludeFilter.html) for details.
...
With Spring MVC, we can query our web endpoints using [`MockMvc`](https://docs.spring.io/spring-framework/reference/6.1.8/testing/spring-mvc-test-framework.html) or `WebTestClient`, as shown in the following example:
...
With Spring WebFlux endpoints, you can use [`WebTestClient`](https://docs.spring.io/spring-framework/reference/6.1.8/testing/webtestclient.html) as shown in the following example:
...
For convenience, tests that need to make REST calls to the started server can additionally `@Autowire` a [`WebTestClient`](https://docs.spring.io/spring-framework/reference/6.1.8/testing/webtestclient.html), which resolves relative links to the running server and comes with a dedicated API for verifying responses, as shown in the following example:
...
See the [Javadoc](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/test/mock/mockito/SpyBean.html) for full details.
...
To test that [Spring WebFlux](https://docs.spring.io/spring-framework/reference/6.1.8/web-reactive.html) controllers are working as expected, you can use the `@WebFluxTest` annotation.
...
`@WebFluxTest` also auto-configures [`WebTestClient`](https://docs.spring.io/spring-framework/reference/6.1.8/testing/webtestclient.html), which offers a powerful way to quickly test WebFlux controllers without needing to start a full HTTP server.
...
See the [relevant section](https://docs.spring.io/spring-framework/reference/6.1.8/testing/testcontext-framework/tx.html#testcontext-tx-enabling-transactions) in the Spring Framework Reference Documentation for more details.
...
Data JPA tests may also inject a [`TestEntityManager`](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/test/autoconfigure/orm/jpa/TestEntityManager.html) bean, which provides an alternative to the standard JPA `EntityManager` that is specifically designed for tests.
