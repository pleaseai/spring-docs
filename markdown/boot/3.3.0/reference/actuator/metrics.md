...
- [Simple (in-memory)](#actuator.metrics.export.simple)
...
If you use [Micrometer Tracing](https://micrometer.io/docs/tracing), this will be auto-configured for you, but you can always create your own if you want.
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.8/integration/observability.html#observability.jms).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.8/integration/observability.html#observability.http-server.servlet).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.8/integration/observability.html#observability.http-server.reactive).
...
See the [Spring Framework reference documentation for more information on produced observations](https://docs.spring.io/spring-framework/reference/6.1.8/integration/observability.html#observability.http-client).
...
For more details on the concepts behind `percentiles-histogram`, `percentiles`, and `slo`, see the [“Histograms and percentiles” section](https://docs.micrometer.io/micrometer/reference/1.13/concepts#_histograms_and_percentiles) of the Micrometer documentation.
