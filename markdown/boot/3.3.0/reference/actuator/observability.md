...
For metrics and traces, Spring Boot uses [Micrometer Observation](https://micrometer.io/docs/observation).
...
For more details about observations please see the [Micrometer Observation documentation](https://micrometer.io/docs/observation).
