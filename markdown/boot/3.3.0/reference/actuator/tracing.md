...
- `io.opentelemetry:opentelemetry-exporter-zipkin` - reports [traces](https://micrometer.io/docs/tracing#_glossary) to Zipkin.
...
> [!TIP]
> If you want to create a span without creating a metric, you need to use the [lower-level `Tracer` API](https://micrometer.io/docs/tracing#_using_micrometer_tracing_directly) from Micrometer.
