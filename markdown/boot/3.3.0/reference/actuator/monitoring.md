...
> [!NOTE]
> Jackson is a required dependency in order to get the correct JSON responses as documented in the [API documentation](https://docs.spring.io/spring-boot/3.3.0/api/rest/actuator/index.html).
