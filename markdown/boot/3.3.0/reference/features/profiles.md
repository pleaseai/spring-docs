...
See the `setAdditionalProfiles()` method in [SpringApplication](https://docs.spring.io/spring-boot/3.3.0/api/java/org/springframework/boot/SpringApplication.html).
...
See "[Profile Specific Files](external-config.md#features.external-config.files.profile-specific)" for details.
