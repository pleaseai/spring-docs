...
- **From 1.x:** [Upgrading from 1.x](upgrading.md#upgrading.from-1x)
...
- **Efficient Container Images:** [Tips to optimize container images such as Docker images](reference/container-images/efficient-images.md)
- **Dockerfiles:** [Building container images using dockerfiles](reference/container-images/dockerfiles.md)
- **Cloud Native Buildpacks:** [Support for Cloud Native Buildpacks with Maven and Gradle](reference/container-images/cloud-native-buildpacks.md)
...
<a id="documentation.native-images"></a>
...
- **GraalVM Native Images:** [Introduction](reference/native-image/introducing-graalvm-native-images.md) | [Key Differences with the JVM](reference/native-image/introducing-graalvm-native-images.md#native-image.introducing-graalvm-native-images.key-differences-with-jvm-deployments) | [Ahead-of-Time Processing](reference/native-image/introducing-graalvm-native-images.md#native-image.introducing-graalvm-native-images.understanding-aot-processing)
- **Getting Started:** [Buildpacks](reference/native-image/developing-your-first-application.md#native-image.developing-your-first-application.buildpacks) | [Native Build Tools](reference/native-image/developing-your-first-application.md#native-image.developing-your-first-application.native-build-tools)
- **Testing:** [JVM](reference/native-image/testing-native-applications.md#native-image.testing.with-the-jvm) | [Native Build Tools](reference/native-image/testing-native-applications.md#native-image.testing.with-native-build-tools)
- **Advanced Topics:** [Nested Configuration Properties](reference/native-image/advanced-topics.md#native-image.advanced.nested-configuration-properties) | [Converting JARs](reference/native-image/advanced-topics.md#native-image.advanced.converting-executable-jars) | [Known Limitations](reference/native-image/advanced-topics.md#native-image.advanced.known-limitations)
...
- **Spring Boot Applications Deployment:** [Cloud Deployment](reference/deployment/cloud.md) | [OS Service](reference/deployment/installing.md)
- **Build tool plugins:** [Maven](https://docs.spring.io/spring-boot/3.3.0/maven-plugin/index.html) | [Gradle](https://docs.spring.io/spring-boot/3.3.0/gradle-plugin/index.html)
