...
You can also use `logback-spring.xml` if you want to use the [Spring Boot Logback extensions](../reference/features/logging.md#features.logging.logback-extensions).
