...
Ahead-of-time processing optimizes the application and evaluates [conditions](https://docs.spring.io/spring-framework/docs/6.1.8/javadoc-api/org/springframework/context/annotation/Conditional.html) based on the environment at build time.
