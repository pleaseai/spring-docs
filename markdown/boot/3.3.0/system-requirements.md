...
Spring Boot 3.3.0 requires [Java 17](https://www.java.com) and is compatible up to and including Java 22.
[Spring Framework 6.1.8](https://docs.spring.io/spring-framework/reference/6.1.8/) or above is also required.
...
Spring Boot applications can be [converted into a Native Image](reference/native-image/introducing-graalvm-native-images.md) using GraalVM 22.3 or above.
