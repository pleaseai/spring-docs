...
> See the [MVC section](https://docs.spring.io/spring-framework/reference/6.1.8/web/webmvc.html) in the Spring Reference Documentation for more details.
...
> See the [plugin documentation](https://docs.spring.io/spring-boot/3.3.0/maven-plugin/getting-started.html) for details.
...
[INFO]
[INFO] --- spring-boot-maven-plugin:3.3.0:repackage (default) @ myproject ---
[INFO] ------------------------------------------------------------------------
[INFO] BUILD SUCCESS
[INFO] ------------------------------------------------------------------------
```
