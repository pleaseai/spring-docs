...
You can take control of Spring HATEOAS’s configuration by using [`@EnableHypermediaSupport`](https://docs.spring.io/spring-hateoas/docs/2.5.x/api/org/springframework/hateoas/config/EnableHypermediaSupport.html).
Note that doing so disables the [`ObjectMapper`](https://javadoc.io/doc/com.fasterxml.jackson.core/jackson-databind/2.19.4/com/fasterxml/jackson/databind/ObjectMapper.html) customization described earlier.
