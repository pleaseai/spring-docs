...
Spring Boot 3.4.0 requires at least [Java 17](https://www.java.com) and is compatible with versions up to and including Java 23.
[Spring Framework 6.2.0](https://docs.spring.io/spring-framework/reference/6.2/) or above is also required.
