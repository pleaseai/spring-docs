...
See [`RabbitProperties`](https://docs.spring.io/spring-boot/3.4.2/api/java/org/springframework/boot/autoconfigure/amqp/RabbitProperties.html) for more of the supported property-based configuration options.
To configure lower-level details of the RabbitMQ [`ConnectionFactory`](https://rabbitmq.github.io/rabbitmq-java-client/api/current/com/rabbitmq/client/ConnectionFactory.html) that is used by Spring AMQP, define a [`ConnectionFactoryCustomizer`](https://docs.spring.io/spring-boot/3.4.2/api/java/org/springframework/boot/autoconfigure/amqp/ConnectionFactoryCustomizer.html) bean.
