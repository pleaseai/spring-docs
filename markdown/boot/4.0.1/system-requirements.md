...
Spring Boot 4.0.1 requires at least [Java 17](https://www.java.com) and is compatible with versions up to and including Java 25.
[Spring Framework 7.0.2](https://docs.spring.io/spring-framework/reference/7.0/) or above is also required.
