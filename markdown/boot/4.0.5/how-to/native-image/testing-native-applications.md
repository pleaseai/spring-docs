...
For example, you can continue to use the [`@SpringBootTest`](https://docs.spring.io/spring-boot/4.0.5/api/java/org/springframework/boot/test/context/SpringBootTest.html) annotation.
