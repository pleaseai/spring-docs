...
Note that doing so disables the [`JsonMapper`](https://javadoc.io/doc/tools.jackson.core/jackson-databind/3.1.0/tools/jackson/databind/json/JsonMapper.html) customization described earlier.
