...
Deprecation can also be specified declaratively in code by adding the [`@DeprecatedConfigurationProperty`](https://docs.spring.io/spring-boot/3.5.2/api/java/org/springframework/boot/context/properties/DeprecatedConfigurationProperty.html) annotation to the getter exposing the deprecated property.
