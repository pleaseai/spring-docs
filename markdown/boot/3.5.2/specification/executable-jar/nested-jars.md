---
title: "Nested JARs"
source: "specification:executable-jar/nested-jars.adoc"
---

<a id="appendix.executable-jar.nested-jars"></a>
...
<a id="appendix.executable-jar.nested-jars.jar-structure"></a>
...
<a id="appendix.executable-jar.nested-jars.war-structure"></a>
...
<a id="appendix.executable-jar.nested-jars.index-files"></a>
...
These files, however, are *not* parsed internally as YAML and they must be written in exactly the formats described below in order to be used.

<a id="appendix.executable-jar.nested-jars.classpath-index"></a>
...
> [!NOTE]
> Spring Boot only uses the classpath index file when the jar or war file is executed with `java -jar`.
...
<a id="appendix.executable-jar.nested-jars.layer-index"></a>
