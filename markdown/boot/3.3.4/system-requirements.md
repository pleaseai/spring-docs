...
Spring Boot 3.3.4 requires [Java 17](https://www.java.com) and is compatible up to and including Java 22.
[Spring Framework 6.1.13](https://docs.spring.io/spring-framework/reference/6.1/) or above is also required.
