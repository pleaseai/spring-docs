...
See the individual plugin documentation on how to use buildpacks with [Maven](https://docs.spring.io/spring-boot/4.0.6/maven-plugin/build-image.html#build-image) and [Gradle](https://docs.spring.io/spring-boot/4.0.6/gradle-plugin/packaging-oci-image.html).
