...
- [Reference](https://docs.spring.io/spring-boot/4.0.6/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/4.0.6/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/4.0.6/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/4.0.6/gradle-plugin/api/java/index.html)
...
<project
	...
	<property name="spring-boot.version" value="4.0.6" />
