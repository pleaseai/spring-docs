...
When using [`JdbcConnectionDetails`](https://docs.spring.io/spring-boot/4.0.6/api/java/org/springframework/boot/jdbc/autoconfigure/JdbcConnectionDetails.html) with Docker Compose, the parameters of the JDBC URL
