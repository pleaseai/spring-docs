...
- [Reference](https://docs.spring.io/spring-boot/4.0.4/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/4.0.4/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/4.0.4/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/4.0.4/gradle-plugin/api/java/index.html)
...
<project
	...
	<property name="spring-boot.version" value="4.0.4" />
