...
- [`QuerydslPredicateExecutor`](https://docs.spring.io/spring-data/commons/docs/4.0.x/api/org/springframework/data/querydsl/QuerydslPredicateExecutor.html)
- [`ReactiveQuerydslPredicateExecutor`](https://docs.spring.io/spring-data/commons/docs/4.0.x/api/org/springframework/data/querydsl/ReactiveQuerydslPredicateExecutor.html)
- [`QueryByExampleExecutor`](https://docs.spring.io/spring-data/commons/docs/4.0.x/api/org/springframework/data/repository/query/QueryByExampleExecutor.html)
- [`ReactiveQueryByExampleExecutor`](https://docs.spring.io/spring-data/commons/docs/4.0.x/api/org/springframework/data/repository/query/ReactiveQueryByExampleExecutor.html)
...
> [!TIP]
> The HTTP endpoint for both Spring MVC and Spring WebFlux is provided by a `RouterFunction` bean with an [`@Order`](https://docs.spring.io/spring-framework/docs/7.0.x/javadoc-api/org/springframework/core/annotation/Order.html) of `0`.
> If you define your own `RouterFunction` beans, you may want to add appropriate [`@Order`](https://docs.spring.io/spring-framework/docs/7.0.x/javadoc-api/org/springframework/core/annotation/Order.html) annotations to ensure that they are sorted correctly.
