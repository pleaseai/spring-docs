...
> [!TIP]
> To create a topic on startup, add a bean of type [`NewTopic`](https://kafka.apache.org/42/javadoc/org/apache/kafka/clients/admin/NewTopic.html).
> If the topic already exists, the bean is ignored.

See [`KafkaProperties`](https://docs.spring.io/spring-boot/4.1.1/api/java/org/springframework/boot/kafka/autoconfigure/KafkaProperties.html) for more supported options.
...
> [!NOTE]
> If the property `spring.kafka.producer.transaction-id-prefix` is defined, a [`KafkaTransactionManager`](https://docs.spring.io/spring-kafka/docs/4.1.x/api/org/springframework/kafka/transaction/KafkaTransactionManager.html) is automatically configured.
...
Only a subset of the properties supported by Kafka are available directly through the [`KafkaProperties`](https://docs.spring.io/spring-boot/4.1.1/api/java/org/springframework/boot/kafka/autoconfigure/KafkaProperties.html) class.
