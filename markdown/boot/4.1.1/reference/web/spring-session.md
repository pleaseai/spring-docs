...
To provide the timeout programmatically, define a [`SessionTimeout`](https://docs.spring.io/spring-boot/4.1.1/api/java/org/springframework/boot/session/autoconfigure/SessionTimeout.html) bean.
