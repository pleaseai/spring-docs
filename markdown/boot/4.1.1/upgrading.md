...
Check also the [release notes](https://github.com/spring-projects/spring-boot/wiki#release-notes) for a list of “new and noteworthy” features for each release.
...
<a id="upgrading.from-3x"></a>

## Upgrading From 3.x

If you are upgrading from the `3.x` release of Spring Boot, check the [migration guide](https://github.com/spring-projects/spring-boot/wiki/Spring-Boot-4.0-Migration-Guide) on the project wiki that provides detailed upgrade instructions.
Check also the [release notes](https://github.com/spring-projects/spring-boot/wiki#release-notes) for a list of “new and noteworthy” features for each release.
...
> [!WARNING]
> Properties that are added late to the environment, such as when using [`@PropertySource`](https://docs.spring.io/spring-framework/docs/7.0.x/javadoc-api/org/springframework/context/annotation/PropertySource.html), will not be taken into account.
