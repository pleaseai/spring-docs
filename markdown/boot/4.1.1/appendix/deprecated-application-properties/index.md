...
| --- | --- | --- |
| <a id="application-properties.actuator.management.dynatrace.metrics.export.v1.device-id"></a>[`management.dynatrace.metrics.export.v1.device-id`](#application-properties.actuator.management.dynatrace.metrics.export.v1.device-id) | Dynatrace V1 API is deprecated, use the V2 API instead. |  |
| <a id="application-properties.actuator.management.dynatrace.metrics.export.v1.group"></a>[`management.dynatrace.metrics.export.v1.group`](#application-properties.actuator.management.dynatrace.metrics.export.v1.group) | Dynatrace V1 API is deprecated, use the V2 API instead. |  |
| <a id="application-properties.actuator.management.dynatrace.metrics.export.v1.technology-type"></a>[`management.dynatrace.metrics.export.v1.technology-type`](#application-properties.actuator.management.dynatrace.metrics.export.v1.technology-type) | Dynatrace V1 API is deprecated, use the V2 API instead. | `java` |
...
<a id="appendix.deprecated-application-properties.devtools"></a>

## Deprecated Devtools Properties

| Name | Description | Default Value |
| --- | --- | --- |
| <a id="application-properties.devtools.spring.devtools.livereload.enabled"></a>[`spring.devtools.livereload.enabled`](#application-properties.devtools.spring.devtools.livereload.enabled) | Deprecated with no replacement | `false` |
| <a id="application-properties.devtools.spring.devtools.livereload.port"></a>[`spring.devtools.livereload.port`](#application-properties.devtools.spring.devtools.livereload.port) | Deprecated with no replacement | `35729` |
