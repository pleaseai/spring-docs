...
Spring Boot 3.4.11 requires at least [Java 17](https://www.java.com) and is compatible with versions up to and including Java 24.
[Spring Framework 6.2.12](https://docs.spring.io/spring-framework/reference/6.2/) or above is also required.
