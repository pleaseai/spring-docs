...
> If you need to customize the task executor, consider implementing [`SchedulerFactoryBeanCustomizer`](https://docs.spring.io/spring-boot/3.5.9/api/java/org/springframework/boot/autoconfigure/quartz/SchedulerFactoryBeanCustomizer.html).
