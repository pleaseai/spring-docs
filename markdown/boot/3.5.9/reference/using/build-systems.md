...
- [Reference](https://docs.spring.io/spring-boot/3.5.9/maven-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.5.9/maven-plugin/api/java/index.html)
...
- [Reference](https://docs.spring.io/spring-boot/3.5.9/gradle-plugin/index.html)
- [API](https://docs.spring.io/spring-boot/3.5.9/gradle-plugin/api/java/index.html)
...
<project
	...
	<property name="spring-boot.version" value="3.5.9" />
