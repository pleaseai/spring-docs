...
[Spring MVC](https://docs.spring.io/spring-framework/reference/6.1.11/web/webmvc-cors.html) and [Spring WebFlux](https://docs.spring.io/spring-framework/reference/6.1.11/web/webflux-cors.html) support CORS (Cross-Origin Resource Sharing) requests.
