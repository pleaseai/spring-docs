...
> [!NOTE]
> Check the [relevant section](https://docs.spring.io/spring-framework/reference/6.1.11/integration/cache.html) of the Spring Framework reference for more details.
...
> [!TIP]
> It is also possible to transparently [update](https://docs.spring.io/spring-framework/reference/6.1.11/integration/cache/annotations.html#cache-annotations-put) or [evict](https://docs.spring.io/spring-framework/reference/6.1.11/integration/cache/annotations.html#cache-annotations-evict) data from the cache.
...
If Spring Data Couchbase is available and Couchbase is [configured](../data/nosql.md#data.nosql.couchbase), a `CouchbaseCacheManager` is auto-configured.
