...
You can learn more about AOP with Spring in the [Spring Framework reference documentation](https://docs.spring.io/spring-framework/reference/6.1.11/core/aop-api.html).
