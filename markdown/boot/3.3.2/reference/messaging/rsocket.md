...
See the [RSocket section](https://docs.spring.io/spring-framework/reference/6.1.11/rsocket.html#rsocket-spring) of the Spring Framework reference for more details, including an overview of the RSocket protocol.
