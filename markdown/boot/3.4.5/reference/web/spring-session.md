...
1. Hazelcast
1. MongoDB
1. If none of Redis, JDBC, Hazelcast and MongoDB are available, we do not configure a [`SessionRepository`](https://docs.spring.io/spring-session/docs/3.4.x/api/org/springframework/session/SessionRepository.html).
...
1. Redis
1. MongoDB
1. If neither Redis nor MongoDB are available, we do not configure a [`ReactiveSessionRepository`](https://docs.spring.io/spring-session/docs/3.4.x/api/org/springframework/session/ReactiveSessionRepository.html).
