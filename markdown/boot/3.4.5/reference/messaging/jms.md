...
> [!TIP]
> See [`ActiveMQProperties`](https://docs.spring.io/spring-boot/3.4.5/api/java/org/springframework/boot/autoconfigure/jms/activemq/ActiveMQProperties.html) for more of the supported options.
> You can also register an arbitrary number of beans that implement [`ActiveMQConnectionFactoryCustomizer`](https://docs.spring.io/spring-boot/3.4.5/api/java/org/springframework/boot/autoconfigure/jms/activemq/ActiveMQConnectionFactoryCustomizer.html) for more advanced customizations.
...
See [`ArtemisProperties`](https://docs.spring.io/spring-boot/3.4.5/api/java/org/springframework/boot/autoconfigure/jms/artemis/ArtemisProperties.html) for more supported options.
...
The auto-configuration uses [`ConnectionFactoryUnwrapper`](https://docs.spring.io/spring-boot/3.4.5/api/java/org/springframework/boot/jms/ConnectionFactoryUnwrapper.html) to unwrap the native connection factory from the auto-configured one.
