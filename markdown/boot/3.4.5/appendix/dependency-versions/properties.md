...
Browse the [`spring-boot-dependencies` build.gradle](https://github.com/spring-projects/spring-boot/tree/v3.4.5/spring-boot-project/spring-boot-dependencies/build.gradle) for a complete list of dependencies.
