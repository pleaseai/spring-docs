...
- **From 3.x:** [Upgrading from 3.x](upgrading.md#upgrading.from-3x)
...
- **AOT cache:** [Overview](reference/packaging/aot-cache.md)
...
- **Build tool plugins:** [Maven](https://docs.spring.io/spring-boot/4.0.3/maven-plugin/index.html) | [Gradle](https://docs.spring.io/spring-boot/4.0.3/gradle-plugin/index.html)
