...
Only a subset of the properties supported by Pulsar are available directly through the [`PulsarProperties`](https://docs.spring.io/spring-boot/4.0.3/api/java/org/springframework/boot/pulsar/autoconfigure/PulsarProperties.html) class.
