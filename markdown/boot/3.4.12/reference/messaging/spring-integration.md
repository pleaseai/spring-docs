...
If Spring Integration is available on your classpath, it is initialized through the [`@EnableIntegration`](https://docs.spring.io/spring-integration/docs/6.4.x/api/org/springframework/integration/config/EnableIntegration.html) annotation.
...
The default [`PollerMetadata`](https://docs.spring.io/spring-integration/docs/6.4.x/api/org/springframework/integration/scheduling/PollerMetadata.html) (poll unbounded number of messages every second) can be customized with `spring.integration.poller.*` configuration properties.
...
See the [`IntegrationAutoConfiguration`](https://github.com/spring-projects/spring-boot/tree/v3.4.12/spring-boot-project/spring-boot-autoconfigure/src/main/java/org/springframework/boot/autoconfigure/integration/IntegrationAutoConfiguration.java) and [`IntegrationProperties`](https://docs.spring.io/spring-boot/3.4.12/api/java/org/springframework/boot/autoconfigure/integration/IntegrationProperties.html) classes for more details.
