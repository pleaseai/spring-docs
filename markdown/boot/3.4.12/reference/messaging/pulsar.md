...
When you use the Pulsar starter, Spring Boot will auto-configure and register a [`PulsarClient`](https://javadoc.io/doc/org.apache.pulsar/pulsar-client-api/3.3.9/org/apache/pulsar/client/api/PulsarClient.html) bean.
...
Only a subset of the properties supported by Pulsar are available directly through the [`PulsarProperties`](https://docs.spring.io/spring-boot/3.4.12/api/java/org/springframework/boot/autoconfigure/pulsar/PulsarProperties.html) class.
