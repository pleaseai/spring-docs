...
See [`DataSourceProperties`](https://docs.spring.io/spring-boot/3.3.8/api/java/org/springframework/boot/autoconfigure/jdbc/DataSourceProperties.html) API documentation for more of the supported options.
...
Additional connection pools can always be configured manually, using [`DataSourceBuilder`](https://docs.spring.io/spring-boot/3.3.8/api/java/org/springframework/boot/jdbc/DataSourceBuilder.html).
...
The following connection pools are supported by [`DataSourceBuilder`](https://docs.spring.io/spring-boot/3.3.8/api/java/org/springframework/boot/jdbc/DataSourceBuilder.html):
...
> [!TIP]
> You can customize entity scanning locations by using the [`@EntityScan`](https://docs.spring.io/spring-boot/3.3.8/api/java/org/springframework/boot/autoconfigure/domain/EntityScan.html) annotation.
...
You can follow the instructions in the [jOOQ user manual](https://www.jooq.org/doc/3.19.18/manual-single-page/#jooq-in-7-steps-step3).
...
The fluent API offered by jOOQ is initiated through the [`DSLContext`](https://www.jooq.org/javadoc/3.19.18/org/jooq/DSLContext.html) interface.
Spring Boot auto-configures a [`DSLContext`](https://www.jooq.org/javadoc/3.19.18/org/jooq/DSLContext.html) as a Spring Bean and connects it to your application [`DataSource`](https://docs.oracle.com/en/java/javase/17/docs/api/java.sql/javax/sql/DataSource.html).
To use the [`DSLContext`](https://www.jooq.org/javadoc/3.19.18/org/jooq/DSLContext.html), you can inject it, as shown in the following example:
...
> [!TIP]
> The jOOQ manual tends to use a variable named `create` to hold the [`DSLContext`](https://www.jooq.org/javadoc/3.19.18/org/jooq/DSLContext.html).

You can then use the [`DSLContext`](https://www.jooq.org/javadoc/3.19.18/org/jooq/DSLContext.html) to construct your queries, as shown in the following example:
...
More advanced customizations can be achieved by defining your own [`DefaultConfigurationCustomizer`](https://docs.spring.io/spring-boot/3.3.8/api/java/org/springframework/boot/autoconfigure/jooq/DefaultConfigurationCustomizer.html) bean that will be invoked prior to creating the [`Configuration`](https://www.jooq.org/javadoc/3.19.18/org/jooq/Configuration.html) [`@Bean`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/context/annotation/Bean.html).
This takes precedence to anything that is applied by the auto-configuration.

You can also create your own [`Configuration`](https://www.jooq.org/javadoc/3.19.18/org/jooq/Configuration.html) [`@Bean`](https://docs.spring.io/spring-framework/docs/6.1.x/javadoc-api/org/springframework/context/annotation/Bean.html) if you want to take complete control of the jOOQ configuration.
