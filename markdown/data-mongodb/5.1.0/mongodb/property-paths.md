...
source: "ROOT:mongodb/property-paths.adoc"
---
...
1. Reference the entire `previousAddresses` collection (supported by certain technologies for collection-based sorting).
1. Navigate through the collection to sort by the `city` field of each address.
...
See [Type-safe Property-References](#type-safe-property-references) for details.

> [!NOTE]
> For implementation details, refer to [Property Path Internals](#property-path-internals) for more information.

<a id="property-path-internals"></a>
...
<a id="type-safe-property-references"></a>
...
<a id="type-safe-property-references-recommendations"></a>
