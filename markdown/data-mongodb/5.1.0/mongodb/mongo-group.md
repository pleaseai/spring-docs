...
It can convert the results of the group operation to a POJO and also integrates with Spring’s [Resource abstraction](https://docs.spring.io/spring-framework/reference/7.0/core/resources.html) abstraction.
