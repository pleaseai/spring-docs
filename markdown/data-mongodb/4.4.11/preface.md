...
The Spring Data MongoDB 4.x binaries require JDK level 17 and above and [Spring Framework](https://spring.io/docs) 6.2.12 and above.

In terms of database and driver, you need at least version 4.x of [MongoDB](https://www.mongodb.org/) and a compatible MongoDB Java Driver (5.2.x).
