...
Spring Data MongoDB provides a [`GridFsOperations`](https://docs.spring.io/spring-data/mongodb/docs/5.0.3/api/org/springframework/data/mongodb/gridfs/GridFsOperations.html) and [`ReactiveGridFsOperations`](https://docs.spring.io/spring-data/mongodb/docs/5.0.3/api/org/springframework/data/mongodb/gridfs/ReactiveGridFsOperations.html) interface as well as the corresponding implementation, `GridFsTemplate` and `ReactiveGridFsTemplate`, to let you interact with the filesystem.
