...
You can disable lifecycle events on the [Template API](<https://docs.spring.io/spring-data/mongodb/docs/4.3.7/api/org/springframework/data/mongodb/core/MongoTemplate.html#setEntityLifecycleEventsEnabled(boolean)>).
