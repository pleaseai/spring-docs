...
Spring Data MongoDB provides a [`GridFsOperations`](https://docs.spring.io/spring-data/mongodb/docs/4.3.5/api/org/springframework/data/mongodb/gridfs/GridFsOperations.html) and [`ReactiveGridFsOperations`](https://docs.spring.io/spring-data/mongodb/docs/4.3.5/api/org/springframework/data/mongodb/gridfs/ReactiveGridFsOperations.html) interface as well as the corresponding implementation, `GridFsTemplate` and `ReactiveGridFsTemplate`, to let you interact with the filesystem.
