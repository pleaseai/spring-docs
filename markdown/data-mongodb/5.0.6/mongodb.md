...
- [QueryDSL integration](repositories/core-extensions.md#mongodb.repositories.queries.type-safe) to support type-safe queries.
...
- [Vector Index](mongodb/mongo-search-indexes.md#mongo.search.vector) and declarative [Vector Search](mongodb/repositories/vector-search.md) support.
- [Ahead Of Time (AOT)](mongodb/aot.md) optimizations.
