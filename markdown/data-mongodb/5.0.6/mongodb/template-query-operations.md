...
For more information, see the Javadoc of [`NearQuery`](https://docs.spring.io/spring-data/mongodb/docs/5.0.6/api/org/springframework/data/mongodb/core/query/NearQuery.html) and `Distance`.
