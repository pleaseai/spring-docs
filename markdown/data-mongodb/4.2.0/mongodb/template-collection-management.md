---
title: "Index and Collection Management"
source: "ROOT:mongodb/template-collection-management.adoc"
---

<a id="mongo-template.index-and-collections"></a>
...
<a id="mongo-template.index-and-collections.index"></a>
...
> [!NOTE]
> `Index` and `GeospatialIndex` support configuration of [collations](template-query-operations.md#mongo.query.collation).

<a id="mongo-template.index-and-collections.access"></a>
...
<a id="mongo-template.index-and-collections.collection"></a>
...
> [!NOTE]
> Collection creation allows customization with `CollectionOptions` and supports [collations](collation.md).
