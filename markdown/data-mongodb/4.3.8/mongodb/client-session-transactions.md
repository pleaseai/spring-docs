...
1. Use `MongoOperation` methods as before.
...
1. Use `ReactiveMongoOperation` methods as before.
The `ClientSession` is obtained and applied automatically.
1. Make sure to close the `ClientSession`.
1. Nothing happens until you subscribe.
See [the Project Reactor Reference Guide](https://projectreactor.io/docs/core/release/reference/#reactive.subscribe) for details.
...
1. Or of course, commit the changes in case of success.
...
<a id="mongo.transaction.options"></a>
