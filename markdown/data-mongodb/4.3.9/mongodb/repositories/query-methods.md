...
The definition may contain simple placeholders like `?0` as well as [SpEL expressions](https://docs.spring.io/spring-framework/reference/6.1/core.html#expressions) `?#{ … }`.
