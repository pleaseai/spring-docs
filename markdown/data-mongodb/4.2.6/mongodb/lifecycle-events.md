...
You can disable lifecycle events on the [Template API](<https://docs.spring.io/spring-data/mongodb/docs/4.2.6/api/org/springframework/data/mongodb/core/MongoTemplate.html#setEntityLifecycleEventsEnabled(boolean)>).
