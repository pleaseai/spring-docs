...
We recommend you get familiar with the concepts, ideally from the [MongoDB Documentation](https://www.mongodb.com/docs/manual/core/csfle/) to learn more about its capabilities and restrictions before you continue applying Encryption through Spring Data.
...
Depending on the encryption algorithm, MongoDB supports certain operations on an encrypted field using its [Queryable Encryption](https://www.mongodb.com/docs/manual/core/queryable-encryption/) feature.
...
<a id="mongo.encryption.explicit-setup"></a>
