---
title: "Vector Search"
source: "ROOT:mongodb/repositories/vector-search.adoc"
---
...
1. Return results with a similarity of `0.9` or greater.
1. Return results with a similarity of between `0.5` and `1.0`  or greater.
...
> [!NOTE]
> If you are new to Spring Data repositories, make sure to familiarize yourself with the [basics of repository definitions and query methods](../../repositories/core-concepts.md).
...
`filter`, `limit`, and `numCandidates` support [Value Expressions](../value-expressions.md) allowing references to search method arguments.
