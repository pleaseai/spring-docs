...
Spring Data MongoDB provides a [`GridFsOperations`](https://docs.spring.io/spring-data/mongodb/docs/4.4.3/api/org/springframework/data/mongodb/gridfs/GridFsOperations.html) and [`ReactiveGridFsOperations`](https://docs.spring.io/spring-data/mongodb/docs/4.4.3/api/org/springframework/data/mongodb/gridfs/ReactiveGridFsOperations.html) interface as well as the corresponding implementation, `GridFsTemplate` and `ReactiveGridFsTemplate`, to let you interact with the filesystem.
...
Read more about `DataBuffer` in [Spring’s reference documentation](https://docs.spring.io/spring-framework/docs/6.2.3/reference/html/core.html#databuffers).
