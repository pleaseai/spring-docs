...
The Aggregation Framework support in Spring Data MongoDB is based on the following key abstractions: [`Aggregation`](https://docs.spring.io/spring-data/mongodb/docs/4.4.7/api/org/springframework/data/mongodb/core/aggregation/Aggregation.html) and [`AggregationResults`](https://docs.spring.io/spring-data/mongodb/docs/4.4.7/api/org/springframework/data/mongodb/core/aggregation/AggregationResults.html).
