...
For more information, see the Javadoc of [`NearQuery`](https://docs.spring.io/spring-data/mongodb/docs/5.0.5/api/org/springframework/data/mongodb/core/query/NearQuery.html) and `Distance`.
