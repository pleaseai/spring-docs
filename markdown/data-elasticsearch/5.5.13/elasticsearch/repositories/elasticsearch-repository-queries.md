...
[SpEL expression](https://docs.spring.io/spring-framework/reference/6.2/core/expressions.html) is also supported when defining query in `@Query`.
...
[Bean property](https://docs.spring.io/spring-framework/reference/6.2/core/expressions/language-ref/bean-references.html) is also supported to access.
...
[SpEL Collection Projection](https://docs.spring.io/spring-framework/reference/6.2/core/expressions/language-ref/collection-projection.html) is convenient to use when values in the `Collection` parameter is not plain `String`:
