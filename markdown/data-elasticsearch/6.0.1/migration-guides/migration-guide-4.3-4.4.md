---
title: "Upgrading from 4.3.x to 4.4.x"
source: "ROOT:migration-guides/migration-guide-4.3-4.4.adoc"
---

<a id="elasticsearch-migration-guide-4.3-4.4"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.deprecations"></a>

## Deprecations

<a id="elasticsearch-migration-guide-4.3-4.4.deprecations.reactive-operations"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.breaking-changes"></a>

## Breaking Changes

<a id="elasticsearch-migration-guide-4.3-4.4.breaking-changes.1"></a>

### Removal of deprecated classes

<a id="org-springframework-data-elasticsearch-core-elasticsearchtemplate-has-been-removed"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.breaking-changes.2"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.breaking-changes.3"></a>
...
When the
`ReactiveElasticsearchTemplate` was provided by using the configuration like described in [Reactive REST Client](../elasticsearch/clients.md#elasticsearch.clients.reactiverestclient) the default refresh policy already was set to NONE.

<a id="elasticsearch-migration-guide-4.3-4.4.new-clients"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.new-clients.how-to"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.new-clients.how-to.not"></a>
...
If Spring Data Elasticsearch was configured using a programmatic configuration (see [Elasticsearch Clients](../elasticsearch/clients.md)), remove these beans from the Spring application context.

<a id="elasticsearch-migration-guide-4.3-4.4.new-clients.how-to.dependencies"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.new-clients.how-to.configuration"></a>

#### New configuration classes

<a id="elasticsearch-migration-guide-4.3-4.4.new-clients.how-to.configuration.imperative"></a>
...
<a id="elasticsearch-migration-guide-4.3-4.4.new-clients.how-to.configuration.reactive"></a>
