---
title: "Routing values"
source: "ROOT:elasticsearch/routing.adoc"
---
...
<a id="elasticsearch.routing.join-types"></a>

## Routing on join-types

When using join-types (see [Join-Type implementation](join-types.md)), Spring Data Elasticsearch will automatically use the `parent` property of the entity’s `JoinField` property as the value for the routing.
...
<a id="elasticsearch.routing.custom"></a>
...
1. a property with the name *routing*
