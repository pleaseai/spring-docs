---
title: "Upgrading from 4.2.x to 4.3.x"
source: "ROOT:migration-guides/migration-guide-4.2-4.3.adoc"
---

<a id="elasticsearch-migration-guide-4.2-4.3"></a>
...
>
> Check the sections on [Deprecations](#elasticsearch-migration-guide-4.2-4.3.deprecations) and [Breaking Changes](#elasticsearch-migration-guide-4.2-4.3.breaking-changes) for further details.

<a id="elasticsearch-migration-guide-4.2-4.3.deprecations"></a>

## Deprecations

<a id="elasticsearch-migration-guide-4.2-4.3.deprecations.suggest"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes"></a>

## Breaking Changes

<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.1"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.2"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.3"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.4"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.5"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.6"></a>
...
<a id="elasticsearch-migration-guide-4.2-4.3.breaking-changes.7"></a>
