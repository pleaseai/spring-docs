...
When the statement is run, an instance of [`MyBatisContext`](https://docs.spring.io/spring-data/relational/docs/4.0.7/api/org/springframework/data/jdbc/mybatis/MyBatisContext.html) gets passed as an argument, which makes various arguments available to the statement.
