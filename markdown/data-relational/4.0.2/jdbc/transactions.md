...
For details, see the Javadoc of [`SimpleJdbcRepository`](https://docs.spring.io/spring-data/relational/docs/4.0.2/api/org/springframework/data/jdbc/repository/support/SimpleJdbcRepository.html).
