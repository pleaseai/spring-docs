...
Spring Data R2DBC requires [Spring Framework](https://docs.spring.io/spring-framework/reference/7.0) 7.0.2 and above.
...
> [!TIP]
> Dialects are resolved by [`DialectResolver`](https://docs.spring.io/spring-data/relational/docs/4.0.1/api/org/springframework/data/r2dbc/dialect/DialectResolver.html) from a `ConnectionFactory`, typically by inspecting `ConnectionFactoryMetadata`.
