...
source: "ROOT:jdbc/schema-support.adoc"
---
...
To assist you with a code-first approach, Spring Data JDBC ships with an integration to create database change sets using [Liquibase](https://www.liquibase.org/).
...
> [!NOTE]
> Schema support can only identify additions and removals in the sense of removing tables/columns that are not mapped or adding columns that do not exist in the database.
