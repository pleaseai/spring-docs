...
For details, see the Javadoc of [`SimpleJdbcRepository`](https://docs.spring.io/spring-data/relational/docs/3.5.11/api/org/springframework/data/jdbc/repository/support/SimpleJdbcRepository.html).
