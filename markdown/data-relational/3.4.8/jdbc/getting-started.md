...
Spring Data JDBC requires [Spring Framework](https://docs.spring.io/spring-framework/reference/6.2) 6.2.9 and above.
...
1. [`AbstractJdbcConfiguration`](https://docs.spring.io/spring-data/relational/docs/3.4.8/api/org/springframework/data/jdbc/repository/config/AbstractJdbcConfiguration.html) provides various default beans required by Spring Data JDBC
...
Extending [`AbstractJdbcConfiguration`](https://docs.spring.io/spring-data/relational/docs/3.4.8/api/org/springframework/data/jdbc/repository/config/AbstractJdbcConfiguration.html) ensures various beans get registered.
...
> [!TIP]
> Dialects are resolved by [`DialectResolver`](https://docs.spring.io/spring-data/relational/docs/3.4.8/api/org/springframework/data/jdbc/repository/config/DialectResolver.html) from a `JdbcOperations` instance, typically by inspecting `Connection.getMetaData()`.
> + You can let Spring auto-discover your [`JdbcDialect`](https://docs.spring.io/spring-data/relational/docs/3.4.8/api/org/springframework/data/jdbc/core/dialect/JdbcDialect.html) by registering a class that implements `org.springframework.data.jdbc.repository.config.DialectResolver$JdbcDialectProvider` through `META-INF/spring.factories`.
