---
title: "Auditing"
source: "ROOT:repositories/auditing.adoc"
---
...
> [!NOTE]
> Applications that only track creation and modification dates are not required to make their entities implement [`AuditorAware`](#auditing.auditor-aware).
