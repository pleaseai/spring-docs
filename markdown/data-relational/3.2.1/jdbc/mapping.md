...
You can tweak that by providing a [`NamingStrategy`](https://docs.spring.io/spring-data/jdbc/docs/3.2.1/api/org/springframework/data/relational/core/mapping/NamingStrategy.html) in your application context.

<a id="entity-persistence.custom-table-name"></a>

## Override table names

When the table naming strategy does not match your database table names, you can override the table name with the [`@Table`](https://docs.spring.io/spring-data/jdbc/docs/3.2.1/api/org/springframework/data/relational/core/mapping/Table.html) annotation.
...
When the column naming strategy does not match your database table names, you can override the table name with the [`@Column`](https://docs.spring.io/spring-data/jdbc/docs/3.2.1/api/org/springframework/data/relational/core/mapping/Column.html) annotation.
...
The [`@MappedCollection`](https://docs.spring.io/spring-data/jdbc/docs/3.2.1/api/org/springframework/data/relational/core/mapping/MappedCollection.html)
...
This additional column name may be customized with the `keyColumn` Element of the [`@MappedCollection`](https://docs.spring.io/spring-data/jdbc/docs/3.2.1/api/org/springframework/data/relational/core/mapping/MappedCollection.html) annotation:
