...
> [!TIP]
> Dialects are resolved by [`DialectResolver`](https://docs.spring.io/spring-data/r2dbc/docs/3.3.3/api//org/springframework/data/r2dbc/dialect/DialectResolver.html) from a `ConnectionFactory`, typically by inspecting `ConnectionFactoryMetadata`.
