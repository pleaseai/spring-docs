...
For details, see the Javadoc of [`SimpleJdbcRepository`](https://docs.spring.io/spring-data/relational/docs/3.4.3/api/org/springframework/data/jdbc/repository/support/SimpleJdbcRepository.html).
