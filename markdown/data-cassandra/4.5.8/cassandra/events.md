...
You can disable lifecycle events on the [Template API](<https://docs.spring.io/spring-data/cassandra/docs/4.5.8/api/org/springframework/data/cassandra/core/CassandraTemplate.html#setEntityLifecycleEventsEnabled(boolean)>).
...
The [`AbstractCassandraEventListener`](https://docs.spring.io/spring-data/cassandra/docs/4.5.8/api/org/springframework/data/cassandra/core/mapping/event/AbstractCassandraEventListener.html) has the following callback methods:
