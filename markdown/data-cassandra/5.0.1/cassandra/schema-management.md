...
source: "ROOT:cassandra/schema-management.adoc"
---

<a id="cassandra.schema-management"></a>
...
> [!NOTE]
> Variants of Cassandra can support Materialized Views, User-defined functions, roles and many more object types.
...
<a id="keyspaces-and-lifecycle-scripts"></a>
...
> [!NOTE]
> Keyspace creation allows rapid bootstrapping without the need of external keyspace management.
...
<a id="cassandra.schema-management.initializing"></a>
...
<a id="cassandra.schema-management.initializing.config"></a>
...
<a id="cassandra.schema-management.initializing.component"></a>
...
- Use the Schema management for [Tables and User-defined Types](#cassandra.schema-management.tables) to initialize the keyspace using Spring Data Cassandra’s built-in schema generator.

<a id="cassandra.schema-management.tables"></a>
...
<a id="enabling-tables-and-user-defined-types-for-schema-management"></a>

### Enabling Tables and User-Defined Types for Schema Management

[Metadata-based Mapping](../object-mapping.md#mapping.usage) explains object mapping with conventions and annotations.
