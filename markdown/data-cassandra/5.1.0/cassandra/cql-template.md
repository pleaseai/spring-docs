...
The [`CqlTemplate`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/CqlTemplate.html) class (and its reactive variant [`ReactiveCqlTemplate`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/ReactiveCqlTemplate.html)) is the central class in the core CQL package.
...
Given a `CqlSession`, the [`PreparedStatementCreator`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/PreparedStatementCreator.html) callback interface creates a [prepared statement](prepared-statements.md#cassandra.template.prepared-statements.cql) with the provided CQL and any necessary parameter arguments.
The [`RowCallbackHandler`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/RowCallbackHandler.html) interface extracts values from each row of a `ResultSet`.

The [`CqlTemplate`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/CqlTemplate.html) can be used within a DAO implementation through direct instantiation with a [`SessionFactory`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/SessionFactory.html) reference or be configured in the Spring container and given to DAOs as a bean reference. `CqlTemplate` is a foundational building block for [`CassandraTemplate`](template.md).
...
[`CqlTemplate`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/CqlTemplate.html), [`AsyncCqlTemplate`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/AsyncCqlTemplate.html), and [`ReactiveCqlTemplate`](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/ReactiveCqlTemplate.html).
...
See the [Javadoc](https://docs.spring.io/spring-data/cassandra/docs/5.1.0/api/org/springframework/data/cassandra/core/cql/CqlTemplate.html) for that.
