...
The [`CrudRepository`](https://docs.spring.io/spring-data/commons/reference/3.4.9/api/java/org/springframework/data/repository/CrudRepository.html) and [`ListCrudRepository`](https://docs.spring.io/spring-data/commons/reference/3.4.9/api/java/org/springframework/data/repository/ListCrudRepository.html) interfaces provide sophisticated CRUD functionality for the entity class that is being managed.
...
> Read more about this in “[Defining Query Methods](query-methods-details.md#repositories.query-methods.reserved-methods)”.
>
...
Additional to the `CrudRepository`, there are [`PagingAndSortingRepository`](https://docs.spring.io/spring-data/commons/reference/3.4.9/api/java/org/springframework/data/repository/PagingAndSortingRepository.html) and [`ListPagingAndSortingRepository`](https://docs.spring.io/spring-data/commons/reference/3.4.9/api/java/org/springframework/data/repository/ListPagingAndSortingRepository.html) which add additional methods to ease paginated access to entities:
...
> If you want to use [auditing](../cassandra/auditing.md) make sure to either use [Optimistic Locking](../cassandra/template.md#cassandra.template.optimistic-locking) or implement `Persistable` for proper entity state detection.
