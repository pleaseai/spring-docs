...
You can disable lifecycle events on the [Template API](<https://docs.spring.io/spring-data/cassandra/docs/4.2.1/api/org/springframework/data/cassandra/core/CassandraTemplate.html#setEntityLifecycleEventsEnabled(boolean)>).
