...
To intercept an object before it goes into the database, you can register a subclass of [`AbstractCassandraEventListener`](https://docs.spring.io/spring-data/cassandra/docs/5.0.4/api/org/springframework/data/cassandra/core/mapping/event/AbstractCassandraEventListener.html) that overrides the `onBeforeSave(…)` method.
...
You can disable lifecycle events on the [Template API](<https://docs.spring.io/spring-data/cassandra/docs/5.0.4/api/org/springframework/data/cassandra/core/CassandraTemplate.html#setEntityLifecycleEventsEnabled(boolean)>).
...
The [`AbstractCassandraEventListener`](https://docs.spring.io/spring-data/cassandra/docs/5.0.4/api/org/springframework/data/cassandra/core/mapping/event/AbstractCassandraEventListener.html) has the following callback methods:
