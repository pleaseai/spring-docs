...
- You can create an instance of [`CassandraTemplate`](https://docs.spring.io/spring-data/cassandra/docs/4.4.0/api/org/springframework/data/cassandra/core/CassandraTemplate.html) (or [`ReactiveCassandraTemplate`](https://docs.spring.io/spring-data/cassandra/docs/4.4.0/api/org/springframework/data/cassandra/core/ReactiveCassandraTemplate.html) for reactive usage) with a Cassandra `CqlSession`.
