---
title: "Property-based Converters"
source: "ROOT:cassandra/property-converters.adoc"
---

<a id="cassandra.property-converters"></a>

# Property-based Converters

While [type-based conversion](converters.md) already offers ways to influence the conversion and representation of certain types within the target store, it has limitations when only certain values or properties of a particular type should be considered for conversion.
...
<a id="cassandra.property-converters.declarative"></a>
...
<a id="cassandra.property-converters.programmatic"></a>
...
> [!WARNING]
> Schema derivation can only derive the column type from a registered converter if the converter is a `PropertyValueConverter` class.
...
<a id="cassandra.conversions.-configuration"></a>
