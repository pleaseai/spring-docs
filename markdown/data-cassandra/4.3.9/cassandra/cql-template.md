...
The [`RowCallbackHandler`](https://docs.spring.io/spring-data/cassandra/docs/4.3.9/api/org/springframework/data/cassandra/core/cql/RowCallbackHandler.html) interface extracts values from each row of a `ResultSet`.
...
See the [Javadoc](https://docs.spring.io/spring-data/cassandra/docs/4.3.9/api/org/springframework/data/cassandra/core/cql/CqlTemplate.html) for that.
