...
Spring Data LDAP ships with an annotation processor [`LdapAnnotationProcessor`](https://docs.spring.io/spring-data/ldap/docs/3.4.5/api/org/springframework/data/ldap/repository/support/LdapAnnotationProcessor.html) that isn’t registered by default.
