...
<a id="ldap.repositories.queries.type-safe"></a>

### Type-safe Query Methods with Querydsl

LDAP repository counterpart integrates with the [Querydsl](http://www.querydsl.com/) project, which provides a way to perform type-safe queries.
...
See [Setting up Annotation Processing](#ldap.repositories.queries.type-safe.apt) for how to set up Annotation Processing with your Build System.
...
<a id="ldap.repositories.queries.type-safe.apt"></a>
...
Spring Data LDAP ships with an annotation processor [`LdapAnnotationProcessor`](https://docs.spring.io/spring-data/ldap/docs/4.0.6/api/org/springframework/data/ldap/repository/support/LdapAnnotationProcessor.html) that isn’t registered by default.
