...
Indeed, the built-in [`LdapRepository`](https://docs.spring.io/spring-data/ldap/docs/3.5.0/api/org/springframework/data/ldap/repository/LdapRepository.html) only takes one type parameter: the managed entity class, which defaults the ID to `javax.naming.Name`.
