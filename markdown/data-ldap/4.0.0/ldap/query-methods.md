...
You can specify your own encoder through the `@LdapEncode` annotation that defines which [`LdapEncoder`](https://docs.spring.io/spring-data/ldap/docs/4.0.0/api/org/springframework/data/ldap/repository/LdapEncoder.html) to use.
