...
source: "ROOT:repositories/create-instances.adoc"
---
...
<a id="repositories.create-instances.java-config"></a>

## Java Configuration

Use the store-specific `@EnableCouchbaseRepositories` annotation on a Java configuration class to define a configuration for repository activation.
For an introduction to Java-based configuration of the Spring container, see [JavaConfig in the Spring reference documentation](https://docs.spring.io/spring-framework/reference/6.2/core/beans/java.html).
...
<a id="repositories.create-instances.java-config.placeholders-and-patterns"></a>

### Property Placeholders and Ant-style Patterns

The `basePackages` and `value` attributes in `@EnableCouchbaseRepositories` support `${…}` property placeholders which are resolved against the `Environment` as well as Ant-style package patterns such as `"org.example.**"`.

The following example specifies the `app.scan.packages` property placeholder for the implicit `value` attribute in `@EnableCouchbaseRepositories`.

#### Java

```java
@Configuration
@EnableCouchbaseRepositories("${app.scan.packages}")    // <1>
...
<a id="repositories.create-instances.xml"></a>
...
<a id="repositories.using-filters"></a>
...
For details, see the [Spring reference documentation](https://docs.spring.io/spring-framework/reference/6.2/core/beans/classpath-scanning.html) for these elements.
...
<a id="repositories.create-instances.standalone"></a>
