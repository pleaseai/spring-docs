...
The simplest way to get the correct dependencies is by making a project with [spring initializr](https://start.spring.io/)
The parent Spring Boot Starter artfacts have the required dependencies, they do not need to be specified.

<a id="_spring_boot_version_compatibility"></a>
...
<a id="_couchbase_java_sdk_compatibility"></a>
