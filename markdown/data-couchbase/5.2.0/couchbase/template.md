...
The motivation behind mapping to Spring’s [consistent data access exception hierarchy](https://docs.spring.io/spring-data-commons/referencehtml/dao.html#dao-exceptions)
