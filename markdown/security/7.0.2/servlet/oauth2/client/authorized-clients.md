...
<a id="oauth2-client-rest-client-interface"></a>

### HTTP Service Clients

Spring Security’s OAuth support integrates with [features/integrations/rest/http-service-client.adoc](../../../features/integrations/rest/http-service-client.md).
