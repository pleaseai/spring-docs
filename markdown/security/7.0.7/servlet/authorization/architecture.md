...
![authorizationhierarchy](https://raw.githubusercontent.com/spring-projects/spring-security/7.0.7/docs/modules/ROOT/assets/images/servlet/authorization/authorizationhierarchy.png)
...
The [`AuthorizationManagerFactory`](https://docs.spring.io/spring-security/site/docs/7.0.7/api/org/springframework/security/authorization/AuthorizationManagerFactory.html) interface (introduced in Spring Security 7.0) is used to create generic `AuthorizationManager`s in [request-based](authorize-http-requests.md) and [method-based](method-security.md) authorization components.
...
> [!NOTE]
> The [actual interface](https://github.com/spring-projects/spring-security/tree/7.0.7/core/src/main/java/org/springframework/security/authorization/AuthorizationManagerFactory.java) provides default implementations for all factory methods, which allows custom implementations to only implement the methods that need to be customized.

<a id="authz-authorization-managers"></a>

#### AuthorizationManagers

There are also helpful static factories in [`AuthorizationManagers`](https://docs.spring.io/spring-security/site/docs/7.0.7/api/org/springframework/security/authorization/AuthorizationManagers.html) for composing individual `AuthorizationManager`s into more sophisticated expressions.
...
![access decision voting](https://raw.githubusercontent.com/spring-projects/spring-security/7.0.7/docs/modules/ROOT/assets/images/servlet/authorization/access-decision-voting.png)
...
[`AuthenticatedVoter`](https://docs.spring.io/spring-security/site/docs/7.0.7/api/org/springframework/security/access/vote/AuthenticatedVoter.html).
...
![after invocation](https://raw.githubusercontent.com/spring-projects/spring-security/7.0.7/docs/modules/ROOT/assets/images/servlet/authorization/after-invocation.png)
