...
[Spring MVC resolves parameters of type `Principal`](https://docs.spring.io/spring-framework/docs/current/reference/html/web.html#mvc-ann-arguments) using its own argument resolver.
