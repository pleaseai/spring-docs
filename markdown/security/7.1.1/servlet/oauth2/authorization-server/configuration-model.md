...
source: "ROOT:servlet/oauth2/authorization-server/configuration-model.adoc"
---

<a id="oauth2AuthorizationServer-configuration-model"></a>

# Configuration Model

<a id="oauth2AuthorizationServer-default-configuration"></a>
...
`OAuth2AuthorizationServerConfiguration` uses [`OAuth2AuthorizationServerConfigurer`](#oauth2AuthorizationServer-customizing-the-configuration) to apply the default configuration and registers a `SecurityFilterChain` `@Bean` composed of all the infrastructure components supporting an OAuth2 authorization server.

The OAuth2 authorization server `SecurityFilterChain` `@Bean` is configured with the following default protocol endpoints:

- [OAuth2 Authorization endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-authorization-endpoint)
- [OAuth2 Token endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-endpoint)
- [OAuth2 Token Introspection endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-introspection-endpoint)
- [OAuth2 Token Revocation endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-revocation-endpoint)
- [OAuth2 Authorization Server Metadata endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-authorization-server-metadata-endpoint)
- [JWK Set endpoint](protocol-endpoints.md#oauth2AuthorizationServer-jwk-set-endpoint)
...
>
> - [OAuth2 Device Authorization Endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-device-authorization-endpoint)
> - [OAuth2 Device Verification Endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-device-verification-endpoint)
> - [OAuth2 Client Registration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-client-registration-endpoint)
...
> [!IMPORTANT]
> The [authorization\_code grant](https://datatracker.ietf.org/doc/html/rfc6749#section-4.1) requires the resource owner to be authenticated. Therefore, a user authentication mechanism **must** be configured in addition to the default OAuth2 security configuration.
...
- [OpenID Connect 1.0 Provider Configuration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-provider-configuration-endpoint)
- [OpenID Connect 1.0 Logout endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-logout-endpoint)
- [OpenID Connect 1.0 UserInfo endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-user-info-endpoint)

> [!NOTE]
> The [OpenID Connect 1.0 Client Registration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-client-registration-endpoint) is disabled by default.

> [!TIP]
> `OAuth2AuthorizationServerConfiguration.jwtDecoder(JWKSource<SecurityContext>)` is a convenience (`static`) utility method that can be used to register a `JwtDecoder` `@Bean`, which is **REQUIRED** for the [OpenID Connect 1.0 UserInfo endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-user-info-endpoint) and the [OpenID Connect 1.0 Client Registration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-client-registration-endpoint).
...
<a id="oauth2AuthorizationServer-customizing-the-configuration"></a>
...
It lets you specify the core components to use - for example, [`RegisteredClientRepository`](core-model-components.md#oauth2AuthorizationServer-registered-client-repository),  [`OAuth2AuthorizationService`](core-model-components.md#oauth2AuthorizationServer-oauth2-authorization-service), [`OAuth2TokenGenerator`](core-model-components.md#oauth2AuthorizationServer-oauth2-token-generator), and others.
Furthermore, it lets you customize the request processing logic for the protocol endpoints – for example, [authorization endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-authorization-endpoint), [device authorization endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-device-authorization-endpoint), [device verification endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-device-verification-endpoint), [token endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-endpoint), [token introspection endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-introspection-endpoint), and others.
...
1. `registeredClientRepository()`: The [`RegisteredClientRepository`](core-model-components.md#oauth2AuthorizationServer-registered-client-repository) (**REQUIRED**) for managing new and existing clients.
1. `authorizationService()`: The [`OAuth2AuthorizationService`](core-model-components.md#oauth2AuthorizationServer-oauth2-authorization-service) for managing new and existing authorizations.
1. `authorizationConsentService()`: The [`OAuth2AuthorizationConsentService`](core-model-components.md#oauth2AuthorizationServer-oauth2-authorization-consent-service) for managing new and existing authorization consents.
1. `authorizationServerSettings()`: The [`AuthorizationServerSettings`](#oauth2AuthorizationServer-configuring-authorization-server-settings) (**REQUIRED**) for customizing configuration settings for the OAuth2 authorization server.
1. `tokenGenerator()`: The [`OAuth2TokenGenerator`](core-model-components.md#oauth2AuthorizationServer-oauth2-token-generator) for generating tokens supported by the OAuth2 authorization server.
1. `clientAuthentication()`: The configurer for [OAuth2 Client Authentication](#oauth2AuthorizationServer-configuring-client-authentication).
1. `authorizationEndpoint()`: The configurer for the [OAuth2 Authorization endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-authorization-endpoint).
1. `pushedAuthorizationRequestEndpoint()`: The configurer for the [OAuth2 Pushed Authorization Request endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-pushed-authorization-request-endpoint).
1. `deviceAuthorizationEndpoint()`: The configurer for the [OAuth2 Device Authorization endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-device-authorization-endpoint).
1. `deviceVerificationEndpoint()`: The configurer for the [OAuth2 Device Verification endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-device-verification-endpoint).
1. `tokenEndpoint()`: The configurer for the [OAuth2 Token endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-endpoint).
1. `tokenIntrospectionEndpoint()`: The configurer for the [OAuth2 Token Introspection endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-introspection-endpoint).
1. `tokenRevocationEndpoint()`: The configurer for the [OAuth2 Token Revocation endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-revocation-endpoint).
1. `clientRegistrationEndpoint()`: The configurer for the [OAuth2 Client Registration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-client-registration-endpoint).
1. `authorizationServerMetadataEndpoint()`: The configurer for the [OAuth2 Authorization Server Metadata endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-authorization-server-metadata-endpoint).
1. `providerConfigurationEndpoint()`: The configurer for the [OpenID Connect 1.0 Provider Configuration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-provider-configuration-endpoint).
1. `logoutEndpoint()`: The configurer for the [OpenID Connect 1.0 Logout endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-logout-endpoint).
1. `userInfoEndpoint()`: The configurer for the [OpenID Connect 1.0 UserInfo endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-user-info-endpoint).
1. `clientRegistrationEndpoint()`: The configurer for the [OpenID Connect 1.0 Client Registration endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oidc-client-registration-endpoint).

<a id="oauth2AuthorizationServer-configuring-authorization-server-settings"></a>
...
It specifies the `URI` for the protocol endpoints as well as the [issuer identifier](https://datatracker.ietf.org/doc/html/rfc8414#section-2).
...
> [!TIP]
> [`@Import(OAuth2AuthorizationServerConfiguration.class)`](#oauth2AuthorizationServer-default-configuration) automatically registers an `AuthorizationServerSettings` `@Bean`, if not already provided.
...
<a id="oauth2AuthorizationServer-configuring-client-authentication"></a>

## Configuring Client Authentication

`OAuth2ClientAuthenticationConfigurer` provides the ability to customize [OAuth2 client authentication](https://datatracker.ietf.org/doc/html/rfc6749#section-2.3).
...
1. `authenticationConverters()`: Sets the `Consumer` providing access to the `List` of default and (optionally) added `AuthenticationConverter`'s allowing the ability to add, remove, or customize a specific `AuthenticationConverter`.
1. `authenticationProvider()`: Adds an `AuthenticationProvider` (*main processor*) used for authenticating the `OAuth2ClientAuthenticationToken`.
...
1. `authenticationSuccessHandler()`: The `AuthenticationSuccessHandler` (*post-processor*) used for handling a successful client authentication and associating the `OAuth2ClientAuthenticationToken` to the `SecurityContext`.
1. `errorResponseHandler()`: The `AuthenticationFailureHandler` (*post-processor*) used for handling a failed client authentication and returning the [`OAuth2Error` response](https://datatracker.ietf.org/doc/html/rfc6749#section-5.2).
...
By default, client authentication is required for the [OAuth2 Token endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-endpoint), the [OAuth2 Token Introspection endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-introspection-endpoint), and the [OAuth2 Token Revocation endpoint](protocol-endpoints.md#oauth2AuthorizationServer-oauth2-token-revocation-endpoint).
...
<a id="oauth2AuthorizationServer-customizing-jwt-client-assertion-validation"></a>
...
<a id="oauth2AuthorizationServer-customizing-mutual-tls-client-authentication"></a>
...
<a id="oauth2AuthorizationServer-customizing-mutual-tls-client-authentication-pki-mutual-tls-method"></a>
...
<a id="oauth2AuthorizationServer-customizing-mutual-tls-client-authentication-self-signed-certificate-mutual-tls-method"></a>
...
<a id="oauth2AuthorizationServer-customizing-mutual-tls-client-authentication-client-certificate-bound-access-tokens"></a>
