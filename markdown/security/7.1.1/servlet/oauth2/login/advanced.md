...
source: "ROOT:servlet/oauth2/login/advanced.adoc"
---

<a id="oauth2login-advanced"></a>
...
The following code shows the complete configuration options available in the [ security namespace](../../appendix/namespace/http.md#nsa-oauth2-login):
...
<a id="oauth2login-advanced-login-page"></a>
...
<a id="oauth2login-advanced-redirection-endpoint"></a>
...
<a id="oauth2login-advanced-userinfo-endpoint"></a>
...
<a id="oauth2login-advanced-map-authorities"></a>
...
<a id="oauth2login-advanced-map-authorities-grantedauthoritiesmapper"></a>
...
<a id="oauth2login-advanced-map-authorities-oauth2userservice"></a>
...
<a id="oauth2login-advanced-oauth2-user-service"></a>
...
<a id="oauth2login-advanced-oidc-user-service"></a>
...
<a id="oauth2login-advanced-idtoken-verify"></a>
...
The ID Token is represented as a [JSON Web Token](https://tools.ietf.org/html/rfc7519) (JWT) and MUST be signed by using [JSON Web Signature](https://tools.ietf.org/html/rfc7515) (JWS).
...
<a id="oauth2login-advanced-idtoken-decoder-factory"></a>
...
Then, you can proceed to configure [logout](logout.md)
