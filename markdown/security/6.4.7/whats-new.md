...
- All [method security annotations](servlet/authorization/method-security.md#meta-annotations) now support [Framework’s `@AliasFor`](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/core/annotation/AliasFor.html)
...
- `RelyingPartyRegistrationRepository` results can now be [cached](https://docs.spring.io/spring-security/site/docs/6.4.7/api/org/springframework/security/saml2/provider/service/registration/CachingRelyingPartyRegistrationRepository.html).
