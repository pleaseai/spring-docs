...
source: "ROOT:migration-7/saml2.adoc"
---

# Saml 2.0 Migrations

<a id="_use_opensaml_5_by_default"></a>
...
1. If you are constructing an `OpenSaml4XXX` Spring Security component, change it to `OpenSaml5`.
...
<a id="_continue_filter_chain_when_no_relying_party_found"></a>
...
<a id="_validate_response_after_validating_assertions"></a>
...
1. Validate Response attributes, like Destination and Issuer
1. For each assertion, verify the signature, decrypt, and then validate its fields
1. Check to ensure that the response has at least one assertion with a name field
...
<a id="_relyingpartyregistration_improvements"></a>
...
1. If you are providing or retrieving `AssertingPartyDetails`, use `getAssertingPartyMetadata` or `withAssertingPartyMetadata` instead.

<a id="_opensaml5authenticationprovider_improvements"></a>
...
<a id="_response_authentication_converter"></a>
