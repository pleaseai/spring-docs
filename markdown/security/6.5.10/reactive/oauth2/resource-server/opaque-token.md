...
However, unless you provide a custom [`ReactiveOpaqueTokenIntrospector`](#webflux-oauth2resourceserver-opaque-introspector-bean), the Resource Server falls back to `SpringReactiveOpaqueTokenIntrospector`.
