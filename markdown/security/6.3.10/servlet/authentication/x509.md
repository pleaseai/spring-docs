...
<a id="_adding_x_509_authentication_to_your_web_application"></a>
...
So "emailAddress=(.\*?)," matches "EMAILADDRESS=[jimi@hendrix.org](mailto:jimi@hendrix.org),CN=…​", giving a user name "[jimi@hendrix.org](mailto:jimi@hendrix.org)".
...
There are some pre-generated certificates in the [Spring Security Samples repository](https://github.com/spring-projects/spring-security-samples/tree/6.3.x/servlet/java-configuration/authentication/x509/server).
