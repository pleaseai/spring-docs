...
You can also specify a complete `Jwt`, for which [`Jwt.Builder`](https://docs.spring.io/spring-security/site/docs/6.4.13/api/org/springframework/security/oauth2/jwt/Jwt.Builder.html) is quite handy:
