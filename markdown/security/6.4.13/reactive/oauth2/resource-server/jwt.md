...
> [!NOTE]
> Calling [ReactiveJwtDecoders#fromIssuerLocation](https://docs.spring.io/spring-security/site/docs/6.4.13/api/org/springframework/security/oauth2/jwt/ReactiveJwtDecoders.html#fromIssuerLocation-java.lang.String-) invokes the Provider Configuration or Authorization Server Metadata endpoint to derive the JWK Set URI.
