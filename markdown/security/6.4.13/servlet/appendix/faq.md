...
1. [What does "ROLE\_" mean and why do I need it on my role names?](#appendix-faq-role-prefix)
1. [How do I know which dependencies to add to my application to work with Spring Security?](#appendix-faq-what-dependencies)
1. [What dependencies are needed to run an embedded ApacheDS LDAP server?](#appendix-faq-apacheds-deps)
...
### What does "ROLE\_" mean and why do I need it on my role names?
...
You should also consult the [Javadoc](https://docs.spring.io/spring-security/site/docs/6.4.13/api/) for the relevant classes and interfaces.
