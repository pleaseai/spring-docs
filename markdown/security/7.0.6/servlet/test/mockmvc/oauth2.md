...
You can also specify a complete `Jwt`, for which [`Jwt.Builder`](https://docs.spring.io/spring-security/site/docs/7.0.6/api/org/springframework/security/oauth2/jwt/Jwt.Builder.html) comes quite handy:
