...
> [!NOTE]
> `<after-invocation-provider>` is deprecated in favor of `<method-security>` and [`@PostFilter` and `@PostAuthorize`](../../authorization/method-security.md).
...
> [!NOTE]
> `<invocation-attribute-factory>` is deprecated in favor of `<method-security>` and [`@PostFilter` and `@PostAuthorize`](../../authorization/method-security.md).
...
> [!NOTE]
> `<post-invocation-advice>` is deprecated in favor of `<method-security>` and [`@PostFilter` and `@PostAuthorize`](../../authorization/method-security.md).
...
> [!NOTE]
> `<pre-invocation-advice>` is deprecated in favor of `<method-security>` and [`@PreFilter` and `@PreAuthorize`](../../authorization/method-security.md).
...
> [!NOTE]
> `<method-security-metadata-source>` is deprecated in favor of [`<method-security>`](../../authorization/method-security.md).
