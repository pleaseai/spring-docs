...
For a complete listing of the mappings, see the Javadoc for [`PasswordEncoderFactories`](https://docs.spring.io/spring-security/site/docs/7.0.6/api/org/springframework/security/crypto/factory/PasswordEncoderFactories.html).
...
The default implementation of `BCryptPasswordEncoder` uses strength 10 as mentioned in the Javadoc of [`BCryptPasswordEncoder`](https://docs.spring.io/spring-security/site/docs/7.0.6/api/org/springframework/security/crypto/bcrypt/BCryptPasswordEncoder.html). You are encouraged to
