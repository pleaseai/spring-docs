...
source: "ROOT:reactive/integrations/rsocket.adoc"
---
...
- Hello RSocket [hellorsocket](https://github.com/spring-projects/spring-security-samples/tree/6.2.x/reactive/rsocket/hello-security)
- [Spring Flights](https://github.com/rwinch/spring-flights/tree/security)

<a id="_minimal_rsocket_security_configuration"></a>
...
<a id="_adding_securitysocketacceptorinterceptor"></a>
...
Spring Boot registers it automatically in `RSocketSecurityAutoConfiguration` when you include [the correct dependencies](https://github.com/spring-projects/spring-security-samples/tree/6.2.x/reactive/rsocket/hello-security/build.gradle).
...
To customize the interceptor itself, use `RSocketSecurity` to add [authentication](#rsocket-authentication) and [authorization](#rsocket-authorization).

<a id="rsocket-authentication"></a>
...
<a id="rsocket-authentication-setup-vs-request"></a>
...
<a id="rsocket-authentication-simple"></a>

### Simple Authentication

Spring Security has support for the [Simple Authentication Metadata Extension](https://github.com/rsocket/rsocket/blob/5920ed374d008abb712cb1fd7c9d91778b2f4a68/Extensions/Security/Simple.md).
...
<a id="rsocket-authentication-jwt"></a>

### JWT

Spring Security has support for the [Bearer Token Authentication Metadata Extension](https://github.com/rsocket/rsocket/blob/5920ed374d008abb712cb1fd7c9d91778b2f4a68/Extensions/Security/Bearer.md).
...
1. If the route is `fetch.profile.me`, authorization only requires the user to be authenticated.
1. In this rule, we set up a custom matcher, where authorization requires the user to have the `ROLE_CUSTOM` authority.
1. This rule uses custom authorization.
...
1. This rule ensures that a request that does not already have a rule requires the user to be authenticated.
A request is where the metadata is included.
It would not include additional payloads.
1. This rule ensures that any exchange that does not already have a rule is allowed for anyone.
