...
The [`CredentialsContainer`](https://docs.spring.io/spring-security/site/docs/6.5.8/api/org/springframework/security/core/CredentialsContainer.html) interface indicates that the implementing object contains sensitive data, and is used internally by Spring Security to erase the authentication credentials after a successful authentication.
This interface is implemented by most of Spring Security internal domain classes, like [`User`](https://docs.spring.io/spring-security/site/docs/6.5.8/api/org/springframework/security/core/userdetails/User.html) and [`UsernamePasswordAuthenticationToken`](https://docs.spring.io/spring-security/site/docs/6.5.8/api/org/springframework/security/authentication/UsernamePasswordAuthenticationToken.html).
