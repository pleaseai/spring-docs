...
source: "ROOT:features/integrations/concurrency.adoc"
---
...
In fact, this is what Spring Security builds on to integration with [AsyncContext.start(Runnable)](../../servlet/integrations/servlet-api.md#servletapi-start-runnable) and [Spring MVC Async Integration](../../servlet/integrations/mvc.md#mvc-async).
...
For example, you might have used Spring Security’s [<global-method-security>](../../servlet/appendix/namespace/method-security.md#nsa-global-method-security) support to secure one of your services.
