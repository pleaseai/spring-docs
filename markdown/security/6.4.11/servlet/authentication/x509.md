...
There are some pre-generated certificates in the [Spring Security Samples repository](https://github.com/spring-projects/spring-security-samples/tree/6.4.x/servlet/java-configuration/authentication/x509/server).
