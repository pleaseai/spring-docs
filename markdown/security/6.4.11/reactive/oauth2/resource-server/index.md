...
> [!NOTE]
> A complete working example for [JWT](https://github.com/spring-projects/spring-security-samples/tree/6.4.x/reactive/webflux/java/oauth2/resource-server)  is available in the [Spring Security repository](https://github.com/spring-projects/spring-security-samples/tree/6.4.x).
