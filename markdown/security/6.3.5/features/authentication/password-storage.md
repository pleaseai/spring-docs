...
To facilitate that, Spring Security provides integration with the [Have I Been Pwned API](https://haveibeenpwned.com/API/v3#PwnedPasswords) via the [`HaveIBeenPwnedRestApiPasswordChecker` implementation](https://docs.spring.io/spring-security/site/docs/6.3.5/api/org/springframework/security/core/password/HaveIBeenPwnedRestApiPasswordChecker.html) of the [`CompromisedPasswordChecker` interface](https://docs.spring.io/spring-security/site/docs/6.3.5/api/org/springframework/security/core/password/CompromisedPasswordChecker.html).
