...
An alternative approach would be to use Spring Framework’s [`@Cacheable`](https://docs.spring.io/spring-framework/reference/6.1.9/integration.html#cache-annotations-cacheable) in your `UserDetailsService` implementation to cache `UserDetails` by `username`.
