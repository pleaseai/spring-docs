...
[`UserDetailsService`](https://docs.spring.io/spring-security/site/docs/6.2.1/api/org/springframework/security/core/userdetails/UserDetailsService.html) is used by [`DaoAuthenticationProvider`](dao-authentication-provider.md#servlet-authentication-daoauthenticationprovider) for retrieving a username, a password, and other attributes for authenticating with a username and password.
Spring Security provides [in-memory](in-memory.md#servlet-authentication-inmemory) and [JDBC](jdbc.md#servlet-authentication-jdbc) implementations of `UserDetailsService`.
