...
source: "ROOT:reactive/oauth2/client/authorization-grants.adoc"
---
...
> [!TIP]
> If the OAuth 2.0 Provider supports PKCE for [Confidential Clients](https://tools.ietf.org/html/rfc6749#section-2.1), you may (optionally) configure it using `DefaultServerOAuth2AuthorizationRequestResolver.setAuthorizationRequestCustomizer(OAuth2AuthorizationRequestCustomizers.withPkce())`.

<a id="oauth2-client-authorization-code-redirect-uri"></a>

<a id="oauth2Client-auth-code-redirect-uri"></a>The `DefaultServerOAuth2AuthorizationRequestResolver` also supports `URI` template variables for the `redirect-uri` using `UriComponentsBuilder`.
...
`WebClientReactiveAuthorizationCodeTokenResponseClient` is very flexible and provides several options for customizing the OAuth 2.0 Access Token request and response for the Authorization Code grant.
...
- I want to [customize the instance of `WebClient` that is used](#oauth2-client-authorization-code-access-token-response-web-client)
...
<a id="oauth2-client-authorization-code-access-token-response-web-client"></a>
...
Whether you customize `WebClientReactiveAuthorizationCodeTokenResponseClient` or provide your own implementation of `ReactiveOAuth2AccessTokenResponseClient`, you can configure it using the DSL (as an alternative to [publishing a bean](#oauth2-client-authorization-code-access-token-response-client-bean)) as shown in the following example:
...
`WebClientReactiveRefreshTokenTokenResponseClient` is very flexible and provides several options for customizing the OAuth 2.0 Access Token request and response for the Refresh Token grant.
Choose from the following use cases to learn more:
...
- I want to [customize the instance of `WebClient` that is used](#oauth2-client-refresh-token-access-token-response-web-client)
...
<a id="oauth2-client-refresh-token-access-token-response-web-client"></a>
...
Whether you customize `WebClientReactiveRefreshTokenTokenResponseClient` or provide your own implementation of `ReactiveOAuth2AccessTokenResponseClient`, you can configure it using the `ReactiveOAuth2AuthorizedClientProviderBuilder` (as an alternative to [publishing a bean](#oauth2-client-refresh-token-access-token-response-client-bean)) as follows:
...
`WebClientReactiveClientCredentialsTokenResponseClient` is very flexible and provides several options for customizing the OAuth 2.0 Access Token request and response for the Client Credentials grant.
Choose from the following use cases to learn more:
...
- I want to [customize the instance of `WebClient` that is used](#oauth2-client-client-credentials-access-token-response-web-client)
...
<a id="oauth2-client-client-credentials-access-token-response-web-client"></a>
...
Whether you customize `WebClientReactiveClientCredentialsTokenResponseClient` or provide your own implementation of `ReactiveOAuth2AccessTokenResponseClient`, you can configure it using the `ReactiveOAuth2AuthorizedClientProviderBuilder` (as an alternative to [publishing a bean](#oauth2-client-client-credentials-access-token-response-client-bean)) as follows:
...
> If not provided, it will be obtained from the [Reactor’s Context](https://projectreactor.io/docs/core/release/reference/#context) via the key `ServerWebExchange.class`.

<a id="oauth2-client-password"></a>

## <a id="oauth2Client-password-grant"></a>Resource Owner Password Credentials
...
<a id="oauth2-client-password-access-token"></a>
...
<a id="oauth2-client-password-access-token-response-client-bean"></a>
...
`WebClientReactivePasswordTokenResponseClient` is very flexible and provides several options for customizing the OAuth 2.0 Access Token request and response for the Password grant.
Choose from the following use cases to learn more:

- I want to [customize headers of the Access Token request](#oauth2-client-password-access-token-request-headers)
- I want to [customize parameters of the Access Token request](#oauth2-client-password-access-token-request-parameters)
- I want to [customize parameters of the Access Token response](#oauth2-client-password-access-token-response-parameters)
- I want to [customize the instance of `WebClient` that is used](#oauth2-client-password-access-token-response-web-client)

<a id="oauth2-client-password-access-token-request"></a>
...
<a id="oauth2-client-password-access-token-request-headers"></a>
...
<a id="oauth2-client-password-access-token-request-parameters"></a>
...
<a id="oauth2-client-password-access-token-response"></a>

### Customizing the Access Token Response

`WebClientReactivePasswordTokenResponseClient` provides hooks for customizing the OAuth 2.0 Access Token Response.

<a id="oauth2-client-password-access-token-response-parameters"></a>
...
<a id="oauth2-client-password-access-token-response-web-client"></a>
...
<a id="oauth2-client-password-authorized-client-provider-builder"></a>

### Customize using the Builder

Whether you customize `WebClientReactivePasswordTokenResponseClient` or provide your own implementation of `ReactiveOAuth2AccessTokenResponseClient`, you can configure it using the `ReactiveOAuth2AuthorizedClientProviderBuilder` (as an alternative to [publishing a bean](#oauth2-client-password-access-token-response-client-bean)) as follows:
...
<a id="oauth2-client-password-authorized-client-manager"></a>
...
## <a id="oauth2Client-jwt-bearer-grant"></a>JWT Bearer
...
`WebClientReactiveJwtBearerTokenResponseClient` is very flexible and provides several options for customizing the OAuth 2.0 Access Token request and response for the JWT Bearer grant.
Choose from the following use cases to learn more:
...
- I want to [customize the instance of `WebClient` that is used](#oauth2-client-jwt-bearer-access-token-response-web-client)
...
<a id="oauth2-client-jwt-bearer-access-token-response-web-client"></a>
...
Whether you customize `WebClientReactiveJwtBearerTokenResponseClient` or provide your own implementation of `ReactiveOAuth2AccessTokenResponseClient`, you can configure it using the `ReactiveOAuth2AuthorizedClientProviderBuilder` (as an alternative to [publishing a bean](#oauth2-client-jwt-bearer-access-token-response-client-bean)) as follows:
...
`WebClientReactiveTokenExchangeTokenResponseClient` is very flexible and provides several options for customizing the OAuth 2.0 Access Token request and response for the Token Exchange grant.
Choose from the following use cases to learn more:
...
- I want to [customize the instance of `WebClient` that is used](#oauth2-client-token-exchange-access-token-response-web-client)
...
<a id="oauth2-client-token-exchange-access-token-response-web-client"></a>
...
Whether you customize `WebClientReactiveTokenExchangeTokenResponseClient` or provide your own implementation of `ReactiveOAuth2AccessTokenResponseClient`, you can configure it using the `ReactiveOAuth2AuthorizedClientProviderBuilder` (as an alternative to [publishing a bean](#oauth2-client-token-exchange-access-token-response-client-bean)) as follows:
