...
source: "ROOT:servlet/integrations/data.adoc"
---
...
By exposing the `SecurityEvaluationContextExtension` bean, all of the [Common Security Expressions](../authorization/method-security.md#authorization-expressions) are available within the Query.
