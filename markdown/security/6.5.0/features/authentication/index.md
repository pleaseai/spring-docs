...
Refer to the sections on authentication for [Servlet](../../servlet/authentication/index.md) and [WebFlux](../../reactive/authentication/index.md) for details on what is supported for each stack.
