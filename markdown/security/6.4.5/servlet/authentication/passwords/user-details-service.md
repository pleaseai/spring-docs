...
[`UserDetailsService`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/core/userdetails/UserDetailsService.html) is used by [`DaoAuthenticationProvider`](dao-authentication-provider.md#servlet-authentication-daoauthenticationprovider) for retrieving a username, a password, and other attributes for authenticating with a username and password.
