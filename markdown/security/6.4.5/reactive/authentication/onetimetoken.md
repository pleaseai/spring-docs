...
- OTT: Usually a custom [`ServerOneTimeTokenGenerationSuccessHandler`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/web/server/authentication/ott/ServerOneTimeTokenGenerationSuccessHandler.html) must be implemented, responsible for delivering the token to the end user.
...
- OTT: The [`ReactiveOneTimeTokenService.generate(GenerateOneTimeTokenRequest)`](<https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/authentication/ott/reactive/ReactiveOneTimeTokenService.html#generate(org.springframework.security.authentication.ott.GenerateOneTimeTokenRequest)>) method requires a [`OneTimeToken`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/authentication/ott/OneTimeToken.html), wrapped in Mono, to be returned, emphasizing server-side generation.
...
It will also set up the [`OneTimeTokenSubmitPageGeneratingWebFilter`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/web/server/ui/OneTimeTokenSubmitPageGeneratingWebFilter.html) to generate a default One-Time Token submit page.
...
Therefore, a custom [`ServerOneTimeTokenGenerationSuccessHandler`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/web/server/authentication/ott/ServerOneTimeTokenGenerationSuccessHandler.html) must be provided to deliver the token to the user based on your needs.
...
By default, the [`GenerateOneTimeTokenWebFilter`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/web/server/authentication/ott/GenerateOneTimeTokenWebFilter.html) listens to `POST /ott/generate` requests.
...
The default One-Time Token submit page is generated by the [`OneTimeTokenSubmitPageGeneratingWebFilter`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/web/server/ui/OneTimeTokenSubmitPageGeneratingWebFilter.html) and listens to `GET /login/ott`.
...
The interface that define the common operations for generating and consuming one-time tokens is the [`ReactiveOneTimeTokenService`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/authentication/ott/reactive/ReactiveOneTimeTokenService.html).
Spring Security uses the [`InMemoryReactiveOneTimeTokenService`](https://docs.spring.io/spring-security/site/docs/6.4.5/api/org/springframework/security/authentication/ott/reactive/InMemoryReactiveOneTimeTokenService.html) as the default implementation of that interface, if none is provided.
