...
1. [What dependences are needed to run an embedded UnboundID LDAP server?](#appendix-faq-unboundid-deps)
...
You should also consult the [Javadoc](https://docs.spring.io/spring-security/site/docs/7.0.0/api/) for the relevant classes and interfaces.
