...
(See the [`NoOpPasswordEncoder`](https://docs.spring.io/spring-security/site/docs/7.0.0/api/org/springframework/security/crypto/password/NoOpPasswordEncoder.html) class in the Javadoc.)
