---
title: "Authorize ServerHttpRequest"
source: "ROOT:reactive/authorization/authorize-http-requests.adoc"
---
...
1. Any URL that starts with "/admin/" will be restricted to users who have the authority "ROLE\_ADMIN".
You will notice that since we are invoking the `hasRole` method we do not need to specify the "ROLE\_" prefix.
1. Any URL that starts with "/db/" requires the user to have both "ROLE\_ADMIN" and "ROLE\_DBA".
