...
```text
$ java -jar sec-server-win-auth-7.1.0.jar
```
...
![ie1](https://raw.githubusercontent.com/spring-projects/spring-security/7.1.0/docs/modules/ROOT/assets/images/servlet/authentication/kerberos/ie1.png)

![ie2](https://raw.githubusercontent.com/spring-projects/spring-security/7.1.0/docs/modules/ROOT/assets/images/servlet/authentication/kerberos/ie2.png)

Access sample application from a non windows vm and use domain
credentials manually.

![ff1](https://raw.githubusercontent.com/spring-projects/spring-security/7.1.0/docs/modules/ROOT/assets/images/servlet/authentication/kerberos/ff1.png)

![ff2](https://raw.githubusercontent.com/spring-projects/spring-security/7.1.0/docs/modules/ROOT/assets/images/servlet/authentication/kerberos/ff2.png)

![ff3](https://raw.githubusercontent.com/spring-projects/spring-security/7.1.0/docs/modules/ROOT/assets/images/servlet/authentication/kerberos/ff3.png)
...
```text
$ java -jar sec-server-client-auth-7.1.0.jar
```
...
```text
$ java -jar sec-server-spnego-form-auth-7.1.0.jar
```
...
```text
$ java -jar sec-client-rest-template-7.1.0.jar --app.user-principal --app.keytab-location
```
...
```text
$ java -jar sec-client-rest-template-7.1.0.jar
```
