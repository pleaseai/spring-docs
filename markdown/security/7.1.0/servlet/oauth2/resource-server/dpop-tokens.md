---
title: "OAuth 2.0 DPoP-bound Access Tokens"
source: "ROOT:servlet/oauth2/resource-server/dpop-tokens.adoc"
---

<a id="oauth2-dpop-bound-access-tokens"></a>
...
When the client initiates an [access token request](#dpop-access-token-request), it attaches a DPoP proof to the request in an HTTP header.
The authorization server binds (sender-constrains) the access token to the public key associated in the DPoP proof.

When the client initiates a [protected resource request](#dpop-protected-resource-request), it again attaches a DPoP proof to the request in an HTTP header.
...
<a id="dpop-access-token-request"></a>
...
<a id="dpop-public-key-confirmation"></a>
...
<a id="dpop-protected-resource-request"></a>
