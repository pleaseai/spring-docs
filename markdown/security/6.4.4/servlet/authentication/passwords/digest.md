...
(See the [`NoOpPasswordEncoder`](https://docs.spring.io/spring-security/site/docs/6.4.4/api/org/springframework/security/crypto/password/NoOpPasswordEncoder.html) class in the Javadoc.)
