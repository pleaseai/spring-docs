...
- Hello RSocket [hellorsocket](https://github.com/spring-projects/spring-security-samples/tree/6.5.x/reactive/rsocket/hello-security)
...
Spring Boot registers it automatically in `RSocketSecurityAutoConfiguration` when you include [the correct dependencies](https://github.com/spring-projects/spring-security-samples/tree/6.5.x/reactive/rsocket/hello-security/build.gradle).
