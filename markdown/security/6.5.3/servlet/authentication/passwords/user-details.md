...
[`UserDetails`](https://docs.spring.io/spring-security/site/docs/6.5.3/api/org/springframework/security/core/userdetails/UserDetails.html) is returned by the [`UserDetailsService`](user-details-service.md#servlet-authentication-userdetailsservice).
