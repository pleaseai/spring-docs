...
So, to complete migration, [`@EnableReactiveMethodSecurity`](https://docs.spring.io/spring-security/site/docs/6.5.4/api/org/springframework/security/config/annotation/method/configuration/EnableReactiveMethodSecurity.html) remove the `useAuthorizationManager` attribute:
...
[`AuthenticationWebFilter`](https://docs.spring.io/spring-security/site/docs/6.5.4/api/org/springframework/security/web/server/authentication/AuthenticationWebFilter.html) propagates [`AuthenticationServiceException`](https://docs.spring.io/spring-security/site/docs/6.5.4/api/org/springframework/security/authentication/AuthenticationServiceException.html)s to the [`ServerAuthenticationEntryPoint`](https://docs.spring.io/spring-security/site/docs/6.5.4/api/org/springframework/security/web/server/ServerAuthenticationEntryPoint.html).
