...
1. Supports reactive return types. Note that we are waiting on [additional coroutine support from the Spring Framework](https://github.com/spring-projects/spring-framework/issues/22462) before adding coroutine support.
...
<a id="jc-reactive-method-security-custom-authorization-manager"></a>
...
> If any other interceptors are present and come after Spring Security’s method security interceptor, [they will be skipped](https://github.com/spring-projects/spring-framework/issues/22462).
...
You can find a complete sample in [hellowebflux-method](https://github.com/spring-projects/spring-security-samples/tree/6.2.x/reactive/webflux/java/method).
