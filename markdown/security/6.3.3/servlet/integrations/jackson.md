...
>
> - spring-security-core ([`CoreJackson2Module`](https://docs.spring.io/spring-security/site/docs/6.3.3/api/org/springframework/security/jackson2/CoreJackson2Module.html))
...
> - [spring-security-oauth2-client](#oauth2client) ([`OAuth2ClientJackson2Module`](https://docs.spring.io/spring-security/site/docs/6.3.3/api/org/springframework/security/oauth2/client/jackson2/OAuth2ClientJackson2Module.html))
> - spring-security-cas ([`CasJackson2Module`](https://docs.spring.io/spring-security/site/docs/6.3.3/api/org/springframework/security/cas/jackson2/CasJackson2Module.html))
