...
General support for [Java configuration](https://docs.spring.io/spring-framework/reference/6.2.17/core/beans/java.html) was added to Spring Framework in Spring 3.1.
...
You can do so in Java configuration with [Spring’s `WebApplicationInitializer` support](https://docs.spring.io/spring-framework/reference/6.2.17/web/webmvc/mvc-servlet/container-config.html) in a Servlet 3.0+ environment.
