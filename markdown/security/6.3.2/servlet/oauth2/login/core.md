...
This section shows how to configure the [**OAuth 2.0 Login sample**](https://github.com/spring-projects/spring-security-samples/tree/6.3.x/servlet/spring-boot/java/oauth2/login) by using *Google* as the *Authentication Provider* and covers the following topics:
