...
![opaquetokenauthenticationprovider](https://raw.githubusercontent.com/spring-projects/spring-security/6.4.10/docs/modules/ROOT/assets/images/servlet/oauth2/opaquetokenauthenticationprovider.png)
...
![number 3](https://raw.githubusercontent.com/spring-projects/spring-security/6.4.10/docs/modules/ROOT/assets/images/icons/number_3.png) `OpaqueTokenAuthenticationProvider` introspects the opaque token and adds granted authorities using an [`OpaqueTokenIntrospector`](#oauth2resourceserver-opaque-introspector).
