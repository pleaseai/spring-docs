...
> [!NOTE]
> The completed starter application can be found [in our samples repository](https://github.com/spring-projects/spring-security-samples/tree/6.4.x/servlet/spring-boot/java/hello-security).
