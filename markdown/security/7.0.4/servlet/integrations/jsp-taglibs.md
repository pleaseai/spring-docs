...
source: "ROOT:servlet/integrations/jsp-taglibs.adoc"
---
...
The first approach uses a [web-security expression](../authorization/authorize-http-requests.md#authorization-expressions), which is specified in the `access` attribute of the tag.
...
If you have [method-based authorization rules](../authorization/authorize-http-requests.md#match-by-httpmethod), you should combine this approach with the `method` attribute (supplying the HTTP method, such as `POST`) to activate the intended method-based rule.
...
<a id="_disabling_tag_authorization_for_testing"></a>
...
<a id="_the_authentication_tag"></a>
...
<a id="_the_accesscontrollist_tag"></a>
...
> Instead, use the [The authorize Tag](#taglibs-authorize).
