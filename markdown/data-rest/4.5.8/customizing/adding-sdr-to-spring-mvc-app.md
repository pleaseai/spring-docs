...
<a id="customizing-sdr.adding-sdr-to-spring-mvc-app"></a>
...
<a id="customizing-sdr.adding-sdr-to-spring-mvc-app.required-config"></a>
...
<a id="customizing-sdr.adding-sdr-to-spring-mvc-app.required-config.mapping"></a>
