...
- Using Spring Data REST’s implementation of [`RepositoryEntityLinks`](https://docs.spring.io/spring-data/rest/docs/4.5.5/api/org/springframework/data/rest/webmvc/support/RepositoryEntityLinks.html).
