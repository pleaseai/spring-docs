...
For more detailed client configuration tweaks, see [`LettuceClientConfiguration`](https://docs.spring.io/spring-data/redis/docs/3.3.12/api/org/springframework/data/redis/connection/lettuce/LettuceClientConfiguration.html).
