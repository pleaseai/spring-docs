...
See [`EnableKeyspaceEvents`](https://docs.spring.io/spring-data/redis/docs/3.3.2/api/org/springframework/data/redis/core/RedisKeyValueAdapter.EnableKeyspaceEvents.html) for possible values.
