...
- [`RedisTemplate` and `ReactiveRedisTemplate` helper class](redis/template.md) that increases productivity when performing common Redis operations.
...
- Feature-rich [Object Mapping](redis/redis-repositories/mapping.md) integrated with Spring’s Conversion Service.
- Annotation-based mapping metadata that is extensible to support other metadata formats.
- [Transactions](redis/transactions.md) and [Pipelining](redis/pipelining.md).
- [Redis Cache](redis/redis-cache.md) integration through Spring’s Cache abstraction.
- [Redis Pub/Sub Messaging](redis/pubsub.md) and [Redis Stream](redis/redis-streams.md) Listeners.
- [Redis Collection Implementations](redis/support-classes.md) for Java such as `RedisList` or `RedisSet`.

<a id="_why_spring_data_redis"></a>
