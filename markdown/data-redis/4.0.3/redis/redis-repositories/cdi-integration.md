...
A Redis Repository requires [`RedisKeyValueAdapter`](https://docs.spring.io/spring-data/redis/docs/4.0.3/api/org/springframework/data/redis/core/RedisKeyValueAdapter.html) and [`RedisKeyValueTemplate`](https://docs.spring.io/spring-data/redis/docs/4.0.3/api/org/springframework/data/redis/core/RedisKeyValueTemplate.html) instances.
