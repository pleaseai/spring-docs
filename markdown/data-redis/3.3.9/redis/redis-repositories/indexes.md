...
source: "ROOT:redis/redis-repositories/indexes.adoc"
---

<a id="redis.repositories.indexes"></a>

# Secondary Indexes

[Secondary indexes](https://redis.io/topics/indexes) are used to enable lookup operations based on native Redis structures.
Values are written to the according indexes on every save and are removed when objects are deleted or [expire](expirations.md).

<a id="redis.repositories.indexes.simple"></a>
...
1. `SADD people:relatives.map-key.firstname:tam e2c7dcee-b8cd-4424-883e-736ce564363e`
1. `SADD people:addresses.city:tear e2c7dcee-b8cd-4424-883e-736ce564363e`

> [!CAUTION]
> Indexes cannot be resolved on [References](usage.md#redis.repositories.references).
...
<a id="redis.repositories.indexes.geospatial"></a>
...
1. Query method declaration on a nested property, using `Circle` to search within.
1. `GEOADD people:address:location 13.361389 38.115556 e2c7dcee-b8cd-4424-883e-736ce564363e`
1. `GEORADIUS people:address:location 15.0 37.0 200.0 km`
