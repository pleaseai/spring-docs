...
source: "ROOT:redis/redis-repositories/mapping.adoc"
---

<a id="redis.repositories.mapping"></a>
...
1. Simple property values are mapped by path.
1. Properties of complex types are mapped by their dot path.
...
> [!NOTE]
> Custom conversions have no effect on index resolution. [Secondary Indexes](indexes.md) are still created, even for custom converted types.

<a id="customizing-type-mapping"></a>
...
If you need to customize the mapping even more, look at the [`TypeInformationMapper`](https://docs.spring.io/spring-data/commons/reference/3.5.3/api/java/org/springframework/data/convert/TypeInformationMapper.html) interface.
...
<a id="configuring-custom-type-mapping"></a>
