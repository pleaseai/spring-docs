...
The `checkAndSet` method above then runs the scripts. Scripts can be run within a `SessionCallback` as part of a transaction or pipeline. See “[Redis Transactions](transactions.md)” and “[Pipelining](pipelining.md)” for more information.
