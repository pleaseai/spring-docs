...
source: "ROOT:redis/pubsub-annotated.adoc"
---

<a id="pubsub-annotated"></a>
...
<a id="redis-annotated-support"></a>
...
You can customize the [listener registrar](https://docs.spring.io/spring-data/redis/docs/4.1.0/api/org/springframework/data/redis/config/RedisListenerEndpointRegistrar.html) by implementing the `RedisListenerConfigurer` interface.
See the javadoc of classes that implement [`RedisListenerConfigurer`](https://docs.spring.io/spring-data/redis/docs/4.1.0/api/org/springframework/data/redis/config/RedisListenerConfigurer.html) for details and examples.

<a id="redis-annotated-programmatic-registration"></a>
...
<a id="redis-annotated-method-signature"></a>
...
[`RedisMessageConverters`](https://docs.spring.io/spring-data/redis/docs/4.1.0/api/org/springframework/data/redis/serializer/RedisMessageConverters.html) registers by default the following converters:
