...
[`RedisOperations`](https://docs.spring.io/spring-data/redis/docs/4.1.0/api/org/springframework/data/redis/core/RedisOperations.html) (typically backed by [`RedisTemplate`](https://docs.spring.io/spring-data/redis/docs/4.1.0/api/org/springframework/data/redis/core/RedisTemplate.html)), or through the message-oriented
[`RedisMessageSendingTemplate`](https://docs.spring.io/spring-data/redis/docs/4.1.0/api/org/springframework/data/redis/messaging/RedisMessageSendingTemplate.html).
