...
To use Redis as a backing implementation, add [`RedisCacheManager`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCacheManager.html) to your configuration, as follows:
...
`RedisCacheManager` behavior can be configured with [`RedisCacheManager.RedisCacheManagerBuilder`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCacheManager.RedisCacheManagerBuilder.html), letting you set the default [`RedisCacheManager`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCacheManager.html), transaction behavior, and predefined caches.
...
The behavior of [`RedisCache`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCache.html) created by [`RedisCacheManager`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCacheManager.html) is defined with `RedisCacheConfiguration`.
...
[`RedisCacheManager`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCacheManager.html) defaults to a lock-free [`RedisCacheWriter`](https://docs.spring.io/spring-data/redis/docs/3.5.5/api/org/springframework/data/redis/cache/RedisCacheWriter.html) for reading and writing binary values.
