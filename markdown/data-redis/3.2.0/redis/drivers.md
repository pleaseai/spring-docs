---
title: "Drivers"
source: "ROOT:redis/drivers.adoc"
---

<a id="redis:connectors"></a>
...
<a id="redis:connectors:connection"></a>
...
It also automatically translates underlying connecting library exceptions to Spring’s consistent [DAO exception hierarchy](https://docs.spring.io/spring-framework/reference/6.1/data-access.html#dao-exceptions) so that you can switch connectors without any code changes, as the operation semantics remain the same.
...
For more information, see the dedicated [section](https://docs.spring.io/spring-framework/reference/6.1/data-access.html#orm-exception-translation) in the Spring Framework documentation.
...
> See [documentation](template.md) on `RedisTemplate` for more details.
...
<a id="redis:connectors:overview"></a>

| Supported Feature | Lettuce | Jedis |
| --- | --- | --- |
| Standalone Connections | X | X |
| [Master/Replica Connections](../redis.md#redis:write-to-master-read-from-replica) | X |  |
| [Redis Sentinel](../redis.md#redis:sentinel) | Master Lookup, Sentinel Authentication, Replica Reads | Master Lookup |
| [Redis Cluster](cluster.md) | Cluster Connections, Cluster Node Connections, Replica Reads | Cluster Connections, Cluster Node Connections |
...
| SSL Support | X | X |
| [Pub/Sub](pubsub.md) | X | X |
| [Pipelining](pipelining.md) | X | X (Pipelining and Transactions mutually exclusive) |
| [Transactions](transactions.md) | X | X (Pipelining and Transactions mutually exclusive) |
...
<a id="redis:connectors:lettuce"></a>
...
For more detailed client configuration tweaks, see [`LettuceClientConfiguration`](https://docs.spring.io/spring-data/redis/docs/current/api/org/springframework/data/redis/connection/lettuce/LettuceClientConfiguration.html).
