...
source: "ROOT:redis/redis-repositories/cluster.adoc"
---

<a id="redis.repositories.cluster"></a>

# Redis Repositories Running on a Cluster

You can use the Redis repository support in a clustered Redis environment.
See the “[Redis Cluster](../cluster.md)” section for `ConnectionFactory` configuration details.
