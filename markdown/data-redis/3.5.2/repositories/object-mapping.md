...
> In all other cases you can exclude synthetic fields for delegated properties by annotating the property with [`@Transient`](https://docs.spring.io/spring-data/commons/docs/3.5.2/api//org/springframework/data/annotation/Transient.html).
