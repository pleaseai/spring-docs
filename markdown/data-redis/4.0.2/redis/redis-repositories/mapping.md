...
If you need to customize the mapping even more, look at the [`TypeInformationMapper`](https://docs.spring.io/spring-data/commons/reference/4.0/api/java/org/springframework/data/convert/TypeInformationMapper.html) interface.
