...
| [Master/Replica Connections](connection-modes.md#redis:write-to-master-read-from-replica) | X |  |
| [Redis Sentinel](connection-modes.md#redis:sentinel) | Master Lookup, Sentinel Authentication, Replica Reads | Master Lookup |
...
For more detailed client configuration tweaks, see [`LettuceClientConfiguration`](https://docs.spring.io/spring-data/redis/docs/4.0.7/api/org/springframework/data/redis/connection/lettuce/LettuceClientConfiguration.html).
