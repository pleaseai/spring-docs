...
These operations are available on [`RedisTemplate`](https://docs.spring.io/spring-data/redis/docs/4.0.7/api/org/springframework/data/redis/core/RedisTemplate.html).
