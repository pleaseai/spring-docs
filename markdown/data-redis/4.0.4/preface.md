...
[core](https://docs.spring.io/spring-framework/reference/7.0/core.html) functionality, including:

- [IoC](https://docs.spring.io/spring-framework/reference/7.0/core.html#beans) container
- [type conversion system](https://docs.spring.io/spring-framework/reference/7.0/core.html#validation)
- [expression language](https://docs.spring.io/spring-framework/reference/7.0/core.html#expressions)
- [JMX integration](https://docs.spring.io/spring-framework/reference/7.0/integration.html#jmx)
- [DAO exception hierarchy](https://docs.spring.io/spring-framework/reference/7.0/data-access.html#dao-exceptions).
...
Spring Data Redis binaries require JDK level 17 and above and [Spring Framework](https://spring.io/projects/spring-framework/) 7.0.6 and above.
