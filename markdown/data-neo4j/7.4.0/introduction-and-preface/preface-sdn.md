---
title: "Introducing Spring Data Neo4j"
source: "ROOT:introduction-and-preface/preface-sdn.adoc"
---
...
Spring Data Neo4j or in short SDN is the next-generation [Spring Data](https://spring.io/projects/spring-data) module, created and maintained by [Neo4j, Inc.](https://neo4j.com) in close collaboration with [VMware’s](https://www.vmware.com/) Spring Data Team.
...
SDN relies completely on the [Neo4j Java Driver](https://github.com/neo4j/neo4j-java-driver), without introducing another "driver" or "transport" layer between the mapping framework and the driver. The Neo4j Java Driver - sometimes dubbed Bolt or the Bolt driver - is used as a protocol much like JDBC is with relational databases.
...
We provide *repositories* as a high-level abstraction for storing and querying documents as well as templates and clients for generic domain access or generic query execution.
...
> [!NOTE]
> You still can use Neo4j-OGM, even in modern Spring Boot applications.
...
Please make sure you read the [Frequently Asked Questions](../faq.md#faq) where we address many reoccurring questions about our mapping decisions but also how interaction with Neo4j cluster instances such as [Neo4j AuraDB](https://neo4j.com/cloud/platform/aura-graph-database/) and on-premise cluster deployments can be significantly improved.
