---
title: "Conversions"
source: "ROOT:appendix/conversions.adoc"
---
...
| `org.springframework.data.domain.Vector` | persisted through `setNodeVectorProperty` |  |
...
<a id="build-in.conversions.vector"></a>
...
> [!NOTE]
> Spring Data Neo4j only allows one `Vector` property to be present in an entity definition.

> [!NOTE]
> Please be aware that a persisted `float` value differs from a read back value due to the nature of floating numbers.
