...
![image$movie graph deep](https://raw.githubusercontent.com/spring-projects/spring-data-neo4j/8.0.6/src/main/antora/modules/ROOT/assets/images/image$movie-graph-deep.png)
...
![image$custom query.paths](https://raw.githubusercontent.com/spring-projects/spring-data-neo4j/8.0.6/src/main/antora/modules/ROOT/assets/images/image$custom-query.paths.png)
...
[Spring Expression Language (SpEL)](https://docs.spring.io/spring-framework/reference/7.0/core/expressions.html) can be used in custom queries inside `:#{}`.
