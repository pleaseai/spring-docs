---
title: "Your way through this document"
source: "ROOT:introduction-and-preface/index.adoc"
---
...
A lot of Neo4j specific questions can be found in the [Frequently Asked Questions](../faq.md#faq). These questions are
...
If you are already familiar with the core concepts of Spring Data, head straight to [getting-started](../getting-started.md#getting-started).
...
Go to [mapping](../object-mapping/metadata-based-mapping.md#mapping.annotations) to learn about how to map nodes and relationships to your domain model.
...
you will most likely be interested in the [introduction to SDN](preface-sdn.md#preface.sdn) and especially in the relationship
[between SDN+OGM and the current SDN](../faq.md#faq.sdn-related-to-ogm). In the same chapter, you will find out about the
[building blocks](building-blocks.md#building-blocks) of SDN.

To learn more about the general concepts of repositories, head over to [repositories](../repositories.md#repositories).
