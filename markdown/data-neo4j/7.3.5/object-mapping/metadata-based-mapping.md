...
- `@CompositeProperty`: Applied at the field level on attributes of type Map that shall be read back as a composite. See [Composite properties](../appendix/conversions.md#custom.conversions.composite-properties).
...
See [Conversions](../appendix/conversions.md#custom.conversions.attribute.specific) for more information on that.
