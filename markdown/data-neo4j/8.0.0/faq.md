...
![image$bacon distance](https://raw.githubusercontent.com/spring-projects/spring-data-neo4j/8.0.0/src/main/antora/modules/ROOT/assets/images/image$bacon-distance.png)
...
- Use the [Cypher-DSL](https://neo4j.github.io/cypher-dsl) via the `CypherdslStatementExecutor` or the `ReactiveCypherdslStatementExecutor`.
