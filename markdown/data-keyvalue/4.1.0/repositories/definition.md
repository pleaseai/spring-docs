...
source: "ROOT:repositories/definition.adoc"
---
...
<a id="repositories.definition-tuning"></a>
...
<a id="repositories.multiple-modules"></a>
...
1. If the domain class is [annotated with the module-specific type annotation](#repositories.multiple-modules.annotations), it is a valid candidate for the particular Spring Data module.
...
<a id="repositories.multiple-modules.types"></a>
...
<a id="repositories.multiple-modules.annotations"></a>
...
The [base package in XML-based configuration](create-instances.md#repositories.create-instances.xml) is mandatory.
