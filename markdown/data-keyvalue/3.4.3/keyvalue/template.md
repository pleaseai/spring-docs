...
> [!TIP]
> `@KeySpace` supports [SpEL](https://docs.spring.io/spring/docs/6.2.3/spring-framework-reference/core.html#expressions) expressions allowing dynamic keyspace configuration.
