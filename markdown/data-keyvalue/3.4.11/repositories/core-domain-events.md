---
title: "Publishing Events from Aggregate Roots"
source: "ROOT:repositories/core-domain-events.adoc"
---

<a id="core.domain-events"></a>
...
1. After all events have been published, we have a method annotated with `@AfterDomainEventPublication`.
