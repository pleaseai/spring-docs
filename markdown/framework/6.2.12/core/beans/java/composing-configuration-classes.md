---
title: "Composing Java-based Configurations"
source: "ROOT:core/beans/java/composing-configuration-classes.adoc"
---
...
[we already discussed](bean-annotation.md#beans-java-dependencies),
...
> [`AutowiredAnnotationBeanPostProcessor`](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/beans/factory/annotation/AutowiredAnnotationBeanPostProcessor.html).
...
<a id="beans-java-injecting-imported-beans-fq"></a>
...
[Spring Tools for Eclipse](https://spring.io/tools) provides tooling that
...
<a id="beans-java-startup-background"></a>
...
profile has been enabled in the Spring `Environment` (see [Bean Definition Profiles](../environment.md#beans-definition-profiles)
for details).

The `@Profile` annotation is actually implemented by using a much more flexible annotation
called [`@Conditional`](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/context/annotation/Conditional.html).
...
See the [`@Conditional`](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/context/annotation/Conditional.html)
...
<a id="beans-java-combining-xml-centric-declare-as-bean"></a>
...
<a id="beans-java-combining-xml-centric-component-scan"></a>
