...
> [!TIP]
> Dialects are resolved by [`BindMarkersFactoryResolver`](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/r2dbc/core/binding/BindMarkersFactoryResolver.html)
...
See the attendant [javadoc](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/r2dbc/core/DatabaseClient.html) for that.
...
See the [`TransactionAwareConnectionFactoryProxy`](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/r2dbc/connection/TransactionAwareConnectionFactoryProxy.html)
