...
[`SockJsHttpRequestHandler`](https://docs.spring.io/spring-framework/docs/6.2.12/javadoc-api/org/springframework/web/socket/sockjs/support/SockJsHttpRequestHandler.html).
...
[Allowed Origins](server.md#websocket-server-allowed-origins)), the SockJS
