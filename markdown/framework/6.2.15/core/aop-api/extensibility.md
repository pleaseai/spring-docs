...
See the [`org.springframework.aop.framework.adapter`](https://docs.spring.io/spring-framework/docs/6.2.15/javadoc-api/org/springframework/aop/framework/adapter/package-summary.html)
