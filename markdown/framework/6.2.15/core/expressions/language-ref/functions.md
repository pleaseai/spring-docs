---
title: "Functions"
source: "ROOT:core/expressions/language-ref/functions.adoc"
---
...
invocations, [varargs](varargs.md) are also supported
...
> [variables](variables.md) in the evaluation context,
