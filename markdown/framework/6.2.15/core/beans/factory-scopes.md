...
> [`SimpleThreadScope`](https://docs.spring.io/spring-framework/docs/6.2.15/javadoc-api/org/springframework/context/support/SimpleThreadScope.html).
...
![singleton](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.2.15/framework-docs/modules/ROOT/assets/images/singleton.png)
...
![prototype](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.2.15/framework-docs/modules/ROOT/assets/images/prototype.png)
...
[`Scope`](https://docs.spring.io/spring-framework/docs/6.2.15/javadoc-api/org/springframework/beans/factory/config/Scope.html) javadoc,
...
See the [javadoc](https://docs.spring.io/spring-framework/docs/6.2.15/javadoc-api/org/springframework/beans/factory/config/Scope.html#registerDestructionCallback)
