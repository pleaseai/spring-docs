...
The shortcuts are
[Custom Annotations](#mvc-ann-requestmapping-composed)
...
See [MVC config](../mvc-config/path-matching.md) for customizations of path matching options.
...
- [`PathPattern.SPECIFICITY_COMPARATOR`](https://docs.spring.io/spring-framework/docs/7.0.6/javadoc-api/org/springframework/web/util/pattern/PathPattern.html#SPECIFICITY_COMPARATOR)
- [`AntPathMatcher.getPatternComparator(String path)`](<https://docs.spring.io/spring-framework/docs/7.0.6/javadoc-api/org/springframework/util/AntPathMatcher.html#getPatternComparator(java.lang.String)>)
...
> [consumes](#mvc-ann-requestmapping-consumes)
> and [produces](#mvc-ann-requestmapping-produces)
> instead.

<a id="mvc-ann-requestmapping-version"></a>

## API Version

[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-version)

There is no standard way to specify an API version, so when you enable API versioning
in the [MVC Config](../mvc-config/api-version.md) you need
to specify how to resolve the version. The MVC Config creates an
[ApiVersionStrategy](../../webmvc-versioning.md#mvc-versioning-strategy) that in turn
...
- Baseline version ("1.2+") — matches the given and [supported versions](../mvc-config/api-version.md) above
...
1. match any version
1. match version 1.1
1. match version 1.2 and supported versions above
1. match version 1.5
...
> [configured as supported](../mvc-config/api-version.md).
...
See [API Versioning](../../webmvc-versioning.md) for more details on underlying
...
where an [HTTP Service Client](../../../integration/rest-clients.md#rest-http-service-client)
...
[@HttpExchange](../../../integration/rest-clients.md#rest-http-service-client-method-parameters) and
...
[`@RequestMapping`](#mvc-ann-requestmapping-params-and-headers) supports.
