...
See the [`org.springframework.aop.framework.adapter`](https://docs.spring.io/spring-framework/docs/7.0.6/javadoc-api/org/springframework/aop/framework/adapter/package-summary.html)
