---
title: "Variables"
source: "ROOT:core/expressions/language-ref/variables.adoc"
---
...
> [functions](functions.md) in the evaluation context,
...
[collection selection](collection-selection.md).
...
conjunction with
[collection projection](collection-projection.md).
