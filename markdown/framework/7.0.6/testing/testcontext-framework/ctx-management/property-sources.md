---
title: "Context Configuration with Test Property Sources"
source: "ROOT:testing/testcontext-framework/ctx-management/property-sources.adoc"
---

<a id="testcontext-ctx-management-property-sources"></a>
...
<a id="declaring-test-property-sources"></a>
...
<a id="default-properties-file-detection"></a>
...
<a id="testcontext-ctx-management-property-sources-precedence"></a>
...
[`@DynamicPropertySource`](dynamic-property-sources.md) have
...
<a id="inheriting-and-overriding-test-property-sources"></a>
...
> [`@Nested` test class configuration](../support-classes.md#testcontext-junit-jupiter-nested-test-configuration) for details.
