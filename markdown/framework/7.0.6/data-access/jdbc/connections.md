...
See the [`TransactionAwareDataSourceProxy`](https://docs.spring.io/spring-framework/docs/7.0.6/javadoc-api/org/springframework/jdbc/datasource/TransactionAwareDataSourceProxy.html)
