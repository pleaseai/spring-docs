...
- WebMvc.fn DSL with [router { }](https://docs.spring.io/spring-framework/docs/6.1.2/kdoc-api/spring-webmvc/org.springframework.web.servlet.function/router.html)
- WebFlux.fn [Reactive](../../web-reactive.md#webflux-fn) DSL with [router { }](https://docs.spring.io/spring-framework/docs/6.1.2/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/router.html)
- WebFlux.fn [\[Coroutines\]](#Coroutines) DSL with [coRouter { }](https://docs.spring.io/spring-framework/docs/6.1.2/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/co-router.html)
...
[`ScriptTemplateView`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/web/servlet/view/script/ScriptTemplateView.html)
