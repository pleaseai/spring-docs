---
title: "MockMvc and Geb"
source: "ROOT:testing/spring-mvc-test-framework/server-htmlunit/geb.adoc"
---

<a id="spring-mvc-test-server-htmlunit-geb"></a>
...
<a id="spring-mvc-test-server-htmlunit-geb-why"></a>

## Why Geb and MockMvc?

Geb is backed by WebDriver, so it offers many of the
[same benefits](webdriver.md#spring-mvc-test-server-htmlunit-webdriver-why) that we get from
WebDriver. However, Geb makes things even easier by taking care of some of the
boilerplate code for us.

<a id="spring-mvc-test-server-htmlunit-geb-setup"></a>
...
> usage, see [Advanced `MockMvcHtmlUnitDriverBuilder`](webdriver.md#spring-mvc-test-server-htmlunit-webdriver-advanced-builder).
...
<a id="spring-mvc-test-server-htmlunit-geb-usage"></a>
...
[HtmlUnit test](mah.md#spring-mvc-test-server-htmlunit-mah-usage) by using the Page Object
