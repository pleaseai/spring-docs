---
title: "General ORM Integration Considerations"
source: "ROOT:data-access/orm/general.adoc"
---
...
The [Hibernate](hibernate.md) section provides more details and also show these features and
...
JDBC, the `JdbcTemplate` class mentioned in a [previous section](../jdbc/core.md#jdbc-JdbcTemplate)
...
[next section](#orm-exception-translation) for how to get the same exception
...
For details on transaction support, see the [Transaction Management](../transaction.md) chapter.

<a id="orm-exception-translation"></a>
