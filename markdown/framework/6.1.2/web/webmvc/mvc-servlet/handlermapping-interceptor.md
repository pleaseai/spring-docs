---
title: "Interception"
source: "ROOT:web/webmvc/mvc-servlet/handlermapping-interceptor.adoc"
---
...
See [Interceptors](../mvc-config/interceptors.md) in the section on MVC configuration for examples of how to
...
declare it as an [Controller Advice](../mvc-controller/ann-advice.md) bean or configure it directly on
