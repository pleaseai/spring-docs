...
source: "ROOT:core/beans/basics.adoc"
---
...
instance of
[`ClassPathXmlApplicationContext`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/context/support/ClassPathXmlApplicationContext.html)
or [`FileSystemXmlApplicationContext`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/context/support/FileSystemXmlApplicationContext.html).
...
[Convenient ApplicationContext Instantiation for Web Applications](context-introduction.md#context-create)).
If you use the [Spring Tools for Eclipse](https://spring.io/tools) (an Eclipse-powered
...
![container magic](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.2/framework-docs/modules/ROOT/assets/images/container-magic.png)
...
> [Java-based configuration](java.md) for their Spring applications.

For information about using other forms of metadata with the Spring container, see:

- [Annotation-based configuration](annotation-config.md): define beans using
annotation-based configuration metadata.
- [Java-based configuration](java.md): define beans external to your application
classes by using Java rather than XML files. To use these features, see the
[`@Configuration`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/context/annotation/Configuration.html),
[`@Bean`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/context/annotation/Bean.html),
[`@Import`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/context/annotation/Import.html),
and [`@DependsOn`](https://docs.spring.io/spring-framework/docs/6.1.2/javadoc-api/org/springframework/context/annotation/DependsOn.html) annotations.
...
1. The `class` attribute defines the type of the bean and uses the fully qualified
class name.
...
> [Resources](../../web/webflux-webclient/client-builder.md#webflux-client-builder-reactor-resources))
...
> as described in [Application Contexts and Resource Paths](../resources.md#resources-app-ctx).
...
[previous section](#beans-factory-instantiation). Alternatively,
