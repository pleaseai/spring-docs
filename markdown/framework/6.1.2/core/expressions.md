...
source: "ROOT:core/expressions.adoc"
---
...
for code completion support within the [Spring Tools for Eclipse](https://spring.io/tools).
...
[Expression support for defining bean definitions](expressions/beandef.md).
