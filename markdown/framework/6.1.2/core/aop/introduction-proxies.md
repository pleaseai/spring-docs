---
title: "AOP Proxies"
source: "ROOT:core/aop/introduction-proxies.adoc"
---
...
[force the use of CGLIB](proxying.md), in those (hopefully rare) cases where you
...
[Understanding AOP Proxies](proxying.md#aop-understanding-aop-proxies) for a thorough examination of exactly what this
