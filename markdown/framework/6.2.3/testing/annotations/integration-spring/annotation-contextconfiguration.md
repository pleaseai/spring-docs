...
[Component Classes](../../testcontext-framework/ctx-management/javaconfig.md#testcontext-ctx-management-javaconfig-component-classes) for further details.
...
[`@Nested` test class configuration](../../testcontext-framework/support-classes.md#testcontext-junit-jupiter-nested-test-configuration), and the `@ContextConfiguration`
