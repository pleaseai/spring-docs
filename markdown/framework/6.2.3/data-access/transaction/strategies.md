---
title: "Understanding the Spring Framework Transaction Abstraction"
source: "ROOT:data-access/transaction/strategies.adoc"
---

<a id="transaction-strategies"></a>
...
[programmatically](programmatic.md#transaction-programmatic-ptm) from your application code. Because
...
although you can use it [programmatically](programmatic.md#transaction-programmatic-rtm) from your
...
about the semantics of transaction propagation in Spring, see [Transaction Propagation](declarative/tx-propagation.md).
...
> [The JEE Schema](../../integration/appendix.md#xsd-schemas-jee).
...
<a id="transaction-strategies-hibernate"></a>
