...
source: "ROOT:core/beans/dependencies/factory-autowire.adoc"
---
...
[discussed elsewhere in this chapter](../child-bean-definitions.md) are also valuable
in this regard.)
...
When using XML-based configuration metadata (see [Dependency Injection](factory-collaborators.md)), you
...
<a id="beans-factory-autowiring-modes-tbl"></a>
...
to `false`, as described in the [next section](#beans-factory-autowire-candidate).
...
as described in [Annotation-based Container Configuration](../annotation-config.md).
...
injection points such as [`@Autowired`](../annotation-config/autowired.md).
...
>
> When using [qualifiers](../annotation-config/autowired-qualifiers.md),
