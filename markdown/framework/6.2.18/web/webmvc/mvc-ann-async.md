...
[`AsyncHandlerInterceptor`](https://docs.spring.io/spring-framework/docs/6.2.18/javadoc-api/org/springframework/web/servlet/AsyncHandlerInterceptor.html)
for more details.

`DeferredResult` provides `onTimeout(Runnable)` and `onCompletion(Runnable)` callbacks.
See the [javadoc of `DeferredResult`](https://docs.spring.io/spring-framework/docs/6.2.18/javadoc-api/org/springframework/web/context/request/async/DeferredResult.html)
...
> [`ReactiveAdapterRegistry`](https://docs.spring.io/spring-framework/docs/6.2.18/javadoc-api/org/springframework/core/ReactiveAdapterRegistry.html) from
