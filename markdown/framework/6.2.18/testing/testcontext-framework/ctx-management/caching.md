...
source: "ROOT:testing/testcontext-framework/ctx-management/caching.adoc"
---

<a id="testcontext-ctx-management-caching"></a>
...
`@DirtiesContext` in [Spring Testing Annotations](../../annotations/integration-spring/annotation-dirtiescontext.md)
...
> execution of a test method according to [`@DirtiesContext`](../../annotations/integration-spring/annotation-dirtiescontext.md)
