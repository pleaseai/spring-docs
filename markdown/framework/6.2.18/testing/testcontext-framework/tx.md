...
As explained in [Transaction Rollback and Commit Behavior](#testcontext-tx-rollback-and-commit-behavior),
...
javadoc for [`TestTransaction`](https://docs.spring.io/spring-framework/docs/6.2.18/javadoc-api/org/springframework/test/context/transaction/TestTransaction.html)
for further details.
...
[javadoc
for `TestContextTransactionUtils.retrieveTransactionManager()`](<https://docs.spring.io/spring-framework/docs/6.2.18/javadoc-api/org/springframework/test/context/transaction/TestContextTransactionUtils.html#retrieveTransactionManager(org.springframework.test.context.TestContext,java.lang.String)>) for details on the
