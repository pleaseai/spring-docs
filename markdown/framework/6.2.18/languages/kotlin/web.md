...
- [WebMvc.fn DSL](../../web/webmvc-functional.md) with [router { }](https://docs.spring.io/spring-framework/docs/6.2.18/kdoc-api/spring-webmvc/org.springframework.web.servlet.function/router.html)
- [WebFlux.fn Reactive DSL](../../web/webflux-functional.md) with [router { }](https://docs.spring.io/spring-framework/docs/6.2.18/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/router.html)
- [WebFlux.fn Coroutines DSL](coroutines.md) with [coRouter { }](https://docs.spring.io/spring-framework/docs/6.2.18/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/co-router.html)
...
[`ScriptTemplateView`](https://docs.spring.io/spring-framework/docs/6.2.18/javadoc-api/org/springframework/web/servlet/view/script/ScriptTemplateView.html)
