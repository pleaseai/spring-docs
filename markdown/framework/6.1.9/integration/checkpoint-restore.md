...
Conceptually, checkpoint and restore align with the [Spring `Lifecycle` contract](../core/beans/factory-nature.md#beans-factory-lifecycle-processor) for individual beans.
