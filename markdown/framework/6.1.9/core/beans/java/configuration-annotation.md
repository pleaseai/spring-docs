...
source: "ROOT:core/beans/java/configuration-annotation.adoc"
---
...
inter-bean dependencies. See [Basic Concepts: `@Bean` and `@Configuration`](basic-concepts.md) for a general introduction.
...
As noted earlier, [lookup method injection](../dependencies/factory-method-injection.md) is an
