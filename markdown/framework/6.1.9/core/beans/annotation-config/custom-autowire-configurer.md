...
[`CustomAutowireConfigurer`](https://docs.spring.io/spring-framework/docs/6.1.9/javadoc-api/org/springframework/beans/factory/annotation/CustomAutowireConfigurer.html)
