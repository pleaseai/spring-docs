...
`AbstractPoolingTargetSource`](https://docs.spring.io/spring-framework/docs/6.1.16/javadoc-api/org/springframework/aop/target/AbstractPoolingTargetSource.html) and the concrete subclass you wish to use for information
