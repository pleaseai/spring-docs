...
source: "ROOT:core/beans/dependencies/factory-properties-detailed.adoc"
---
...
As mentioned in the [previous section](factory-collaborators.md), you can define bean
...
[conversion service](../../validation/convert.md#core-convert-ConversionService-API) is used to convert these
...
The following example uses the [p-namespace](#beans-p-namespace) for even more succinct
XML configuration:
...
IDEA](https://www.jetbrains.com/idea/) or the [Spring Tools for Eclipse](https://spring.io/tools))
...
bean is a [prototype](../factory-scopes.md) bean, this typo and the resulting exception
...
brings value is in the configuration of [AOP interceptors](../../aop-api/pfb.md#aop-pfb-1) in a
...
[relevant section](../child-bean-definitions.md) before continuing.
...
Spring supports extensible configuration formats [with namespaces](../../appendix/xsd-schemas.md),
...
[Constructor-based Dependency Injection](factory-collaborators.md#beans-constructor-injection):
...
[mechanism](factory-collaborators.md#beans-factory-ctor-arguments-resolution) is quite efficient in matching
