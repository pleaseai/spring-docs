...
source: "ROOT:testing/testcontext-framework/web-scoped-beans.adoc"
---

<a id="testcontext-web-scoped-beans"></a>

# Testing Request- and Session-scoped Beans

Spring has supported [Request- and session-scoped beans](../../core/beans/factory-scopes.md#beans-factory-scopes-other)
...
`LoginAction` is instantiated by using [SpEL expressions](../../core/expressions.md) that
