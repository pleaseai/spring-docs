---
title: "Resolving Error Codes to Error Messages"
source: "ROOT:core/validation/error-code-resolution.adoc"
---

<a id="validation-error-code-resolution"></a>
...
to validation errors. In the example shown in the [preceding section](validator.md),
...
in the javadoc of
[`MessageCodesResolver`](https://docs.spring.io/spring-framework/docs/7.0.4/javadoc-api/org/springframework/validation/MessageCodesResolver.html) and
[`DefaultMessageCodesResolver`](https://docs.spring.io/spring-framework/docs/7.0.4/javadoc-api/org/springframework/validation/DefaultMessageCodesResolver.html),
respectively.
