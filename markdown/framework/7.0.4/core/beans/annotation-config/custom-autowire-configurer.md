...
[`CustomAutowireConfigurer`](https://docs.spring.io/spring-framework/docs/7.0.4/javadoc-api/org/springframework/beans/factory/annotation/CustomAutowireConfigurer.html)
