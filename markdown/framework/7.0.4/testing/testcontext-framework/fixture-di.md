...
(see [Dependency Injection with `SpringExtension`](support-classes.md#testcontext-junit-jupiter-di)).
...
[Goals](../integration.md#integration-testing-goals) section. The next two code
