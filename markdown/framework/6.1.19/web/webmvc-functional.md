...
`@Configuration` class, it will be auto-detected by the servlet, as explained in [Running a Server](#webmvc-fn-running).
...
[Server-Sent Events](https://www.w3.org/TR/eventsource/) can be provided via the
...
> [`RouterFunctions#resource(java.util.function.Function)`](<https://docs.spring.io/spring-framework/docs/6.1.19/javadoc-api/org/springframework/web/servlet/function/RouterFunctions.html#resources(java.util.function.Function)>).
