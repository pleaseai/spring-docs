...
source: "ROOT:core/beans/dependencies/factory-method-injection.adoc"
---
...
[singletons](../factory-scopes.md#beans-factory-scopes-singleton). When a singleton bean needs to
...
A solution is to forego some inversion of control. You can [make bean A aware of the container](../factory-nature.md#beans-factory-aware)
 by implementing the `ApplicationContextAware` interface,
and by [making a `getBean("B")` call to the container](../basics.md#beans-factory-client) ask for (a
...
> [this blog entry](https://spring.io/blog/2004/08/06/method-injection/).
...
in [the preceding section](#). The Spring Framework
...
a [singleton](../factory-scopes.md#beans-factory-scopes-singleton), the same instance of the `myCommand`
...
> `Provider` injection point. See [Scoped Beans as Dependencies](../factory-scopes.md#beans-factory-scopes-other-injection).
>
