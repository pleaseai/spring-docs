---
title: "Bean Scopes"
source: "ROOT:core/beans/factory-scopes.adoc"
---
...
[a custom scope.](#beans-factory-scopes-custom)

The following table describes the supported scopes:

<a id="beans-factory-scopes-tbl"></a>

| Scope | Description |
| --- | --- |
| [singleton](#beans-factory-scopes-singleton) | (Default) Scopes a single bean definition to a single object instance for each Spring IoC container. |
...
| [websocket](../../web/websocket/stomp/scope.md) | Scopes a single bean definition to the lifecycle of a `WebSocket`. Only valid in the context of a web-aware Spring `ApplicationContext`. |

> [!NOTE]
> A thread scope is available but is not registered by default. For more information,
> see the documentation for
> [`SimpleThreadScope`](https://docs.spring.io/spring-framework/docs/6.1.19/javadoc-api/org/springframework/context/support/SimpleThreadScope.html).
...
![singleton](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.19/framework-docs/modules/ROOT/assets/images/singleton.png)
...
![prototype](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.19/framework-docs/modules/ROOT/assets/images/prototype.png)
...
custom [bean post-processor](factory-extension.md#beans-factory-extension-bpp)
...
container, see [Lifecycle Callbacks](factory-nature.md#beans-factory-lifecycle).)
...
runtime more than once, see [Method Injection](dependencies/factory-method-injection.md).
...
<a id="beans-factory-scopes-websocket"></a>
...
[WebSocket scope](../../web/websocket/stomp/scope.md) for more details.
...
> See [here](standard-annotations.md) for more details on JSR-330 overall.
...
[Choosing the Type of Proxy to Create](#beans-factory-scopes-other-injection-proxies)
and [XML Schema-based configuration](../appendix/xsd-schemas.md)).
...
see [Proxying Mechanisms](../aop/proxying.md).

<a id="beans-factory-scopes-injection"></a>
...
[`Scope`](https://docs.spring.io/spring-framework/docs/6.1.19/javadoc-api/org/springframework/beans/factory/config/Scope.html) javadoc,
...
See the [javadoc](https://docs.spring.io/spring-framework/docs/6.1.19/javadoc-api/org/springframework/beans/factory/config/Scope.html#registerDestructionCallback)
