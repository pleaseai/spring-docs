...
source: "ROOT:core/beans/java/instantiating-container.adoc"
---
...
<a id="beans-java-instantiating-container-constructor"></a>
...
> [!NOTE]
> Remember that `@Configuration` classes are [meta-annotated](../classpath-scanning.md#beans-meta-annotations)
