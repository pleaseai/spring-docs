...
> See the
> [`TransactionalEventPublisher`](https://docs.spring.io/spring-framework/docs/6.1.19/javadoc-api/org/springframework/transaction/reactive/TransactionalEventPublisher.html)
> javadoc for details.
