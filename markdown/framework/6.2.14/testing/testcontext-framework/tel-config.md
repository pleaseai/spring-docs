...
[testing/testcontext-framework/bean-overriding.adoc](bean-overriding.md).
...
[`@TestExecutionListeners`](https://docs.spring.io/spring-framework/docs/6.2.14/javadoc-api/org/springframework/test/context/TestExecutionListeners.html)
...
[automatic discovery mechanism](#testcontext-tel-config-automatic-discovery).
...
[Ordering `TestExecutionListener` Implementations](#testcontext-tel-config-ordering).
