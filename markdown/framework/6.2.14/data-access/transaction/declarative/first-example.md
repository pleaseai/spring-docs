---
title: "Example of Declarative Transaction Implementation"
source: "ROOT:data-access/transaction/declarative/first-example.adoc"
---

<a id="transaction-declarative-first-example"></a>
...
expression. See [the AOP section](../../../core/aop.md) for more details on pointcut
...
> in the `x.y.service` package. See [the AOP section](../../../core/aop.md) for more details.
