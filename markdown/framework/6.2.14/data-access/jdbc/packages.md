...
[Using the JDBC Core Classes to Control Basic JDBC Processing and Error Handling](core.md),
[JDBC Batch Operations](advanced.md), and
...
[Controlling Database Connections](connections.md) and
[Embedded Database Support](embedded-database-support.md).
...
[Using `SQLExceptionTranslator`](core.md#jdbc-SQLExceptionTranslator).
