---
title: "Java Bean Validation"
source: "ROOT:core/validation/beanvalidation.adoc"
---
...
<a id="validation-beanvalidation-spring-inject-adapter"></a>
...
groups to use. See
[`MethodValidationPostProcessor`](https://docs.spring.io/spring-framework/docs/6.2.14/javadoc-api/org/springframework/validation/beanvalidation/MethodValidationPostProcessor.html)
for setup details with the Hibernate Validator and Bean Validation providers.

> [!TIP]
> Method validation relies on [AOP Proxies](../aop/introduction-proxies.md) around the
...
> [Understanding AOP Proxies](../aop/proxying.md#aop-understanding-aop-proxies). In addition remember
...
[Validation](../../web/webmvc/mvc-controller/ann-validation.md) and
[Error Responses](../../web/webmvc/mvc-ann-rest-exceptions.md) sections, and the WebFlux
[Validation](../../web/webflux/controller/ann-validation.md) and
[Error Responses](../../web/webflux/ann-rest-exceptions.md) sections.

<a id="validation-beanvalidation-spring-method-exceptions"></a>
...
<a id="validation-beanvalidation-spring-method-i18n"></a>
...
[MessageSource](../beans/context-introduction.md#context-functionality-messagesource)
...
[`LocalValidatorFactoryBean`](https://docs.spring.io/spring-framework/docs/6.2.14/javadoc-api/org/springframework/validation/beanvalidation/LocalValidatorFactoryBean.html)
...
[Spring MVC Validation Configuration](../../web/webmvc/mvc-config/validation.md).

<a id="validation-mvc"></a>

## Spring MVC Validation

See [Validation](../../web/webmvc/mvc-config/validation.md) in the Spring MVC chapter.
