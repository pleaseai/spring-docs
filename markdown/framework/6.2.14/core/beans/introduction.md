...
source: "ROOT:core/beans/introduction.adoc"
---
...
[`BeanFactory`](https://docs.spring.io/spring-framework/docs/6.2.14/javadoc-api/org/springframework/beans/factory/BeanFactory.html)
...
[`BeanFactory` API](beanfactory.md).
