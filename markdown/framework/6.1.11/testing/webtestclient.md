...
[StandaloneMockMvcBuilder](https://docs.spring.io/spring-framework/docs/6.1.11/javadoc-api/org/springframework/test/web/servlet/setup/StandaloneMockMvcBuilder.html)
...
[WebHttpHandlerBuilder](https://docs.spring.io/spring-framework/docs/6.1.11/javadoc-api/org/springframework/web/server/adapter/WebHttpHandlerBuilder.html#applicationContext-org.springframework.context.ApplicationContext-)
...
[MockMvcBuilders.webAppContextSetup](https://docs.spring.io/spring-framework/docs/6.1.11/javadoc-api/org/springframework/test/web/servlet/setup/MockMvcBuilders.html#webAppContextSetup-org.springframework.web.context.WebApplicationContext-)
...
> that accept
> [`ParameterizedTypeReference`](https://docs.spring.io/spring-framework/docs/6.1.11/javadoc-api/org/springframework/core/ParameterizedTypeReference.html)
> instead of `Class<T>`.
