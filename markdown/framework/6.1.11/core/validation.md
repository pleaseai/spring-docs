...
source: "ROOT:core/validation.adoc"
---
...
as described in [Java Bean Validation](validation/beanvalidation.md), and use it exclusively for all validation
needs. In the web layer, applications can further register controller-local Spring
`Validator` instances per `DataBinder`, as described in [Configuring a `DataBinder`](validation/beanvalidation.md#validation-binder), which can
