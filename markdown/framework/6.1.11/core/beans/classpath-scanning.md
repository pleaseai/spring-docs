...
[`BeanNameGenerator`](https://docs.spring.io/spring-framework/docs/6.1.11/javadoc-api/org/springframework/beans/factory/support/BeanNameGenerator.html)
...
> [`ScopeMetadataResolver`](https://docs.spring.io/spring-framework/docs/6.1.11/javadoc-api/org/springframework/context/annotation/ScopeMetadataResolver.html)
...
The `@Qualifier` annotation is discussed in [Fine-tuning Annotation-based Autowiring with Qualifiers](annotation-config/autowired-qualifiers.md).
