---
title: "Fine-tuning Annotation-based Autowiring with Qualifiers"
source: "ROOT:core/beans/annotation-config/autowired-qualifiers.adoc"
---
...
1. The bean with the `action` qualifier value is wired with the constructor argument that
is qualified with the same value.
...
[Self Injection](autowired.md#beans-autowired-annotation-self-injection)
for details.
...
In [Classpath Scanning and Managed Components](../classpath-scanning.md), you can see an annotation-based alternative to
providing the qualifier metadata in XML. Specifically, see [Providing Qualifier Metadata with Annotations](../classpath-scanning.md#beans-scanning-qualifiers).
