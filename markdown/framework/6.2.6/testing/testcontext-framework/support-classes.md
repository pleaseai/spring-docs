...
source: "ROOT:testing/testcontext-framework/support-classes.adoc"
---

<a id="testcontext-support-classes"></a>

# TestContext Framework Support Classes

This section describes the various classes that support the Spring TestContext Framework.

<a id="testcontext-junit4-runner"></a>
...
[Spring’s support for JUnit rules](#testcontext-junit4-rules) instead.
...
<a id="testcontext-junit4-rules"></a>
...
<a id="testcontext-support-classes-junit4"></a>
...
an ORM tool, be sure to avoid [false positives](tx.md#testcontext-tx-false-positives).
As mentioned in [JDBC Testing Support](../support-jdbc.md),
...
> classes by using `@RunWith(SpringRunner.class)` or [Spring’s JUnit rules](#testcontext-junit4-rules)
> .

<a id="testcontext-junit-jupiter-extension"></a>
...
methods. See [Dependency Injection with the `SpringExtension`](#testcontext-junit-jupiter-di) for further details.
- Powerful support for [conditional
test execution](https://junit.org/junit5/docs/current/user-guide/#extensions-conditions) based on SpEL expressions, environment variables, system properties,
and so on. See the documentation for `@EnabledIf` and `@DisabledIf` in
[Spring JUnit Jupiter Testing Annotations](../annotations/integration-junit-jupiter.md) for further details and examples.
...
[Meta-Annotation Support for Testing](../annotations/integration-meta.md) for further details.
...
[Spring JUnit Jupiter Testing Annotations](../annotations/integration-junit-jupiter.md) for further details.

<a id="testcontext-junit-jupiter-di"></a>

### Dependency Injection with the `SpringExtension`

The `SpringExtension` implements the
[`ParameterResolver`](https://junit.org/junit5/docs/current/user-guide/#extensions-parameter-resolution)
...
<a id="testcontext-junit-jupiter-di-constructor"></a>
...
See [`@TestConstructor`](../annotations/integration-junit-jupiter.md#integration-testing-annotations-testconstructor) for details on the use of
`@TestConstructor` and how to change the global *test constructor autowire mode*.
...
[`@TestConstructor`](../annotations/integration-junit-jupiter.md#integration-testing-annotations-testconstructor)), we can omit the declaration of
...
<a id="testcontext-junit-jupiter-di-method"></a>
...
<a id="testcontext-junit-jupiter-nested-test-configuration"></a>
...
classpath. See the ["Changing the default enclosing configuration inheritance mode"](../annotations/integration-junit-jupiter.md#integration-testing-annotations-nestedtestconfiguration)
 note for details.
...
[Context Caching](ctx-management/caching.md) for details). Consult the list of
[supported annotations](../annotations/integration-junit-jupiter.md#integration-testing-annotations-nestedtestconfiguration) to see
...
<a id="testcontext-support-classes-testng"></a>
