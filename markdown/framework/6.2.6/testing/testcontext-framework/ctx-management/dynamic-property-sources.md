...
<a id="testcontext-ctx-management-dynamic-property-sources-precedence"></a>
...
<a id="testcontext-ctx-management-dynamic-property-sources-dynamic-property-registry"></a>
...
<a id="testcontext-ctx-management-dynamic-property-sources-dynamic-property-source"></a>

## `@DynamicPropertySource`

In contrast to the
[`@TestPropertySource`](property-sources.md)
...
> [`@DirtiesContext`](../../annotations/integration-spring/annotation-dirtiescontext.md)
...
<a id="testcontext-ctx-management-dynamic-property-sources-dynamic-property-registrar"></a>
