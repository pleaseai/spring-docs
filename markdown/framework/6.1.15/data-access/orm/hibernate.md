---
title: "Hibernate"
source: "ROOT:data-access/orm/hibernate.adoc"
---

<a id="orm-hibernate"></a>

# Hibernate

We start with a coverage of [Hibernate 5](https://hibernate.org/) in a Spring environment,
...
<a id="orm-session-factory-setup"></a>
...
definition in the [next section](#orm-hibernate-straight).
...
> See [Native Hibernate Setup for JPA](jpa.md#orm-jpa-hibernate) for details.

<a id="orm-hibernate-straight"></a>
...
<a id="orm-hibernate-tx-declarative"></a>
...
> [!NOTE]
> Before you continue, we are strongly encourage you to read [Declarative Transaction Management](../transaction/declarative.md)
...
<a id="orm-hibernate-tx-programmatic"></a>
...
<a id="orm-hibernate-tx-strategies"></a>
...
<a id="orm-hibernate-resources"></a>
...
<a id="orm-hibernate-invalid-jdbc-access-error"></a>
...
`LocalSessionFactoryBean` bean (see [Hibernate Transaction Setup](../transaction/strategies.md#transaction-strategies-hibernate)).
