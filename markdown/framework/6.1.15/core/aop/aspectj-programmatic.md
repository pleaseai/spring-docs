...
source: "ROOT:core/aop/aspectj-programmatic.adoc"
---
...
[next chapter](../aop-api.md). Here, we want to focus on the ability to automatically
...
See the [javadoc](https://docs.spring.io/spring-framework/docs/6.1.15/javadoc-api/org/springframework/aop/aspectj/annotation/AspectJProxyFactory.html) for more information.
