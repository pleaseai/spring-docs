...
source: "ROOT:core/validation/convert.adoc"
---
...
[Conversion and Formatting](../../web/webmvc/mvc-config/conversion.md) in the Spring MVC chapter.

In certain situations, you may wish to apply formatting during conversion. See
[The `FormatterRegistry` SPI](format.md#format-FormatterRegistry-SPI) for details on using `FormattingConversionServiceFactoryBean`.
