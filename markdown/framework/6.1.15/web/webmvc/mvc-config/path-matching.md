...
[`PathMatchConfigurer`](https://docs.spring.io/spring-framework/docs/6.1.15/javadoc-api/org/springframework/web/servlet/config/annotation/PathMatchConfigurer.html) javadoc.
