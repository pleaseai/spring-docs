...
source: "ROOT:integration/jms/annotated.adoc"
---
...
what the [`MessageListenerAdapter`](receiving.md#jms-receiving-async-message-listener-adapter)
provides).
...
[`JmsListenerConfigurer`](https://docs.spring.io/spring-framework/docs/6.1.15/javadoc-api/org/springframework/jms/annotation/JmsListenerConfigurer.html)
for details and examples.

If you prefer [XML configuration](namespace.md), you can use the `<jms:annotation-driven>`
...
The existing support in [`MessageListenerAdapter`](receiving.md#jms-receiving-async-message-listener-adapter)
