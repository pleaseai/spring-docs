...
source: "ROOT:testing/testcontext-framework/key-abstractions.adoc"
---

<a id="testcontext-key-abstractions"></a>
...
class. See the [javadoc](https://docs.spring.io/spring-framework/docs/6.1.14/javadoc-api/org/springframework/test/context/package-summary.html) and the
...
<a id="testexecutionlistener"></a>

## `TestExecutionListener`

`TestExecutionListener` defines the API for reacting to test-execution events published by
the `TestContextManager` with which the listener is registered. See [`TestExecutionListener` Configuration](tel-config.md).

<a id="context-loaders"></a>
