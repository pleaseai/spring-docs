...
source: "ROOT:data-access/transaction/declarative/tx-propagation.adoc"
---
...
<a id="tx-propagation-required"></a>

## Understanding `PROPAGATION_REQUIRED`

![tx prop required](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.14/framework-docs/modules/ROOT/assets/images/tx_prop_required.png)
...
<a id="tx-propagation-requires_new"></a>

## Understanding `PROPAGATION_REQUIRES_NEW`

![tx prop requires new](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.14/framework-docs/modules/ROOT/assets/images/tx_prop_requires_new.png)
...
transactions. See Spring’s [`DataSourceTransactionManager`](https://docs.spring.io/spring-framework/docs/6.1.14/javadoc-api/org/springframework/jdbc/datasource/DataSourceTransactionManager.html).
