...
source: "ROOT:core/aop/proxying.adoc"
---
...
<a id="aop-forcing-proxy-types"></a>
...
![aop proxy plain pojo call](https://raw.githubusercontent.com/spring-projects/spring-framework/v7.0.2/framework-docs/modules/ROOT/assets/images/aop-proxy-plain-pojo-call.png)
...
![aop proxy call](https://raw.githubusercontent.com/spring-projects/spring-framework/v7.0.2/framework-docs/modules/ROOT/assets/images/aop-proxy-call.png)
...
[self injection](../beans/annotation-config/autowired.md#beans-autowired-annotation-self-injection),
