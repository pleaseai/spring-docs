...
The [`Nullness` Spring API](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/core/Nullness.html) can be used at runtime to detect the
...
[@Contract](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/lang/Contract.html) annotation in the `org.springframework.lang` package which
...
[`Assert.notNull()`](<https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/util/Assert.html#notNull(java.lang.Object,java.lang.String)>)
...
[`InitializingBean`](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/beans/factory/InitializingBean.html).
...
Spring null-safety annotations [`@Nullable`](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/lang/Nullable.html),
[`@NonNull`](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/lang/NonNull.html),
[`@NonNullApi`](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/lang/NonNullApi.html), and
[`@NonNullFields`](https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/lang/NonNullFields.html) in the `org.springframework.lang` package were
