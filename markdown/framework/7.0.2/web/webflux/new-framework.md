...
of RxJava or another reactive library. See [Reactive Libraries](../webflux-reactive-libraries.md) for more details.
...
including HTTP abstractions, Reactive Streams [adapters](reactive-spring.md#webflux-httphandler)
for supported servers, [codecs](reactive-spring.md#webflux-codecs), and a core
[`WebHandler` API](reactive-spring.md#webflux-web-handler-api) comparable to
the Servlet API but with non-blocking contracts.

On that foundation, Spring WebFlux provides a choice of two programming models:

- [Annotated Controllers](controller.md): Consistent with Spring MVC and based on the
...
- [Functional Endpoints](../webflux-functional.md): Lambda-based, lightweight,
...
![spring mvc and webflux venn](https://raw.githubusercontent.com/spring-projects/spring-framework/v7.0.2/framework-docs/modules/ROOT/assets/images/spring-mvc-and-webflux-venn.png)
...
You can return reactive types (Reactor, RxJava, [or other](../webflux-reactive-libraries.md))
