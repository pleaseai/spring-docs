...
For more on that, see [Reactive Libraries](webflux-reactive-libraries.md).
...
> [`RouterFunctions#resource(java.util.function.Function)`](<https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/web/reactive/function/server/RouterFunctions.html#resources(java.util.function.Function)>).
