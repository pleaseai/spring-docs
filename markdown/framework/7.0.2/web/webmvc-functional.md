...
source: "ROOT:web/webmvc-functional.adoc"
---
...
[See equivalent in the Reactive stack](webflux-functional.md)
...
the same [DispatcherServlet](webmvc/mvc-servlet.md).

<a id="webmvc-fn-overview"></a>

## Overview

[See equivalent in the Reactive stack](webflux-functional.md#webflux-fn-overview)
...
[Running a Server](#webmvc-fn-running).

<a id="webmvc-fn-handler-functions"></a>

## HandlerFunction

[See equivalent in the Reactive stack](webflux-functional.md#webflux-fn-handler-functions)

`ServerRequest` and `ServerResponse` are immutable interfaces that offer JDK 8-friendly
access to the HTTP request and response, including headers, body, method, and status code.

<a id="webmvc-fn-request"></a>
...
<a id="webmvc-fn-handler-classes"></a>
...
<a id="webmvc-fn-handler-validation"></a>
...
<a id="webmvc-fn-router-functions"></a>

## `RouterFunction`

[See equivalent in the Reactive stack](webflux-functional.md#webflux-fn-router-functions)
...
[MVC Config](webmvc/mvc-config/api-version.md), and then you can use the
`version` [predicate](#webmvc-fn-predicates) as follows:
...
<a id="webmvc-fn-serving-resources"></a>
...
> [`RouterFunctions#resource(java.util.function.Function)`](<https://docs.spring.io/spring-framework/docs/7.0.2/javadoc-api/org/springframework/web/servlet/function/RouterFunctions.html#resources(java.util.function.Function)>).

<a id="webmvc-fn-resource"></a>
...
<a id="webmvc-fn-running"></a>

## Running a Server

[See equivalent in the Reactive stack](webflux-functional.md#webflux-fn-running)

You typically run router functions in a [`DispatcherHandler`](webmvc/mvc-servlet.md)-based setup through the
[MVC Config](webmvc/mvc-config.md), which uses Spring configuration to declare the
...
<a id="webmvc-fn-handler-filter-function"></a>

## Filtering Handler Functions

[See equivalent in the Reactive stack](webflux-functional.md#webflux-fn-handler-filter-function)
...
> [`CorsFilter`](webmvc-cors.md#mvc-cors-filter).
