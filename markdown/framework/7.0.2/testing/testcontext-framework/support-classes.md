...
test execution](https://docs.junit.org/current/user-guide/#extensions-conditions) based on SpEL expressions, environment variables, system properties,
...
[`ParameterResolver`](https://docs.junit.org/current/user-guide/#extensions-parameter-resolution)
