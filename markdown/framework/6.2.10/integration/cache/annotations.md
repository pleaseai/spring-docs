...
| `key-generator` | N/A (see the [`CachingConfigurer`](https://docs.spring.io/spring-framework/docs/6.2.10/javadoc-api/org/springframework/cache/annotation/CachingConfigurer.html) javadoc) | `SimpleKeyGenerator` | Name of the custom key generator to use. |
...
of the [stereotype](../../core/beans/classpath-scanning.md#beans-stereotype-annotations)
annotations, you can use `@Cacheable`, `@CachePut`, `@CacheEvict`, and `@CacheConfig`
as [meta-annotations](../../core/beans/classpath-scanning.md#beans-meta-annotations)
...
[earlier](#cache-annotation-enable),
