...
Refer to the [`HttpMessageConverter` Javadoc](https://docs.spring.io/spring-framework/docs/6.2.10/javadoc-api/org/springframework/http/converter/HttpMessageConverter.html) for the complete list.
