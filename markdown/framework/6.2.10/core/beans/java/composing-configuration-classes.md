...
> [`AutowiredAnnotationBeanPostProcessor`](https://docs.spring.io/spring-framework/docs/6.2.10/javadoc-api/org/springframework/beans/factory/annotation/AutowiredAnnotationBeanPostProcessor.html).
...
called [`@Conditional`](https://docs.spring.io/spring-framework/docs/6.2.10/javadoc-api/org/springframework/context/annotation/Conditional.html).
...
See the [`@Conditional`](https://docs.spring.io/spring-framework/docs/6.2.10/javadoc-api/org/springframework/context/annotation/Conditional.html)
