---
title: "Understanding the Spring Framework’s Declarative Transaction Implementation"
source: "ROOT:data-access/transaction/declarative/tx-decl-explained.adoc"
---

<a id="tx-decl-explained"></a>
...
[via AOP proxies](../../../core/aop/proxying.md#aop-understanding-aop-proxies) and that the transactional
...
> [!NOTE]
> Spring AOP is covered in [the AOP section](../../../core/aop.md).
...
![tx](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.2.17/framework-docs/modules/ROOT/assets/images/tx.png)
