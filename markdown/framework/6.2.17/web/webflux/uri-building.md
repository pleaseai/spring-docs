---
title: "URI Links"
source: "ROOT:web/webflux/uri-building.adoc"
---

<a id="webflux-uri-building"></a>

# URI Links

[See equivalent in the Servlet stack](../webmvc/mvc-uri-building.md)
...
[`UriComponentsBuilder`](#uricomponents) implements `UriBuilder`. You can create a
...
- [UriComponentsBuilder#encode()](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/web/util/UriComponentsBuilder.html#encode--):
Pre-encodes the URI template first and then strictly encodes URI variables when expanded.
- [UriComponents#encode()](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/web/util/UriComponents.html#encode--):
