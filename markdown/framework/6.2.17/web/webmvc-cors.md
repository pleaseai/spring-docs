---
title: "CORS"
source: "ROOT:web/webmvc-cors.adoc"
---
...
[See equivalent in the Reactive stack](webflux-cors.md)
...
[See equivalent in the Reactive stack](webflux-cors.md#webflux-cors-intro)
...
<a id="mvc-cors-credentialed-requests"></a>

## Credentialed Requests

[See equivalent in the Reactive stack](webflux-cors.md#webflux-cors-credentialed-requests)
...
[See equivalent in the Reactive stack](webflux-cors.md#webflux-cors-processing)
...
[configured](<https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/web/servlet/handler/AbstractHandlerMapping.html#setCorsConfigurations(java.util.Map)>)
...
[See equivalent in the Reactive stack](webflux-cors.md#webflux-cors-controller)
...
[See equivalent in the Reactive stack](webflux-cors.md#webflux-cors-global)
...
[See equivalent in the Reactive stack](webflux-cors.md#webflux-cors-webfilter)

You can apply CORS support through the built-in
[`CorsFilter`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/web/filter/CorsFilter.html).
