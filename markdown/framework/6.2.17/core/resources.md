---
title: "Resources"
source: "ROOT:core/resources.adoc"
---
...
[`Resource`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/core/io/Resource.html) javadoc for further details.
...
[`WritableResource`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/core/io/WritableResource.html) interface
...
[`Resource`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/core/io/Resource.html) javadoc.
...
<a id="resources-implementations-pathresource"></a>
...
<a id="resources-resourceloader"></a>
...
<a id="resources-resource-strings"></a>
...
<a id="resources-resourcepatternresolver"></a>
...
[Wildcards in Application Context Constructor Resource Paths](#resources-app-ctx-wildcards-in-resource-paths) and its subsections for further details
on wildcard support with the `classpath*:` resource prefix.

A passed-in `ResourceLoader` (for example, one supplied via
[`ResourceLoaderAware`](#resources-resourceloaderaware) semantics) can be checked whether
...
`constructor` and `byType` autowiring modes (as described in [Autowiring Collaborators](beans/dependencies/factory-autowire.md))
...
For more information, see [Using `@Autowired`](beans/annotation-config/autowired.md).
...
> [`ResourcePatternResolver`](#resources-resourcepatternresolver) autowired into your
...
[Environment Abstraction](beans/environment.md)). The template path can then be referenced via the `@Value`
annotation using a property placeholder (see [Using `@Value`](beans/annotation-config/value-annotations.md)). Spring will
...
See the [`ClassPathXmlApplicationContext`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/context/support/ClassPathXmlApplicationContext.html)
