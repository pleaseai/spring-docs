...
[`CustomAutowireConfigurer`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/beans/factory/annotation/CustomAutowireConfigurer.html)
...
[Fine-tuning with `@Primary` or `@Fallback`](autowired-primary.md).
