...
source: "ROOT:core/validation/format.adoc"
---
...
As discussed in the previous section, [`core.convert`](convert.md) is a
...
in different styles defined in the `@DurationFormat.Style` enum (see [Format Annotation API](#format-annotations-api)).
...
1. Have `getFieldTypes()` return the types of fields on which the annotation can be used.
1. Have `getPrinter()` return a `Printer` to print the value of an annotated field.
1. Have `getParser()` return a `Parser` to parse a `clientValue` for an annotated field.
...
[`@DateTimeFormat`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/format/annotation/DateTimeFormat.html),
[`@DurationFormat`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/format/annotation/DurationFormat.html), and
[`@NumberFormat`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/format/annotation/NumberFormat.html).
...
See [Conversion and Formatting](../../web/webmvc/mvc-config/conversion.md) in the Spring MVC chapter.
