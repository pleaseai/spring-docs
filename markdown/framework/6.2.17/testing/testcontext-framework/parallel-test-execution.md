...
source: "ROOT:testing/testcontext-framework/parallel-test-execution.adoc"
---

<a id="testcontext-parallel-test-execution"></a>
...
> of the cache. See the discussion on [context caching](ctx-management/caching.md)
> for details.
...
> the javadoc for [`TestContext`](https://docs.spring.io/spring-framework/docs/6.2.17/javadoc-api/org/springframework/test/context/TestContext.html). The
