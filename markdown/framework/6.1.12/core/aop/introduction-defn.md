---
title: "AOP Concepts"
source: "ROOT:core/aop/introduction-defn.adoc"
---
...
(the [schema-based approach](schema.md)) or regular classes annotated with the
`@Aspect` annotation (the [@AspectJ style](ataspectj.md)).
