...
[`Resource`](https://docs.spring.io/spring-framework/docs/6.1.12/javadoc-api/org/springframework/core/io/Resource.html) javadoc for further details.
...
[`WritableResource`](https://docs.spring.io/spring-framework/docs/6.1.12/javadoc-api/org/springframework/core/io/WritableResource.html) interface
...
[`Resource`](https://docs.spring.io/spring-framework/docs/6.1.12/javadoc-api/org/springframework/core/io/Resource.html) javadoc.
...
See the [`ClassPathXmlApplicationContext`](https://docs.spring.io/spring-framework/docs/6.1.12/javadoc-api/org/springframework/context/support/ClassPathXmlApplicationContext.html)
