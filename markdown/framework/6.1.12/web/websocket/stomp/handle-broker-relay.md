...
source: "ROOT:web/websocket/stomp/handle-broker-relay.adoc"
---

<a id="websocket-stomp-handle-broker-relay"></a>
...
[ActiveMQ](https://activemq.apache.org/stomp.html), and others), install the broker,
...
in [Sending Messages](handle-send.md), to broadcast messages to subscribed WebSocket clients.
