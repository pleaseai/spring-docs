...
> [Spring Testing Annotations](../../annotations/integration-spring/annotation-dirtiescontext.md) and the
> [`@DirtiesContext`](https://docs.spring.io/spring-framework/docs/6.1.12/javadoc-api/org/springframework/test/annotation/DirtiesContext.html) javadoc.
