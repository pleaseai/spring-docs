...
source: "ROOT:core/beans/annotation-config/autowired.adoc"
---
...
> examples included in this section. See [here](../standard-annotations.md) for more details.
...
> [constructor resolution](#beans-autowired-annotation-constructor-resolution) for details.
...
#### <a id="beans-autowired-annotation-self-injection"></a>Self Injection
...
<a id="beans-autowired-annotation-constructor-resolution"></a>
...
You can also use a parameter-level `@Nullable` annotation (of any kind in any package — for example, `javax.annotation.Nullable` from JSR-305) or just leverage Kotlin built-in
null-safety support:
