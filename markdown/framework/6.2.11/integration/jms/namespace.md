---
title: "JMS Namespace Support"
source: "ROOT:integration/jms/namespace.adoc"
---
...
and `<jca-listener-container/>`. `<annotation-driven/>` enables the use of [annotation-driven listener endpoints](annotated.md)
...
in [Using `MessageListenerAdapter`](receiving.md#jms-receiving-async-message-listener-adapter). In addition to the attributes shown
...
<a id="jms-namespace-listener-tbl"></a>
...
of the [`AbstractMessageListenerContainer`](https://docs.spring.io/spring-framework/docs/6.2.11/javadoc-api/org/springframework/jms/listener/AbstractMessageListenerContainer.html)
...
<a id="jms-namespace-listener-container-tbl"></a>
