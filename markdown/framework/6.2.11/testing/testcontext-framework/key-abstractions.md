...
class. See the [javadoc](https://docs.spring.io/spring-framework/docs/6.2.11/javadoc-api/org/springframework/test/context/package-summary.html) and the
...
[`TestExecutionListener` Configuration](tel-config.md).
