---
title: "Redirect Attributes"
source: "ROOT:web/webmvc/mvc-controller/ann-methods/redirecting-passing-data.adoc"
---
...
not appear in the URL). See [Flash Attributes](flash-attributes.md) for more information.
