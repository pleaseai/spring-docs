...
source: "ROOT:web/integration.adoc"
---
...
*choice*. In a general sense, Spring does not force you to use or buy into any
...
([Spring MVC](webmvc.md#mvc) and [Spring WebFlux](webflux.md#webflux)) while, at the same time,
supporting integration with a number of popular third-party web frameworks.

<a id="web-integration-common"></a>
...
[`ContextLoaderListener`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/web/context/ContextLoaderListener.html)
...
[`WebApplicationContext`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/web/context/WebApplicationContext.html)
...
The
[`WebApplicationContextUtils`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/web/context/support/WebApplicationContextUtils.html)
...
<a id="jsf-springbeanfaceselresolver"></a>
...
The [`FacesContextUtils`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/web/jsf/FacesContextUtils.html)
...
Invented by Craig McClanahan, [Struts](https://struts.apache.org) is an open-source project
...
[Spring Plugin](https://struts.apache.org/plugins/spring/) for built-in Spring integration.

<a id="tapestry"></a>

## Apache Tapestry

[Tapestry](https://tapestry.apache.org/) is a "Component oriented framework for creating
dynamic, robust, highly scalable web applications in Java."

While Spring has its own [powerful web layer](webmvc.md#mvc), there are a number of unique
...
[integration module for Spring](https://tapestry.apache.org/integrating-with-spring-framework.html).

<a id="web-integration-resources"></a>
...
- The [JSF](https://www.oracle.com/java/technologies/javaserverfaces.html) homepage
