...
source: "ROOT:web/webmvc/mvc-servlet/viewresolver.adoc"
---
...
[See equivalent in the Reactive stack](../../webflux/dispatcher-handler.md#webflux-viewresolution)
...
| `ContentNegotiatingViewResolver` | Implementation of the `ViewResolver` interface that resolves a view based on the request file name or `Accept` header. See [Content Negotiation](#mvc-multiple-representations). |
...
[See equivalent in the Reactive stack](../../webflux/dispatcher-handler.md#webflux-viewresolution-handling)
...
configuration. The [MVC Config](../mvc-config.md) provides a dedicated configuration API for
[View Resolvers](../mvc-config/view-resolvers.md) and for adding logic-less
[View Controllers](../mvc-config/view-controller.md) which are useful for HTML template
...
[See equivalent in the Reactive stack](../../webflux/dispatcher-handler.md#webflux-redirecting-redirect-prefix)
...
[See equivalent in the Reactive stack](../../webflux/dispatcher-handler.md#webflux-multiple-representations)

[`ContentNegotiatingViewResolver`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/web/servlet/view/ContentNegotiatingViewResolver.html)
...
See [View Resolvers](../mvc-config/view-resolvers.md) under [MVC Config](../mvc-config.md) for configuration details.
