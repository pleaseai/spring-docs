---
title: "Simplifying JDBC Operations with the `SimpleJdbc` Classes"
source: "ROOT:data-access/jdbc/simple.adoc"
---

<a id="jdbc-simple-jdbc"></a>
...
<a id="jdbc-simple-jdbc-insert-1"></a>
...
<a id="jdbc-simple-jdbc-insert-2"></a>
...
<a id="jdbc-simple-jdbc-insert-3"></a>
...
<a id="jdbc-simple-jdbc-parameters"></a>
...
<a id="jdbc-simple-jdbc-call-1"></a>
...
<a id="jdbc-simple-jdbc-call-2"></a>
...
as input. See the [next section](#jdbc-params) for details on how to define an `SqlParameter`.
...
classes (covered in [Modeling JDBC Operations as Java Objects](object.md)) you can use `SqlParameter` or one of its subclasses.
...
subclasses (covered in [Understanding `SqlQuery`](object.md#jdbc-SqlQuery)).
...
<a id="jdbc-simple-jdbc-call-3"></a>
...
<a id="jdbc-simple-jdbc-call-4"></a>
