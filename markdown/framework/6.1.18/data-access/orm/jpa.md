---
title: "JPA"
source: "ROOT:data-access/orm/jpa.adoc"
---
...
See the [Spring configuration](../../core/aop/using-aspectj.md#aop-aj-ltw-spring) in the AOP chapter for
...
As described in [Spring configuration](../../core/aop/using-aspectj.md#aop-aj-ltw-spring), you can configure
...
<a id="orm-jpa-setup-background"></a>
...
> [!NOTE]
> We strongly encourage you to read [Declarative Transaction Management](../transaction/declarative.md),
...
[next section](#orm-jpa-dialect) for details on `JpaDialect`.
...
[`LazyConnectionDataSourceProxy`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/jdbc/datasource/LazyConnectionDataSourceProxy.html).
...
See the [`JpaDialect`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/orm/jpa/JpaDialect.html) and
[`JpaVendorAdapter`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/orm/jpa/JpaVendorAdapter.html) javadoc for
...
See [Spurious Application Server Warnings with Hibernate](hibernate.md#orm-hibernate-invalid-jdbc-access-error) for related notes.
