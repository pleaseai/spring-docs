...
[`SchedulingConfigurer`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/scheduling/annotation/SchedulingConfigurer.html)
and [`AsyncConfigurer`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/scheduling/annotation/AsyncConfigurer.html)
...
the [`SchedulerFactoryBean`](https://docs.spring.io/spring-framework/docs/6.1.18/javadoc-api/org/springframework/scheduling/quartz/SchedulerFactoryBean.html)
