...
[`LazyConnectionDataSourceProxy`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/jdbc/datasource/LazyConnectionDataSourceProxy.html).
...
See the [`JpaDialect`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/orm/jpa/JpaDialect.html) and
[`JpaVendorAdapter`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/orm/jpa/JpaVendorAdapter.html) javadoc for
