...
source: "ROOT:data-access/jdbc/packages.adoc"
---

<a id="jdbc-packages"></a>
...
class and the related support classes. See [Using the JDBC Core Classes to Control Basic JDBC Processing and Error Handling](core.md), [JDBC Batch Operations](advanced.md), and
[Simplifying JDBC Operations with the `SimpleJdbc` Classes](simple.md).
...
[Controlling Database Connections](connections.md) and [Embedded Database Support](embedded-database-support.md).
...
[Modeling JDBC Operations as Java Objects](object.md). This style
...
exceptions be propagated to the caller. See [Using `SQLExceptionTranslator`](core.md#jdbc-SQLExceptionTranslator).
