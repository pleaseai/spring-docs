...
source: "ROOT:data-access/jdbc/initializing-datasource.adoc"
---

<a id="jdbc-initializing-datasource"></a>
...
<a id="jdbc-initializing-datasource-xml"></a>
...
1. Set the separator for `db-schema.sql` to `;`.
...
<a id="jdbc-client-component-initialization"></a>
