---
title: "`@RequestParam`"
source: "ROOT:web/webflux/controller/ann-methods/requestparam.adoc"
---

<a id="webflux-ann-requestparam"></a>

# `@RequestParam`

[See equivalent in the Servlet stack](../../../webmvc/mvc-controller/ann-methods/requestparam.md)
...
> [command object](modelattrib-method-args.md).
