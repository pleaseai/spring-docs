...
source: "ROOT:testing/testcontext-framework/executing-sql.adoc"
---

<a id="testcontext-executing-sql"></a>
...
[Embedded database support](../../data-access/jdbc/embedded-database-support.md) and
[Testing data access logic with an embedded database](../../data-access/jdbc/embedded-database-support.md#jdbc-embedded-database-dao-testing)
 for details.
...
<a id="testcontext-executing-sql-programmatically"></a>
...
[javadoc](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/jdbc/datasource/init/ScriptUtils.html) for individual
...
[javadoc](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/jdbc/datasource/init/ResourceDatabasePopulator.html) for
...
[`AbstractTransactionalJUnit4SpringContextTests`](support-classes.md#testcontext-support-classes-junit4)
and [`AbstractTransactionalTestNGSpringContextTests`](support-classes.md#testcontext-support-classes-testng)
...
<a id="testcontext-executing-sql-declaratively"></a>
...
> [Merging and Overriding Configuration with `@SqlMergeMode`](#testcontext-executing-sql-declaratively-script-merging)
> for further details.
>
...
<a id="testcontext-executing-sql-declaratively-script-resources"></a>
...
<a id="testcontext-executing-sql-declaratively-script-detection"></a>
...
<a id="testcontext-executing-sql-declaratively-logging"></a>
...
<a id="testcontext-executing-sql-declaratively-multiple-annotations"></a>
...
<a id="testcontext-executing-sql-declaratively-script-execution-phases"></a>
...
<a id="testcontext-executing-sql-declaratively-script-configuration"></a>
...
individual attributes in [`@Sql`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/test/context/jdbc/Sql.html) and
[`@SqlConfig`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/test/context/jdbc/SqlConfig.html) for details.

<a id="testcontext-executing-sql-declaratively-tx"></a>
...
[`@SqlConfig`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/test/context/jdbc/SqlConfig.html) and
[`SqlScriptsTestExecutionListener`](https://docs.spring.io/spring-framework/docs/6.1.17/javadoc-api/org/springframework/test/context/jdbc/SqlScriptsTestExecutionListener.html)
...
`TransactionalTestExecutionListener` (see [transaction management](tx.md) for
details).

<a id="testcontext-executing-sql-declaratively-script-merging"></a>
...
via `@SqlMergeMode(OVERRIDE)`. Consult the [`@SqlMergeMode` annotation documentation section](../annotations/integration-spring/annotation-sqlmergemode.md)
