---
title: "Why HtmlUnit Integration?"
source: "ROOT:testing/spring-mvc-test-framework/server-htmlunit/why.adoc"
---

<a id="spring-mvc-test-server-htmlunit-why"></a>
...
<a id="spring-mvc-test-server-htmlunit-mock-mvc-test"></a>
...
<a id="spring-mvc-test-server-htmlunit-why-integration"></a>
...
<a id="spring-mvc-test-server-htmlunit-why-mockmvc"></a>
...
<a id="spring-mvc-test-server-htmlunit-options"></a>

## HtmlUnit Integration Options

You have a number of options when you want to integrate MockMvc with HtmlUnit:

- [MockMvc and HtmlUnit](mah.md): Use this option if you
want to use the raw HtmlUnit libraries.
- [MockMvc and WebDriver](webdriver.md): Use this option to
ease development and reuse code between integration and end-to-end testing.
- [MockMvc and Geb](geb.md): Use this option if you want to
