---
title: "Appendix"
source: "ROOT:data-access/appendix.adoc"
---
...
- [The `tx` Schema](#xsd-schemas-tx)
- [The `jdbc` Schema](#xsd-schemas-jdbc)

<a id="xsd-schemas-tx"></a>
...
1. Specify the location (with other schema locations).
...
[Embedded Database Support](jdbc/embedded-database-support.md) and
[Initializing a DataSource](jdbc/initializing-datasource.md), respectively.
