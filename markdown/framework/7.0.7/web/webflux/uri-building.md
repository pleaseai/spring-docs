...
- [UriComponentsBuilder#encode()](<https://docs.spring.io/spring-framework/docs/7.0.7/javadoc-api/org/springframework/web/util/UriComponentsBuilder.html#encode()>):
Pre-encodes the URI template first and then strictly encodes URI variables when expanded.
- [UriComponents#encode()](<https://docs.spring.io/spring-framework/docs/7.0.7/javadoc-api/org/springframework/web/util/UriComponents.html#encode()>):
