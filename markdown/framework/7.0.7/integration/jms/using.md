---
title: "Using Spring JMS"
source: "ROOT:integration/jms/using.adoc"
---
...
<a id="jms-jmstemplate-jmsclient"></a>
...
[`JmsClient`](https://docs.spring.io/spring-framework/docs/7.0.7/javadoc-api/org/springframework/jms/core/JmsClient.html) for usage examples.
...
[Asynchronous Receipt: Message-Driven POJOs](receiving.md#jms-receiving-async)
for detailed coverage of Spring’s MDP support.) Endpoint methods can be annotated with
`@JmsListener` — see [Annotation-driven Listener Endpoints](annotated.md)
for more details.
...
[`ExponentialBackOff`](https://docs.spring.io/spring-framework/docs/7.0.7/javadoc-api/org/springframework/util/backoff/ExponentialBackOff.html) for an example.

> [!NOTE]
> Like its sibling ([`SimpleMessageListenerContainer`](#jms-mdp-simple)),
...
[Transaction Management section of the Data Access chapter](../../data-access/transaction.md).
