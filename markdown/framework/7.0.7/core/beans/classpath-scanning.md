...
source: "ROOT:core/beans/classpath-scanning.adoc"
---
...
([Annotation-based Container Configuration](annotation-config.md))
...
[Exception Translation](../../data-access/orm/general.md#orm-exception-translation).
...
For example, the `@Service` annotation mentioned [earlier](#beans-stereotype-annotations)
...
<a id="beans-scanning-placeholders-and-patterns"></a>
...
<a id="beans-scanning-filters-tbl"></a>
...
[stereotype annotations](#beans-stereotype-annotations),
...
[`BeanNameGenerator`](https://docs.spring.io/spring-framework/docs/7.0.7/javadoc-api/org/springframework/beans/factory/support/BeanNameGenerator.html) or
...
see [Request, Session, Application, and WebSocket Scopes](factory-scopes.md#beans-factory-scopes-other).
...
> [`ScopeMetadataResolver`](https://docs.spring.io/spring-framework/docs/7.0.7/javadoc-api/org/springframework/context/annotation/ScopeMetadataResolver.html)
...
[Scoped Beans as Dependencies](factory-scopes.md#beans-factory-scopes-other-injection).
...
[Fine-tuning Annotation-based Autowiring with Qualifiers](annotation-config/autowired-qualifiers.md).
...
<a id="beans-factorybeans-annotations-lazy-injection-points"></a>
