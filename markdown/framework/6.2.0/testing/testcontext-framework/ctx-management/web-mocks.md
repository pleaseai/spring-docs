...
source: "ROOT:testing/testcontext-framework/ctx-management/web-mocks.adoc"
---

<a id="testcontext-ctx-management-web-mocks"></a>
...
`WebApplicationContext`, this [`TestExecutionListener`](../key-abstractions.md)
