...
> type, as explained in the javadoc for [`Conventions`](https://docs.spring.io/spring-framework/docs/6.2.0/javadoc-api/org/springframework/core/Conventions.html).
