...
`AbstractPoolingTargetSource`](https://docs.spring.io/spring-framework/docs/6.2.0/javadoc-api/org/springframework/aop/target/AbstractPoolingTargetSource.html) and the concrete subclass you wish to use for information
