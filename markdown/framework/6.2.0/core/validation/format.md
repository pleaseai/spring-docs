...
[`@DateTimeFormat`](https://docs.spring.io/spring-framework/docs/6.2.0/javadoc-api/org/springframework/format/annotation/DateTimeFormat.html),
[`@DurationFormat`](https://docs.spring.io/spring-framework/docs/6.2.0/javadoc-api/org/springframework/format/annotation/DurationFormat.html), and
[`@NumberFormat`](https://docs.spring.io/spring-framework/docs/6.2.0/javadoc-api/org/springframework/format/annotation/NumberFormat.html).
