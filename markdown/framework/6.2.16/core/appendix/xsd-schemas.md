---
title: "XML Schemas"
source: "ROOT:core/appendix/xsd-schemas.adoc"
---
...
[`FieldRetrievingFactoryBean`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/beans/factory/config/FieldRetrievingFactoryBean.html)
...
[`staticField`](<https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/beans/factory/config/FieldRetrievingFactoryBean.html#setStaticField(java.lang.String)>)
property:
...
loaded from the supplied [`Resource`](../../web/webflux-webclient/client-builder.md#webflux-client-builder-reactor-resources) location).
...
These tags are comprehensively covered in the chapter entitled [Aspect Oriented Programming with Spring](../aop.md)
.
...
specified properties file (as a [Spring resource location](../../web/webflux-webclient/client-builder.md#webflux-client-builder-reactor-resources)). This element
is a convenience mechanism that sets up a [`PropertySourcesPlaceholderConfigurer`](../beans/factory-extension.md#beans-factory-placeholderconfigurer)
...
- Spring’s [`@Configuration`](../beans/basics.md#beans-factory-metadata) model
- [`@Autowired`/`@Inject`](../beans/annotation-config.md), `@Value`, and `@Lookup`
...
- Spring’s [`@EventListener`](../beans/context-introduction.md#context-functionality-events-annotation)
...
> [`@Transactional`](../../data-access/transaction/declarative/annotations.md) annotation;
> you can use the [`<tx:annotation-driven/>`](../../data-access.md#tx-decl-explained)
> element for that purpose. Similarly, Spring’s
> [caching annotations](../../integration/cache/annotations.md) need to be explicitly
> [enabled](../../integration/cache/annotations.md#cache-annotation-enable) as well.

<a id="xsd-schemas-context-component-scan"></a>

### Using `<component-scan/>`

This element is detailed in the section on [annotation-based container configuration](../beans/annotation-config.md).

<a id="xsd-schemas-context-ltw"></a>

### Using `<load-time-weaver/>`

This element is detailed in the section on [load-time weaving with AspectJ in the Spring Framework](../aop/using-aspectj.md#aop-aj-ltw).

<a id="xsd-schemas-context-sc"></a>

### Using `<spring-configured/>`

This element is detailed in the section on [using AspectJ to dependency inject domain objects with Spring](../aop/using-aspectj.md#aop-atconfigurable).

<a id="xsd-schemas-context-mbe"></a>

### Using `<mbean-export/>`

This element is detailed in the section on [configuring annotation-based MBean export](../../integration/jmx/naming.md#jmx-context-mbeanexport).
...
in [dependencies and configuration in detail](../beans/dependencies/factory-properties-detailed.md)
(and, indeed, in that entire [chapter](../../web/webmvc-view/mvc-xslt.md#mvc-view-xslt-beandefs)).
...
in the appendix entitled [XML Schema Authoring](xml-custom.md)).
