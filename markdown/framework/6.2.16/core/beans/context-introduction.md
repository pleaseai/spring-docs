...
[`ApplicationContext`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/context/ApplicationContext.html)
...
> See the [`ReloadableResourceBundleMessageSource`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/context/support/ReloadableResourceBundleMessageSource.html)
> javadoc for details.
...
see the javadoc for Spring’s [`ApplicationEventMulticaster`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/context/event/ApplicationEventMulticaster.html) interface
and [`SimpleApplicationEventMulticaster`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/context/event/SimpleApplicationEventMulticaster.html) implementation
...
caller. See
[`AsyncUncaughtExceptionHandler`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/aop/interceptor/AsyncUncaughtExceptionHandler.html)
for more details.
- Asynchronous event listener methods cannot publish a subsequent event by returning a
value. If you need to publish another event as the result of the processing, inject an
[`ApplicationEventPublisher`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/context/ApplicationEventPublisher.html)
...
[`SpringContextResourceAdapter`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/jca/context/SpringContextResourceAdapter.html)
...
[javadoc for `SpringContextResourceAdapter`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/jca/context/SpringContextResourceAdapter.html))
