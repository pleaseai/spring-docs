---
title: "CORS"
source: "ROOT:web/webflux-cors.adoc"
---
...
[See equivalent in the Servlet stack](webmvc-cors.md)

Spring WebFlux lets you handle CORS (Cross-Origin Resource Sharing). This section
describes how to do so.

<a id="webflux-cors-intro"></a>

## Introduction

[See equivalent in the Servlet stack](webmvc-cors.md#mvc-cors-intro)
...
<a id="webflux-cors-processing"></a>

## Processing

[See equivalent in the Servlet stack](webmvc-cors.md#mvc-cors-processing)
...
[configured](<https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/web/reactive/handler/AbstractHandlerMapping.html#setCorsConfigurations(java.util.Map)>)
...
[`CorsConfiguration#combine(CorsConfiguration)`](<https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/web/cors/CorsConfiguration.html#combine(org.springframework.web.cors.CorsConfiguration)>)
for more details.
...
<a id="webflux-cors-credentialed-requests"></a>

## Credentialed Requests

[See equivalent in the Servlet stack](webmvc-cors.md#mvc-cors-credentialed-requests)
...
<a id="webflux-cors-controller"></a>

## `@CrossOrigin`

[See equivalent in the Servlet stack](webmvc-cors.md#mvc-cors-controller)

The [`@CrossOrigin`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/web/bind/annotation/CrossOrigin.html)
...
1. Using `@CrossOrigin` at the method level.
...
<a id="webflux-cors-global"></a>

## Global Configuration

[See equivalent in the Servlet stack](webmvc-cors.md#mvc-cors-global)
...
<a id="webflux-cors-webfilter"></a>

## CORS `WebFilter`

[See equivalent in the Servlet stack](webmvc-cors.md#mvc-cors-filter)

You can apply CORS support through the built-in
[`CorsWebFilter`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/web/cors/reactive/CorsWebFilter.html), which is a
good fit with [functional endpoints](webflux-functional.md).
