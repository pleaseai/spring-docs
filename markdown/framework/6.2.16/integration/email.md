---
title: "Email"
source: "ROOT:integration/email.adoc"
---
...
`MailException`. See the [javadoc](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/mail/MailException.html)
...
> refactoring into a [custom Spring AOP aspect](../core/aop.md), which could then
...
<a id="mail-javamail-mime-attachments"></a>
