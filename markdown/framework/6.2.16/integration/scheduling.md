...
source: "ROOT:integration/scheduling.adoc"
---
...
[cron expressions](#scheduling-cron-expression).
...
[`SchedulingConfigurer`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/scheduling/annotation/SchedulingConfigurer.html)
and [`AsyncConfigurer`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/scheduling/annotation/AsyncConfigurer.html)
...
[cron expression](#scheduling-cron-expression).
...
<a id="scheduling-annotation-support-scheduled-reactive"></a>
...
<a id="scheduling-cron-expression"></a>

## Cron Expressions

All Spring cron expressions have to conform to the same format, whether you are using them in
[`@Scheduled` annotations](#scheduling-annotation-support-scheduled),
[`task:scheduled-tasks` elements](#scheduling-task-namespace-scheduled-tasks),
...
the [`SchedulerFactoryBean`](https://docs.spring.io/spring-framework/docs/6.2.16/javadoc-api/org/springframework/scheduling/quartz/SchedulerFactoryBean.html)
