...
[Using `@Transactional`](annotations.md).
...
> [Using `@Transactional`](annotations.md) and
...
[Load-time weaving with AspectJ in the Spring Framework](../../../core/aop/using-aspectj.md#aop-aj-ltw)
