---
title: "Coroutines"
source: "ROOT:languages/kotlin/coroutines.adoc"
---
...
Kotlin [Coroutines](https://kotlinlang.org/docs/coroutines-overview.html) are Kotlin
...
- Extensions for WebFlux [client](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-webflux/org.springframework.web.reactive.function.client/index.html) and [server](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/index.html) functional API.
- WebFlux.fn [coRouter { }](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/co-router.html) DSL
- WebFlux [`CoWebFilter`](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-web/org.springframework.web.server/-co-web-filter/index.html)
- Suspending function and `Flow` support in RSocket `@MessageMapping` annotated methods
- Extensions for [`RSocketRequester`](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-messaging/org.springframework.messaging.rsocket/index.html)
- Spring AOP
...
<a id="how-reactive-translates-to-coroutines"></a>
...
[coRouter { }](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/co-router.html)
...
<a id="coroutines.propagation"></a>

## Context Propagation

Spring applications are [instrumented with Micrometer for Observability support](../../integration/observability.md).
...
The [`PropagationContextElement`](https://docs.spring.io/spring-framework/docs/7.0.0/kdoc-api/spring-core/org.springframework.core/-propagation-context-element/index.html) operator generally ensures that the
