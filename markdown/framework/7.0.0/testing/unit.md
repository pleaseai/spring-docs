...
[`AopTestUtils`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/test/util/AopTestUtils.html) is a collection of
...
utilities, see [`AopUtils`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/aop/support/AopUtils.html) and
[`AopProxyUtils`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/aop/framework/AopProxyUtils.html).

[`ReflectionTestUtils`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/test/util/ReflectionTestUtils.html) is a
...
[`TestSocketUtils`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/test/util/TestSocketUtils.html) is a simple
...
[`ModelAndViewAssert`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/test/web/ModelAndViewAssert.html), which you
