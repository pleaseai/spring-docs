...
Injection with the `SpringExtension`](#testcontext-junit-jupiter-di) for further details.
...
[Spring JUnit Jupiter Testing Annotations](../annotations/integration-junit-jupiter.md)
...
[Meta-Annotation Support for Testing](../annotations/integration-meta.md) for
further details.
...
See [`@TestConstructor`](../annotations/integration-junit-jupiter.md#integration-testing-annotations-testconstructor)
...
[`@TestConstructor`](../annotations/integration-junit-jupiter.md#integration-testing-annotations-testconstructor)),
...
classpath. See the
["Changing the default enclosing configuration inheritance mode"](../annotations/integration-junit-jupiter.md#integration-testing-annotations-nestedtestconfiguration)
note for details.
...
[Context Caching](ctx-management/caching.md) for details).
Consult the list of
[supported annotations](../annotations/integration-junit-jupiter.md#integration-testing-annotations-nestedtestconfiguration)
...
<a id="testcontext-junit4-support"></a>
...
> [`SpringExtension`](#testcontext-junit-jupiter-extension)
> and JUnit Jupiter.
...
[Spring’s support for JUnit rules](#testcontext-junit4-rules)
instead.
...
[false positives](tx.md#testcontext-tx-false-positives).
...
> [Spring’s JUnit rules](#testcontext-junit4-rules).
