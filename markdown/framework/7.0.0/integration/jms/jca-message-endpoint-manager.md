...
See the javadoc for [`JmsMessageEndpointManager`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/jms/listener/endpoint/JmsMessageEndpointManager.html),
[`JmsActivationSpecConfig`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/jms/listener/endpoint/JmsActivationSpecConfig.html),
and [`ResourceAdapterFactoryBean`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/jca/support/ResourceAdapterFactoryBean.html)
for more details.
...
[`GenericMessageEndpointManager`](https://docs.spring.io/spring-framework/docs/7.0.0/javadoc-api/org/springframework/jca/endpoint/GenericMessageEndpointManager.html)
