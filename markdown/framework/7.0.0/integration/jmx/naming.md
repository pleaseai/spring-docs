---
title: "Controlling  `ObjectName` Instances for Your Beans"
source: "ROOT:integration/jmx/naming.adoc"
---
...
If you prefer to use [the annotation-based approach](interface.md#jmx-interface-metadata) to define
...
[MetadataNamingStrategy](#jmx-naming-metadata), as the following example shows:
