---
title: "Dependency Injection of Test Fixtures"
source: "ROOT:testing/testcontext-framework/fixture-di.adoc"
---

<a id="testcontext-fixture-di"></a>
...
(see [Dependency Injection with `SpringExtension`](support-classes.md#testcontext-junit-jupiter-di)). For consistency with Spring’s annotation-based
...
Because `@Autowired` is used to perform [autowiring by type](../../core/beans/dependencies/factory-autowire.md)
...
[Goals](../integration.md#integration-testing-goals) section. The next two code listings demonstrate the
