...
[`@RecordApplicationEvents`
javadoc](https://docs.spring.io/spring-framework/docs/6.1.7/javadoc-api/org/springframework/test/context/event/RecordApplicationEvents.html) for an example and further details.
