...
source: "ROOT:web/webmvc/mvc-controller/ann-methods/sessionattributes.adoc"
---
...
[See equivalent in the Reactive stack](../../../webflux/controller/ann-methods/sessionattributes.md)
...
1. Clearing the `Pet` value from the Servlet session.
