...
[`NotificationPublisher`](https://docs.spring.io/spring-framework/docs/6.1.7/javadoc-api/org/springframework/jmx/export/notification/NotificationPublisher.html)
