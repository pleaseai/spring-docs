...
element](#beans-ref-element) in XML-based configuration metadata. However, sometimes dependencies between
...
> in the case of [singleton](../factory-scopes.md#beans-factory-scopes-singleton) beans only, a corresponding
