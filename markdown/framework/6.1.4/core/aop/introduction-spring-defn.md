...
source: "ROOT:core/aop/introduction-spring-defn.adoc"
---
...
API. Spring AOP remains backward-compatible. See [the following chapter](../aop-api.md)
...
>
> See [Choosing which AOP Declaration Style to Use](choosing.md) for a more complete discussion of the advantages and disadvantages of
> each style.
