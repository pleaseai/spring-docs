...
See the [`org.springframework.aop.framework.adapter`](https://docs.spring.io/spring-framework/docs/6.1.4/javadoc-api/org/springframework/aop/framework/adapter/package-summary.html)
