...
source: "ROOT:data-access/transaction/declarative/rolling-back.adoc"
---

<a id="transaction-declarative-rolling-back"></a>
...
[`@Transactional` Settings](annotations.md#transaction-declarative-attransactional-settings).
...
refer to the \[official Vavr documentation\]([www.vavr.io/vavr-docs/#\_try](https://www.vavr.io/vavr-docs/#_try)).
...
<a id="transaction-declarative-rollback-rules"></a>
...
> [`@Transactional`](annotations.md#transaction-declarative-attransactional-settings), rollback rules may
...
application-specific `Exception` type by supplying an *exception pattern* via the
