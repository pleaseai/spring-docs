...
source: "ROOT:web/webflux/ann-rest-exceptions.adoc"
---

<a id="webflux-ann-rest-exceptions"></a>

# Error Responses

[See equivalent in the Servlet stack](../webmvc/mvc-ann-rest-exceptions.md)
...
specification, [RFC 7807](https://datatracker.ietf.org/doc/html/rfc7807.html).
...
[@ControllerAdvice](controller/ann-advice.md) that handles all Spring WebFlux exceptions,
and any `ErrorResponseException`, and renders an error response with a body.

<a id="webflux-ann-rest-exceptions-render"></a>

## Render

[See equivalent in the Servlet stack](../webmvc/mvc-ann-rest-exceptions.md#mvc-ann-rest-exceptions-render)
...
[@ControllerAdvice](controller/ann-advice.md) in Spring configuration. The handler
...
<a id="webflux-ann-rest-exceptions-non-standard"></a>

## Non-Standard Fields

[See equivalent in the Servlet stack](../webmvc/mvc-ann-rest-exceptions.md#mvc-ann-rest-exceptions-non-standard)
...
<a id="webflux-ann-rest-exceptions-i18n"></a>

## Customization and i18n

[See equivalent in the Servlet stack](../webmvc/mvc-ann-rest-exceptions.md#mvc-ann-rest-exceptions-i18n)
...
<a id="webflux-ann-rest-exceptions-codes"></a>
...
| `MissingRequestValueException` | (default) | `{0}` a label for the value (e.g. "request header", "cookie value", …​), `{1}` the value name |
...
<a id="webflux-ann-rest-exceptions-client"></a>

## Client Handling

[See equivalent in the Servlet stack](../webmvc/mvc-ann-rest-exceptions.md#mvc-ann-rest-exceptions-client)
