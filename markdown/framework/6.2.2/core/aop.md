...
> [schema-based approach](aop/schema.md) or the [@AspectJ annotation style](aop/ataspectj.md).
...
> The lower-level AOP support is discussed in [the following chapter](aop-api.md).

AOP is used in the Spring Framework to:

- Provide declarative enterprise services. The most important such service is
[declarative transaction management](../data-access/transaction/declarative.md).
