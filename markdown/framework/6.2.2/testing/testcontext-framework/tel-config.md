...
source: "ROOT:testing/testcontext-framework/tel-config.adoc"
---

<a id="testcontext-tel-config"></a>
...
[`ApplicationEvents`](application-events.md).
- `BeanOverrideTestExecutionListener`: Provides support for [testing/testcontext-framework/bean-overriding.adoc](bean-overriding.md) .
...
`ApplicationContext` (see [Test Execution Events](test-execution-events.md)).
- `MockitoResetTestExecutionListener`: Resets mocks as configured by `@MockitoBean` or `@MockitoSpyBean`.

<a id="testcontext-tel-config-registering-tels"></a>
...
[annotation support](../annotations.md) and the javadoc for
[`@TestExecutionListeners`](https://docs.spring.io/spring-framework/docs/6.2.2/javadoc-api/org/springframework/test/context/TestExecutionListeners.html)
...
<a id="testcontext-tel-config-automatic-discovery"></a>
...
properties file](https://github.com/spring-projects/spring-framework/tree/main/spring-test/src/main/resources/META-INF/spring.factories). Third-party frameworks and developers can contribute their own
...
<a id="testcontext-tel-config-ordering"></a>
...
through the [aforementioned](#testcontext-tel-config-automatic-discovery)
...
<a id="testcontext-tel-config-merging"></a>
...
implementations by using the aforementioned [automatic discovery mechanism](#testcontext-tel-config-automatic-discovery)
.
...
of `AnnotationAwareOrderComparator`, as described in [Ordering `TestExecutionListener` Implementations](#testcontext-tel-config-ordering).
