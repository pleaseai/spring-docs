---
title: "Overview"
source: "ROOT:testing/mockmvc/overview.adoc"
---

<a id="mockmvc-overview"></a>
...
["mock" implementations of the Servlet API](../unit.md#mock-objects-servlet)
...
[WebTestClient](../webtestclient.md) API with MockMvc plugged in as the server
to handle requests.
