---
title: "Common Problems with Parameter and Data Value Handling"
source: "ROOT:data-access/jdbc/parameter-handling.adoc"
---

<a id="jdbc-parameter-handling"></a>
...
1. Using the method `setClobAsCharacterStream` to pass in the contents of the CLOB.
1. Using the method `setBlobAsBinaryStream` to pass in the contents of the BLOB.
...
1. Using the method `getBlobAsBytes` to retrieve the contents of the BLOB.
