---
title: "Multipart"
source: "ROOT:web/webmvc/mvc-controller/ann-methods/multipart-forms.adoc"
---
...
[See equivalent in the Reactive stack](../../../webflux/controller/ann-methods/multipart-forms.md)

After a `MultipartResolver` has been [enabled](../../mvc-servlet/multipart.md), the content of POST
...
[command object](modelattrib-method-args.md). For example, the form field
