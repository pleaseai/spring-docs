...
source: "ROOT:web/websocket/stomp/user-destination.adoc"
---

<a id="websocket-stomp-user-destination"></a>
...
> application destination prefixes as shown in [Enable STOMP](enable.md), or otherwise the
