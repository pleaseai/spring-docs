...
bean is a [prototype](../factory-scopes.md) bean, this typo and the resulting
...
> element brings value is in the configuration of [AOP interceptors](../../aop-api/pfb.md#aop-pfb-1)
