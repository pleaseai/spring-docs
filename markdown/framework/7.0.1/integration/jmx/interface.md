---
title: "Controlling the Management Interface of Your Beans"
source: "ROOT:integration/jmx/interface.adoc"
---
...
In the example in the [preceding section](exporting.md#jmx-exporting-registration-behavior),
...
used in [Creating an MBeanServer](exporting.md#jmx-exporting-mbeanserver).
...
detail later in [Spring JMX Annotations](#jmx-interface-metadata-types).
...
> [!NOTE]
> The `AnnotationTestBean` class is not required to implement any Java interfaces,
...
<a id="jmx-metadata-parameters"></a>
...
Your Beans](naming.md). You can also see an example which uses the `MetadataNamingStrategy` in
[Using Source-level Metadata: Java Annotations](#jmx-interface-metadata).
