---
title: "Mixing XML, Groovy Scripts, and Component Classes"
source: "ROOT:testing/testcontext-framework/ctx-management/mixed-config.adoc"
---

<a id="testcontext-ctx-management-mixed-config"></a>
