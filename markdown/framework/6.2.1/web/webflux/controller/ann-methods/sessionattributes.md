...
source: "ROOT:web/webflux/controller/ann-methods/sessionattributes.adoc"
---

<a id="webflux-ann-sessionattributes"></a>

# `@SessionAttributes`

[See equivalent in the Servlet stack](../../../webmvc/mvc-controller/ann-methods/sessionattributes.md)
...
1. Using the `@SessionAttributes` annotation.
1. Using a `SessionStatus` variable.
