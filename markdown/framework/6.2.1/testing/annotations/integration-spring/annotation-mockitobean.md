...
override beans in the test’s `ApplicationContext` with a Mockito *mock* or *spy*,
...
[strategy for test bean overriding](../../testcontext-framework/bean-overriding.md#testcontext-bean-overriding-custom).
...
[strategy](../../testcontext-framework/bean-overriding.md#testcontext-bean-overriding-custom),
