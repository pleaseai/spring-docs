---
title: "Declarative XML-based Caching"
source: "ROOT:integration/cache/declarative-xml.adoc"
---
...
[advice](../../data-access/transaction/declarative/first-example.md)). The example
...
[Aspect Oriented Programming with Spring](../../core/aop.md)). In the preceding example,
