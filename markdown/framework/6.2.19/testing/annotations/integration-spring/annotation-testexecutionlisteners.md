...
and the [`@TestExecutionListeners` javadoc](https://docs.spring.io/spring-framework/docs/6.2.19/javadoc-api/org/springframework/test/context/TestExecutionListeners.html)
...
[Registering `TestExecutionListener` Implementations](../../testcontext-framework/tel-config.md#testcontext-tel-config-registering-tels).
