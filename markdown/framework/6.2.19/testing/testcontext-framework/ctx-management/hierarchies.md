...
source: "ROOT:testing/testcontext-framework/ctx-management/hierarchies.adoc"
---

<a id="testcontext-ctx-management-ctx-hierarchies"></a>
...
> [Spring Testing Annotations](../../annotations/integration-spring/annotation-dirtiescontext.md)
> and the [`@DirtiesContext`](https://docs.spring.io/spring-framework/docs/6.2.19/javadoc-api/org/springframework/test/annotation/DirtiesContext.html) javadoc.
...
<a id="testcontext-ctx-management-ctx-hierarchies-with-bean-overrides"></a>

**Context hierarchies with bean overrides**

When `@ContextHierarchy` is used in conjunction with
[bean overrides](../bean-overriding.md) such as
