...
> See [`proxyBeanMethods` Javadoc](https://docs.spring.io/spring-framework/docs/6.2.4/javadoc-api/org/springframework/context/annotation/Configuration.html#proxyBeanMethods--) for more details.
...
[`@TestConstructor(autowireMode = AutowireMode.ALL)`](https://docs.spring.io/spring-framework/docs/6.2.4/javadoc-api/org/springframework/test/context/TestConstructor.html)
