---
title: "Path Matching"
source: "ROOT:web/webmvc/mvc-servlet/handlermapping-path.adoc"
---

<a id="mvc-handlermapping-path"></a>
...
a `UrlPathHelper` with `alwaysUseFullPath=true` via [Path Matching](../mvc-config/path-matching.md) in
the MVC config.
...
[Pattern Comparison](../mvc-controller/ann-requestmapping.md#mvc-ann-requestmapping-pattern-comparison).
