...
source: "ROOT:core/beans/dependencies/factory-collaborators.adoc"
---
...
DI exists in two major variants: [Constructor-based dependency injection](#beans-constructor-injection)
 and [Setter-based dependency injection](#beans-setter-injection).
...
<a id="beans-factory-ctor-arguments-type"></a>
...
<a id="beans-factory-ctor-arguments-index"></a>
...
<a id="beans-factory-ctor-arguments-name"></a>
...
<a id="beans-constructor-vs-setter-injection"></a>
...
> for optional dependencies. Note that use of the [@Autowired](../annotation-config/autowired.md)
...
> later. Management through [JMX MBeans](../../../integration/jmx.md) is therefore a compelling
...
when the container is created. Scopes are defined in [Bean Scopes](../factory-scopes.md). Otherwise,
...
methods (such as a [configured init method](../factory-nature.md#beans-factory-lifecycle-initializingbean)
or the [InitializingBean callback method](../factory-nature.md#beans-factory-lifecycle-initializingbean))
are invoked.
