...
- [Message](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/messaging/Message.html):
Simple representation for a message, including headers and payload.
- [MessageHandler](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/messaging/MessageHandler.html):
Contract for handling a message.
- [MessageChannel](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/messaging/MessageChannel.html):
Contract for sending a message that enables loose coupling between producers and consumers.
- [SubscribableChannel](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/messaging/SubscribableChannel.html):
`MessageChannel` with `MessageHandler` subscribers.
- [ExecutorSubscribableChannel](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/messaging/support/ExecutorSubscribableChannel.html):
...
![message flow simple broker](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.2.13/framework-docs/modules/ROOT/assets/images/message-flow-simple-broker.png)
...
![message flow broker relay](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.2.13/framework-docs/modules/ROOT/assets/images/message-flow-broker-relay.png)
