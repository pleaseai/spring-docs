...
See the
[`ApplicationEvents`
javadoc](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/test/context/event/ApplicationEvents.html) for further details regarding the `ApplicationEvents` API.
