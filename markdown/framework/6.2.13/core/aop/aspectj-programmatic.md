...
See the [javadoc](https://docs.spring.io/spring-framework/docs/6.2.13/javadoc-api/org/springframework/aop/aspectj/annotation/AspectJProxyFactory.html) for more information.
