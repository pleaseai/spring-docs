...
`@Around("com.xyz.CommonPointcuts.businessService()")` references the `businessService` named pointcut defined in [Sharing Named Pointcut Definitions](pointcuts.md#aop-common-pointcuts).
