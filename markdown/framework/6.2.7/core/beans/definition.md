---
title: "Bean Overview"
source: "ROOT:core/beans/definition.adoc"
---
...
<a id="beans-factory-bean-definition-tbl"></a>

| Property | Explained in…​ |
| --- | --- |
| Class | [Instantiating Beans](#beans-factory-class) |
| Name | [Naming Beans](#beans-beanname) |
| Scope | [Bean Scopes](factory-scopes.md) |
| Constructor arguments | [Dependency Injection](dependencies/factory-collaborators.md) |
| Properties | [Dependency Injection](dependencies/factory-collaborators.md) |
| Autowiring mode | [Autowiring Collaborators](dependencies/factory-autowire.md) |
| Lazy initialization mode | [Lazy-initialized Beans](dependencies/factory-lazy-init.md) |
| Initialization method | [Initialization Callbacks](factory-nature.md#beans-factory-lifecycle-initializingbean) |
| Destruction method | [Destruction Callbacks](factory-nature.md#beans-factory-lifecycle-disposablebean) |
...
<a id="beans-definition-overriding"></a>
...
> [this section](../../testing/testcontext-framework/bean-overriding.md) for more details.
...
Motivations for not supplying a name are related to using [inner beans](dependencies/factory-properties-detailed.md#beans-inner-beans)
 and [autowiring collaborators](dependencies/factory-autowire.md).
...
> See [Using the `@Bean` Annotation](java/bean-annotation.md) for details.
...
[Instantiation by Using an Instance Factory Method](#beans-factory-class-instance-factory-method) and [Bean Definition Inheritance](child-bean-definitions.md).)
...
[Injecting Dependencies](dependencies/factory-collaborators.md).
...
see [Dependencies and Configuration in Detail](dependencies/factory-properties-detailed.md).
...
Similar to instantiation through a [static factory method](#beans-factory-class-static-factory-method)
...
> [instance](#beans-factory-class-instance-factory-method) or
> [static](#beans-factory-class-static-factory-method) factory method. By contrast,
> `FactoryBean` (notice the capitalization) refers to a Spring-specific
> [`FactoryBean`](factory-extension.md#beans-factory-extension-factorybean) implementation class.

<a id="beans-factory-type-determination"></a>
