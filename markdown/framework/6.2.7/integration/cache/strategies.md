---
title: "Understanding the Cache Abstraction"
source: "ROOT:integration/cache/strategies.adoc"
---
...
Spring provides [a few implementations](store-configuration.md) of that abstraction:
JDK `java.util.concurrent.ConcurrentMap` based caches, Gemfire cache,
[Caffeine](https://github.com/ben-manes/caffeine/wiki), and JSR-107 compliant caches (such
as Ehcache 3.x). See [Plugging-in Different Back-end Caches](plug.md) for more information on plugging in other cache
