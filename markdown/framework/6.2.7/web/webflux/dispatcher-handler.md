...
[`WebHttpHandlerBuilder`](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/web/server/adapter/WebHttpHandlerBuilder.html),
...
| `ViewResolutionResultHandler` | `CharSequence`, [`View`](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/web/reactive/result/view/View.html), [Model](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/ui/Model.html), `Map`, [Rendering](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/web/reactive/result/view/Rendering.html), or any other `Object` is treated as a model attribute. See also [View Resolution](#webflux-viewresolution). | `Integer.MAX_VALUE` |
...
- [Rendering](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/web/reactive/result/view/Rendering.html): API for
...
[BeanUtils#isSimpleProperty](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/beans/BeanUtils.html#isSimpleProperty-java.lang.Class-))
is treated as a model attribute to be added to the model. The attribute name is derived
from the class name by using [conventions](https://docs.spring.io/spring-framework/docs/6.2.7/javadoc-api/org/springframework/core/Conventions.html),
