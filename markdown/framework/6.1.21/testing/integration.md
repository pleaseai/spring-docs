...
source: "ROOT:testing/integration.adoc"
---
...
it from (see the [section on Dependency Management](../core/beans/dependencies.md)
...
[Spring TestContext Framework](testcontext-framework.md). The TestContext framework is
...
- [JDBC Testing Support](support-jdbc.md)
- [Spring TestContext Framework](testcontext-framework.md)
- [WebTestClient](webtestclient.md)
- [MockMvc](spring-mvc-test-framework.md)
- [Testing Client Applications](spring-mvc-test-client.md)
- [Annotations](annotations.md)

<a id="integration-testing-goals"></a>

## Goals of Integration Testing

Spring’s integration testing support has the following primary goals:

- To manage [Spring IoC container caching](#testing-ctx-management) between tests.
- To provide [Dependency Injection of test fixture instances](#testing-fixture-di).
- To provide [transaction management](#testing-tx) appropriate to integration testing.
- To supply [Spring-specific base classes](#testing-support-classes) that assist
...
See [Context Management](testcontext-framework/ctx-management.md) and [Context Caching](testcontext-framework/ctx-management/caching.md) with the
TestContext framework.

<a id="testing-fixture-di"></a>
...
[TestContext framework](testcontext-framework/fixture-di.md).
...
[`@Commit`](annotations.md) annotation.

See transaction management with the [TestContext framework](testcontext-framework/tx.md).

<a id="testing-support-classes"></a>
...
to avoid [false positives](testcontext-framework/tx.md#testcontext-tx-false-positives).
...
See support classes for the [TestContext framework](testcontext-framework/support-classes.md).
