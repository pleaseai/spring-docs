...
source: "ROOT:testing/spring-mvc-test-framework/server-htmlunit.adoc"
---

<a id="spring-mvc-test-server-htmlunit"></a>

# HtmlUnit Integration

Spring provides integration between [MockMvc](server.md) and
