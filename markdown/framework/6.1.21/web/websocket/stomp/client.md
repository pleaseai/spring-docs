---
title: "STOMP Client"
source: "ROOT:web/websocket/stomp/client.adoc"
---

<a id="websocket-stomp-client"></a>
...
[`SockJsClient`](../fallback.md#websocket-fallback-sockjs-client).
...
when initializing the [External Broker](handle-broker-relay.md) which ensures a
