...
source: "ROOT:testing/spring-mvc-test-framework/server-setup-steps.adoc"
---

<a id="spring-mvc-test-server-setup-steps"></a>
...
See the javadoc for
[`ConfigurableMockMvcBuilder`](https://docs.spring.io/spring-framework/docs/6.1.20/javadoc-api/org/springframework/test/web/servlet/setup/ConfigurableMockMvcBuilder.html)
