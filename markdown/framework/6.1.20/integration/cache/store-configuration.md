---
title: "Configuring the Cache Storage"
source: "ROOT:integration/cache/store-configuration.adoc"
---
...
<a id="cache-store-configuration-eviction"></a>

## Ehcache-based Cache

Ehcache 3.x is fully JSR-107 compliant and no dedicated support is required for it. See
[JSR-107 Cache](#cache-store-configuration-jsr107) for details.
