---
title: "Resolving Codes to Error Messages"
source: "ROOT:core/validation/conversion.adoc"
---
...
in the javadoc of
[`MessageCodesResolver`](https://docs.spring.io/spring-framework/docs/6.1.20/javadoc-api/org/springframework/validation/MessageCodesResolver.html) and
[`DefaultMessageCodesResolver`](https://docs.spring.io/spring-framework/docs/6.1.20/javadoc-api/org/springframework/validation/DefaultMessageCodesResolver.html),
respectively.
