...
source: "ROOT:web/websocket/fallback.adoc"
---

<a id="websocket-fallback"></a>
...
<a id="websocket-fallback-sockjs-overview"></a>
...
<a id="websocket-fallback-sockjs-enable"></a>
...
configuration of a [`DispatcherServlet`](../webmvc/mvc-servlet.md). However, Spring’s WebSocket
...
[`SockJsHttpRequestHandler`](https://docs.spring.io/spring-framework/docs/6.1.10/javadoc-api/org/springframework/web/socket/sockjs/support/SockJsHttpRequestHandler.html).
...
<a id="websocket-fallback-xhr-vs-iframe"></a>
...
<a id="websocket-fallback-sockjs-heartbeat"></a>
...
<a id="websocket-fallback-sockjs-servlet3-async"></a>
...
<a id="websocket-fallback-cors"></a>

## SockJS and CORS

If you allow cross-origin requests (see [Allowed Origins](server.md#websocket-server-allowed-origins)), the SockJS protocol
...
<a id="websocket-fallback-sockjs-client"></a>
...
1. Set the `httpMessageCacheSize` property to 1,000 (the default is `100`).
1. Set the `disconnectDelay` property to 30 property seconds (the default is five seconds — `5 * 1000`).
