...
![tx prop required](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.13/framework-docs/modules/ROOT/assets/images/tx_prop_required.png)
...
![tx prop requires new](https://raw.githubusercontent.com/spring-projects/spring-framework/v6.1.13/framework-docs/modules/ROOT/assets/images/tx_prop_requires_new.png)
...
transactions. See Spring’s [`DataSourceTransactionManager`](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/jdbc/datasource/DataSourceTransactionManager.html).
