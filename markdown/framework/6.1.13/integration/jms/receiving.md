...
[Using `MessageListenerAdapter`](#jms-receiving-async-message-listener-adapter)) on an MDP is that it must implement
...
[MessageListenerContainer](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/jms/listener/MessageListenerContainer.html))
