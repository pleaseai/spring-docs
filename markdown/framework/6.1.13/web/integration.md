...
[`ContextLoaderListener`](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/web/context/ContextLoaderListener.html)
...
[`WebApplicationContext`](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/web/context/WebApplicationContext.html)
...
The
[`WebApplicationContextUtils`](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/web/context/support/WebApplicationContextUtils.html)
...
The [`FacesContextUtils`](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/web/jsf/FacesContextUtils.html)
