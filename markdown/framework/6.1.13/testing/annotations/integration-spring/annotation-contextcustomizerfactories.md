...
[`@ContextCustomizerFactories`
javadoc](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/test/context/ContextCustomizerFactories.html) for an example and further details.
