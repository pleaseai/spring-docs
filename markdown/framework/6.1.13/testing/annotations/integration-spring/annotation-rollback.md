---
title: "`@Rollback`"
source: "ROOT:testing/annotations/integration-spring/annotation-rollback.adoc"
---

<a id="spring-testing-annotation-rollback"></a>
...
[`@Commit`](annotation-commit.md)). Rollback for integration tests in the Spring
