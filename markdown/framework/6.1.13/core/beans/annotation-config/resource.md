...
source: "ROOT:core/beans/annotation-config/resource.adoc"
---
...
> [`SimpleJndiBeanFactory`](https://docs.spring.io/spring-framework/docs/6.1.13/javadoc-api/org/springframework/jndi/support/SimpleJndiBeanFactory.html)
