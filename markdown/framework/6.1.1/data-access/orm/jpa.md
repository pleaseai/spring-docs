...
See the [next section](#orm-jpa-dialect) for details on the `JpaDialect` mechanism.
...
See the [`JpaDialect`](https://docs.spring.io/spring-framework/docs/6.1.1/javadoc-api/org/springframework/orm/jpa/JpaDialect.html) and
[`JpaVendorAdapter`](https://docs.spring.io/spring-framework/docs/6.1.1/javadoc-api/org/springframework/orm/jpa/JpaVendorAdapter.html) javadoc for
