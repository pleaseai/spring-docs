...
source: "ROOT:web/webmvc/mvc-ann-rest-exceptions.adoc"
---
...
[See equivalent in the Reactive stack](../webflux/ann-rest-exceptions.md)
...
specification, [RFC 7807](https://datatracker.ietf.org/doc/html/rfc7807).
...
[@ControllerAdvice](mvc-controller/ann-advice.md) that handles all Spring MVC exceptions,
and any `ErrorResponseException`, and renders an error response with a body.

<a id="mvc-ann-rest-exceptions-render"></a>

## Render

[See equivalent in the Reactive stack](../webflux/ann-rest-exceptions.md#webflux-ann-rest-exceptions-render)
...
[@ControllerAdvice](mvc-controller/ann-advice.md) in Spring configuration. The handler
...
<a id="mvc-ann-rest-exceptions-non-standard"></a>

## Non-Standard Fields

[See equivalent in the Reactive stack](../webflux/ann-rest-exceptions.md#webflux-ann-rest-exceptions-non-standard)
...
<a id="mvc-ann-rest-exceptions-i18n"></a>

## Customization and i18n

[See equivalent in the Reactive stack](../webflux/ann-rest-exceptions.md#webflux-ann-rest-exceptions-i18n)
...
these through a [MessageSource](../../core/beans/context-introduction.md#context-functionality-messagesource)
...
<a id="mvc-ann-rest-exceptions-codes"></a>
...
| `MethodArgumentNotValidException` | (default) | `{0}` the list of global errors, `{1}` the list of field errors. Message codes and arguments for each error are also resolvedvia `MessageSource`. |
...
> [MessageSource](../../core/beans/context-introduction.md#context-functionality-messagesource)
> resource bundle. See
> [Customizing Validation Errors](../../core/validation/beanvalidation.md#validation-beanvalidation-spring-method-i18n)
> for more details.

<a id="mvc-ann-rest-exceptions-client"></a>

## Client Handling

[See equivalent in the Reactive stack](../webflux/ann-rest-exceptions.md#webflux-ann-rest-exceptions-client)
