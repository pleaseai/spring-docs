...
source: "ROOT:testing/testcontext-framework.adoc"
---

<a id="testcontext-framework"></a>
...
configuration ([context management](testcontext-framework/ctx-management.md),
[dependency injection](testcontext-framework/fixture-di.md), [transaction management](testcontext-framework/tx.md)
), [support classes](testcontext-framework/support-classes.md), and
[annotation support](annotations.md) sections.
