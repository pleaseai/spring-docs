...
<a id="webflux-ann-requestmapping-version"></a>

## API Version

[See equivalent in the Servlet stack](../../webmvc/mvc-controller/ann-requestmapping.md#mvc-ann-requestmapping-version)

There is no standard way to specify an API version, so when you enable API versioning
in the [WebFlux Config](../config.md#webflux-config-api-version) you need
to specify how to resolve the version. The WebFlux Config creates an
[ApiVersionStrategy](../../webflux-versioning.md#webflux-versioning-strategy) that in turn
...
[supported versions](../config.md#webflux-config-api-version) above
...
> [configured as supported](../config.md#webflux-config-api-version).
...
[client with a generated proxy](../../../integration/rest-clients.md#rest-http-service-client),
