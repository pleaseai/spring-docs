...
- [WebMvc.fn DSL](../../web/webmvc-functional.md) with [router { }](https://docs.spring.io/spring-framework/docs/7.0.8/kdoc-api/spring-webmvc/org.springframework.web.servlet.function/router.html)
- [WebFlux.fn Reactive DSL](../../web/webflux-functional.md) with [router { }](https://docs.spring.io/spring-framework/docs/7.0.8/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/router.html)
- [WebFlux.fn Coroutines DSL](coroutines.md) with [coRouter { }](https://docs.spring.io/spring-framework/docs/7.0.8/kdoc-api/spring-webflux/org.springframework.web.reactive.function.server/co-router.html)
