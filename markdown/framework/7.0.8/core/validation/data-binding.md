---
title: "Data Binding"
source: "ROOT:core/validation/data-binding.adoc"
---
...
with property paths as keys, following [JavaBeans conventions](#data-binding-conventions).
`DataBinder` is the main class that supports this, and it provides two ways to bind user
input:

- [Constructor binding](#data-binding-constructor-binding) - bind user input to a
public data constructor, looking up constructor argument values in the user input.
- [Property binding](#data-binding-property-binding) - bind user input to setters,
...
<a id="data-binding-constructor-binding"></a>
...
1. Set `targetType` to the target class.
1. Call `construct`.
...
[Type conversion](#data-binding-conventions) is applied as needed to convert user input.
...
<a id="data-binding-property-binding"></a>
...
<a id="data-binding-conventions"></a>
...
<a id="data-binding-conventions-properties-tbl"></a>
...
[section on `PropertyEditors`](#data-binding-conversion).)
...
<a id="data-binding-conversion"></a>
...
<a id="data-binding-property-editors-tbl"></a>
...
└── example
    └── things
        ...
        └── <strong>SomethingEditor</strong> // the PropertyEditor for the Something class
```
...
└── example
    └── things
        ├── <strong>Something</strong>
        └── <strong>SomethingBeanInfo</strong> // the BeanInfo for the Something class
```
...
<a id="data-binding-conversion-customeditor-registration"></a>
...
registers are listed in the [previous section](#data-binding-conversion).
...
<a id="data-binding-conversion-customeditor-registration-per"></a>
...
[here](#data-binding-conversion-customeditor-registration)), which exposes a property
...
using [Spring’s MVC web framework](../../web/webmvc.md#mvc), using a `PropertyEditorRegistrar` in
