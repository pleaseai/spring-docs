...
source: "ROOT:core/aop-api/pfb.adoc"
---
...
- Specify whether to use CGLIB (described later and see also [JDK- and CGLIB-based proxies](#aop-pfb-proxy-types)).
...
are created (but see also [JDK- and CGLIB-based proxies](#aop-pfb-proxy-types)).
...
proxy for the target class is used (but see also [JDK- and CGLIB-based proxies](#aop-pfb-proxy-types)).
...
invocation.
  ...
  to be applied. You can find an example of using this feature in [Using “Global” Advisors](#aop-global-advisors).
