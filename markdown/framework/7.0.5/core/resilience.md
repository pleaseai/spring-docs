...
source: "ROOT:core/resilience.adoc"
---
...
[`@Retryable`](#resilience-annotations-retryable) and [`@ConcurrencyLimit`](#resilience-annotations-concurrencylimit)
annotations for method invocations as well as [programmatic retry support](#resilience-programmatic-retry).

<a id="resilience-annotations-retryable"></a>

## `@Retryable`

[`@Retryable`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/resilience/annotation/Retryable.html) is an annotation
...
[`@Retryable`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/resilience/annotation/Retryable.html).
...
<a id="resilience-annotations-concurrencylimit"></a>

## `@ConcurrencyLimit`

[`@ConcurrencyLimit`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/resilience/annotation/ConcurrencyLimit.html) is
...
[`SimpleAsyncTaskExecutor`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/task/SimpleAsyncTaskExecutor.html).
For synchronous invocations, this annotation provides equivalent behavior through
[`ConcurrencyThrottleInterceptor`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/aop/interceptor/ConcurrencyThrottleInterceptor.html)
...
<a id="resilience-annotations-configuration"></a>
...
[`@EnableResilientMethods`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/resilience/annotation/EnableResilientMethods.html)
...
<a id="resilience-programmatic-retry"></a>

## Programmatic Retry Support

In contrast to [`@Retryable`](#resilience-annotations-retryable) which provides a declarative approach
for specifying retry semantics for methods within beans registered in the
`ApplicationContext`,
[`RetryTemplate`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/retry/RetryTemplate.html) provides a
programmatic API for retrying arbitrary blocks of code.

Specifically, a `RetryTemplate` executes and potentially retries a
[`Retryable`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/retry/Retryable.html) operation based on a
configured [`RetryPolicy`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/retry/RetryPolicy.html).
...
1. Specify one or more exception types to exclude.
...
> [!TIP]
> A [`RetryListener`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/retry/RetryListener.html) can be registered
...
> [`CompositeRetryListener`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/retry/support/CompositeRetryListener.html).
...
[`BackOff`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/util/backoff/BackOff.html) strategy to use. Note that you
