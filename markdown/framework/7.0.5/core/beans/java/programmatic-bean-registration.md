...
provided via the [`BeanRegistrar`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/beans/factory/BeanRegistrar.html)
...
> [!NOTE]
> You can leverage type-level conditional annotations ([`@Conditional`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/annotation/Conditional.html),
> but also other variants) to conditionally import the related bean registrars.

The bean registrar implementation uses [`BeanRegistry`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/beans/factory/BeanRegistry.html) and
[`Environment`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/env/Environment.html) APIs to register beans programmatically in a concise
