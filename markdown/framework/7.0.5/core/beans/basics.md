...
[`AnnotationConfigApplicationContext`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/annotation/AnnotationConfigApplicationContext.html)
or [`ClassPathXmlApplicationContext`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/support/ClassPathXmlApplicationContext.html).
...
![container magic](https://raw.githubusercontent.com/spring-projects/spring-framework/v7.0.5/framework-docs/modules/ROOT/assets/images/container-magic.png)
...
[`@Configuration`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/annotation/Configuration.html),
[`@Bean`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/annotation/Bean.html),
[`@Import`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/annotation/Import.html),
and [`@DependsOn`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/context/annotation/DependsOn.html) annotations.
