...
- `observationRegistry`: the registry to use for enabling [Observability support](../../integration/observability.md#observability.http-client.webclient).
- `observationConvention`: [an optional, custom convention to extract metadata](../../integration/observability.md#observability.config) for recorded observations.
