---
title: "`@Controller`"
source: "ROOT:web/webflux/controller/ann.adoc"
---

<a id="webflux-ann-controller"></a>

# `@Controller`

[See equivalent in the Servlet stack](../../webmvc/mvc-controller/ann.md)
...
`@RestController` is a [composed annotation](../../../core/beans/classpath-scanning.md#beans-meta-annotations) that is
...
<a id="webflux-ann-requestmapping-proxying"></a>

## AOP Proxies

[See equivalent in the Servlet stack](../../webmvc/mvc-controller/ann.md#mvc-ann-requestmapping-proxying)
