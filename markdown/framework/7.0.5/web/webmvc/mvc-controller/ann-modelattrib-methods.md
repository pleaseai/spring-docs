...
> type, as explained in the javadoc for [`Conventions`](https://docs.spring.io/spring-framework/docs/7.0.5/javadoc-api/org/springframework/core/Conventions.html).
