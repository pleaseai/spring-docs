...
[`ReactiveAdapterRegistry`](https://docs.spring.io/spring-framework/docs/6.1.6/javadoc-api/org/springframework/core/ReactiveAdapterRegistry.html), which
provides pluggable support for reactive library and other asynchronous types. The registry
has built-in support for RxJava 3, Kotlin coroutines and SmallRye Mutiny, but you can
register others, too.

For functional APIs (such as [\[webflux-fn\]](#webflux-fn), the `WebClient`, and others), the general rules
