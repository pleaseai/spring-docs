...
- [`PropertyOrFieldReference`](https://docs.spring.io/spring-framework/docs/7.0.3/javadoc-api/org/springframework/expression/spel/ast/PropertyOrFieldReference.html)
- [`MethodReference`](https://docs.spring.io/spring-framework/docs/7.0.3/javadoc-api/org/springframework/expression/spel/ast/MethodReference.html)
- [`Indexer`](https://docs.spring.io/spring-framework/docs/7.0.3/javadoc-api/org/springframework/expression/spel/ast/Indexer.html)
- [`Selection`](https://docs.spring.io/spring-framework/docs/7.0.3/javadoc-api/org/springframework/expression/spel/ast/Selection.html)
- [`Projection`](https://docs.spring.io/spring-framework/docs/7.0.3/javadoc-api/org/springframework/expression/spel/ast/Projection.html)
