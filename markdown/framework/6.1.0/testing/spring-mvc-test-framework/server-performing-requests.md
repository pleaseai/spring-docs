...
source: "ROOT:testing/spring-mvc-test-framework/server-performing-requests.adoc"
---

<a id="spring-mvc-test-server-performing-requests"></a>
...
[Writing Tests](../webtestclient.md#webtestclient-tests) instead.
