---
title: "Overview"
source: "ROOT:testing/spring-mvc-test-framework/server.adoc"
---

<a id="spring-mvc-test-server"></a>
...
[“mock” implementations of the Servlet API](../unit.md#mock-objects-servlet) from the
...
the [WebTestClient](../webtestclient.md) API with MockMvc plugged in as the server to handle requests
with.
