...
> [!TIP]
> Kotlin users: See [this section](../languages/kotlin/spring-projects-in.md#kotlin-webtestclient-issue)
...
[StandaloneMockMvcBuilder](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/test/web/servlet/setup/StandaloneMockMvcBuilder.html)
...
[MockMvc](spring-mvc-test-framework.md) to handle requests:
...
[WebHttpHandlerBuilder](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/web/server/adapter/WebHttpHandlerBuilder.html#applicationContext-org.springframework.context.ApplicationContext-)
...
[MockMvcBuilders.webAppContextSetup](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/test/web/servlet/setup/MockMvcBuilders.html#webAppContextSetup-org.springframework.web.context.WebApplicationContext-)
to create a [MockMvc](spring-mvc-test-framework.md) instance to handle
requests:
...
This setup allows you to test [functional endpoints](../web-reactive.md#webflux-fn) via
...
`WebTestClient` provides an API identical to [WebClient](../web/webflux-webclient.md)
up to the point of performing a request by using `exchange()`. See the
[WebClient](../web/webflux-webclient/client-body.md) documentation for examples on how to
...
> that accept
> [`ParameterizedTypeReference`](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/core/ParameterizedTypeReference.html)
> instead of `Class<T>`.
