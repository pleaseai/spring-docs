---
title: "Using `@Transactional` with AspectJ"
source: "ROOT:data-access/transaction/declarative/aspectj.adoc"
---

<a id="transaction-declarative-aspectj"></a>
...
attribute to `aspectj` as described in [Using `@Transactional`](annotations.md). Because
we focus here on applications that run outside of a Spring container, we show
you how to do it programmatically.

> [!NOTE]
> Prior to continuing, you may want to read [Using `@Transactional`](annotations.md) and
> [AOP](../../../core/aop.md) respectively.
...
[AspectJ Development
Guide](https://www.eclipse.org/aspectj/doc/released/devguide/index.html)) or use load-time weaving. See [Load-time weaving with AspectJ in the Spring Framework](../../../core/aop/using-aspectj.md#aop-aj-ltw)
