---
title: "Introduction to ORM with Spring"
source: "ROOT:data-access/orm/introduction.adoc"
---

<a id="orm-introduction"></a>
...
(rollback and so on) are handled for you. As discussed in [Resource and Transaction Management](general.md#orm-resource-mngmnt),
...
> [Spring Data](https://projects.spring.io/spring-data/) suite of projects. If you are
