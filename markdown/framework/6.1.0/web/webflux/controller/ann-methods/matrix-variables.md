...
source: "ROOT:web/webflux/controller/ann-methods/matrix-variables.adoc"
---

<a id="webflux-ann-matrix-variables"></a>

# Matrix Variables

[See equivalent in the Servlet stack](../../../webmvc/mvc-controller/ann-methods/matrix-variables.md)
