...
source: "ROOT:web/webflux/controller/ann-methods/modelattrib-method-args.adoc"
---

<a id="webflux-ann-modelattrib-method-args"></a>

# `@ModelAttribute`

[See equivalent in the Servlet stack](../../../webmvc/mvc-controller/ann-methods/modelattrib-method-args.md)
...
[`Model`](../ann-modelattrib-methods.md).
- Accessed from the HTTP session if the model attribute was listed in
the class-level [`@SessionAttributes`](sessionattributes.md).
...
[model design](../ann-initbinder.md#webflux-ann-initbinder-model-design).
...
[Bean Validation](../../../../core/validation/beanvalidation.md) and
[Spring validation](../../../webmvc/mvc-config/validation.md)). For example:
...
controller method [Validation](../../../webmvc/mvc-controller/ann-validation.md).
...
> *AND* that is not resolved by any other argument resolver is treated as an `@ModelAttribute`.
