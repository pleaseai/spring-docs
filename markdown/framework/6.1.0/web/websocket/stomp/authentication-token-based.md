...
source: "ROOT:web/websocket/stomp/authentication-token-based.adoc"
---

<a id="websocket-stomp-authentication-token-based"></a>
...
The [WebSocket protocol, RFC 6455](https://tools.ietf.org/html/rfc6455#section-10.5)
...
1. Process the authentication headers with a `ChannelInterceptor`.
