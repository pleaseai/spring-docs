...
source: "ROOT:web/webmvc/mvc-controller/ann-requestmapping.adoc"
---
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md)

This section discusses request mapping for annotated controllers.

<a id="mvc-ann-requestmapping-annotation"></a>

## `@RequestMapping`

[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-annotation)
...
The shortcuts are [Custom Annotations](#mvc-ann-requestmapping-composed) that are provided because,
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-uri-templates)
...
default from version 6.0. See [MVC config](../mvc-config/path-matching.md) for
...
[PathPattern](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/web/util/pattern/PathPattern.html) and
[AntPathMatcher](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/util/AntPathMatcher.html).
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-pattern-comparison)
...
- [`PathPattern.SPECIFICITY_COMPARATOR`](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/web/util/pattern/PathPattern.html#SPECIFICITY_COMPARATOR)
- [`AntPathMatcher.getPatternComparator(String path)`](https://docs.spring.io/spring-framework/docs/6.1.0/javadoc-api/org/springframework/util/AntPathMatcher.html#getPatternComparator-java.lang.String-)
...
- `useSuffixPatternMatching(false)`, see [PathMatchConfigurer](../mvc-config/path-matching.md)
- `favorPathExtension(false)`, see [ContentNegotiationConfigurer](../mvc-config/content-negotiation.md)
...
[ContentNegotiationConfigurer](../mvc-config/content-negotiation.md).
...
See [Content Types](../mvc-config/content-negotiation.md).

See [CVE-2015-5211](https://pivotal.io/security/cve-2015-5211) for additional
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-consumes)
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-produces)
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-params-and-headers)
...
> [consumes](#mvc-ann-requestmapping-consumes) and [produces](#mvc-ann-requestmapping-produces)
> instead.
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-head-options)
...
[See equivalent in the Reactive stack](#mvc-ann-requestmapping-head-options)

Spring MVC supports the use of [composed annotations](../../../core/beans/classpath-scanning.md#beans-meta-annotations)
...
[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-requestmapping-registration)
...
1. Prepare the request mapping meta data.
...
<a id="mvc-ann-httpexchange-annotation"></a>

## `@HttpExchange`

[See equivalent in the Reactive stack](../../webflux/controller/ann-requestmapping.md#webflux-ann-httpexchange-annotation)
...
[HTTP Interface](../../../integration/rest-clients.md#rest-http-interface) and can be used as
...
[HTTP interface](../../../integration/rest-clients.md#rest-http-interface-method-parameters) and for
