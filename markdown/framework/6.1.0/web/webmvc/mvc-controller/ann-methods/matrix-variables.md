...
source: "ROOT:web/webmvc/mvc-controller/ann-methods/matrix-variables.adoc"
---
...
[See equivalent in the Reactive stack](../../../webflux/controller/ann-methods/matrix-variables.md)

[RFC 3986](https://tools.ietf.org/html/rfc3986#section-3.3) discusses name-value pairs in
...
[Path Matching](../../mvc-config/path-matching.md). In the MVC XML namespace, you can set
