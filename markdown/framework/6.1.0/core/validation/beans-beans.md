...
[Type conversion](#beans-beans-conventions) is applied as needed to convert user input.
...
<a id="beans-beans-conventions-properties-tbl"></a>
...
[section on `PropertyEditors`](#beans-beans-conversion).)
...
`PropertyEditor`, see [the javadoc of the `java.beans` package from Oracle](https://docs.oracle.com/javase/8/docs/api/java/beans/package-summary.html).
...
<a id="beans-beans-property-editors-tbl"></a>
...
registers are listed in the [previous section](#beans-beans-conversion).
...
[here](#beans-beans-conversion-customeditor-registration)), which exposes a property
