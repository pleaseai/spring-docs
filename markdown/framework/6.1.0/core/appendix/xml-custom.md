---
title: "XML Schema Authoring"
source: "ROOT:core/appendix/xml-custom.adoc"
---
...
<a id="xsd-custom-introduction"></a>
...
Spring distribution, you should first read the previous section on [XML Schemas](xsd-schemas.md).

To create new XML configuration extensions:

1. [Author](#core.appendix.xsd-custom-schema) an XML schema to describe your custom element(s).
1. [Code](#core.appendix.xsd-custom-namespacehandler) a custom `NamespaceHandler` implementation.
1. [Code](#core.appendix.xsd-custom-parser) one or more `BeanDefinitionParser` implementations
(this is where the real work is done).
1. [Register](#core.appendix.xsd-custom-registration) your new artifacts with Spring.
...
[scopes that Spring supports](../beans/factory-scopes.md).
...
1. We supply the `AbstractSingleBeanDefinitionParser` superclass with the type that our
...
If we stick to [the steps described previously](#core.appendix.xsd-custom-introduction), we start off
...
Again following [the process described earlier](#core.appendix.xsd-custom-introduction),
...
[JCache](https://jcp.org/en/jsr/detail?id=107), and you want to ensure that the
