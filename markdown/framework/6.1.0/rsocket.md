...
[Java library](https://github.com/rsocket/rsocket-javahttps://github.com/rsocket/rsocket-java) is built on [Project Reactor](https://projectreactor.io/),
...
- [Composite Metadata](https://github.com/rsocket/rsocket/blob/master/Extensions/CompositeMetadata.md)-- multiple,
...
The [Java implementation](https://github.com/rsocket/rsocket-javahttps://github.com/rsocket/rsocket-java) for RSocket is built on
...
The main contract
[io.rsocket.RSocket](https://github.com/rsocket/rsocket-javahttps://github.com/rsocket/rsocket-java/blob/master/rsocket-core/src/main/java/io/rsocket/RSocket.java)
...
[sample apps](https://github.com/rsocket/rsocket-javahttps://github.com/rsocket/rsocket-java/tree/master/rsocket-examples) that
...
See the
[RSocket section](https://docs.spring.io/spring-boot/docs/current/reference/htmlsingle/#boot-features-rsocket)
...
[composite metadata](https://github.com/rsocket/rsocket/blob/master/Extensions/CompositeMetadata.md) which allows multiple
...
[@ConnectMapping](#rsocket-annot-connectmapping) methods can be used to handle the start of a
...
[composite metadata](https://github.com/rsocket/rsocket/blob/master/Extensions/CompositeMetadata.md) (the default) and if the
...
[composite](https://github.com/rsocket/rsocket/blob/master/Extensions/CompositeMetadata.md) and
[routing](https://github.com/rsocket/rsocket/blob/master/Extensions/Routing.md) metadata by default. You can set its
...
[Composite metadata](https://github.com/rsocket/rsocket/blob/master/Extensions/CompositeMetadata.md) allows independently
...
["message/x.rsocket.routing.v0"](https://github.com/rsocket/rsocket/blob/master/Extensions/Routing.md) which it decodes to
...
| `@Payload` | Set the input payload(s) for the request. This can be a concrete value, or any producer of values that can be adapted to a Reactive Streams `Publisher` via `ReactiveAdapterRegistry` |
