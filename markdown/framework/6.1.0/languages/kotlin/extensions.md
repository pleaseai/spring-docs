...
The [Spring Framework KDoc API](https://docs.spring.io/spring-framework/docs/6.1.0/kdoc-api/) lists
...
For example, [Kotlin reified type parameters](https://kotlinlang.org/docs/reference/inline-functions.html#reified-type-parameters)
