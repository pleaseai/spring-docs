---
title: "Data Binding"
source: "ROOT:web/webmvc/mvc-data-binding.adoc"
---

<a id="mvc-data-binding"></a>

# Data Binding

[See equivalent in the Reactive stack](../webflux/data-binding.md)
...
[@ModelAttribute](mvc-controller/ann-methods/modelattrib-method-args.md) method argument.
For functional endpoints, use the `bind` method of [ServerRequest](../webmvc-functional.md#webmvc-fn-request).

> [!TIP]
> For browser applications with annotated controllers, you can use
> [@ModelAttribute methods](mvc-controller/ann-modelattrib-methods.md)
...
[@InitBinder methods](mvc-controller/ann-initbinder.md) within a controller, or
across controllers through [Controller Advice](mvc-controller/ann-advice.md).
For functional endpoints, use overloaded `ServerRequest.bind` methods.

<a id="mvc-data-binding-design"></a>

## Model Design

[See equivalent in the Reactive stack](../webflux/data-binding.md#webflux-data-binding-design)
