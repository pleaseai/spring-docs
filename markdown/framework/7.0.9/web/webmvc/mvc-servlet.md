...
(see [Servlet Config](mvc-servlet/container-config.md)), and the
equivalent `web.xml`:
...
> [`GenericWebApplicationContext`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/web/context/support/GenericWebApplicationContext.html)
> javadoc for details.
