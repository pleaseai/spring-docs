---
title: "Context Pausing"
source: "ROOT:testing/testcontext-framework/ctx-management/context-pausing.adoc"
---

<a id="testcontext-ctx-management-pausing"></a>

# Context Pausing

As of Spring Framework 7.0, an `ApplicationContext` stored in the context cache (see
[Context Caching](caching.md)) may be
