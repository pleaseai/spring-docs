---
title: "`@TestBean`"
source: "ROOT:testing/annotations/integration-spring/annotation-testbean.adoc"
---

<a id="spring-testing-annotation-beanoverriding-testbean"></a>

# `@TestBean`

[`@TestBean`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/test/context/bean/override/convention/TestBean.html)
...
1. The result of this static method will be used as the instance and injected into the field.
...
> [strategy
> for bean overrides](../../testcontext-framework/bean-overriding.md#testcontext-bean-overriding-strategy), which registers the value returned from the factory method directly
