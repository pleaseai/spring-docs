...
[`AopTestUtils`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/test/util/AopTestUtils.html) is a collection of
...
utilities, see [`AopUtils`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/aop/support/AopUtils.html) and
[`AopProxyUtils`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/aop/framework/AopProxyUtils.html).

> [!TIP]
> For guidance on using `AopTestUtils` together with `@MockitoSpyBean` when the spied
> bean is wrapped in a Spring AOP proxy, see
> [`@MockitoSpyBean`
> and Spring AOP Proxies](annotations/integration-spring/annotation-mockitobean.md#spring-testing-annotation-beanoverriding-mockitospybean-aop-proxies).

[`ReflectionTestUtils`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/test/util/ReflectionTestUtils.html) is a
...
[`TestSocketUtils`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/test/util/TestSocketUtils.html) is a simple
...
[`ModelAndViewAssert`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/test/web/ModelAndViewAssert.html), which you
...
> [Servlet API mocks](#mock-objects-servlet). For thorough integration
