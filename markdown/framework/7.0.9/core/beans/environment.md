...
The [`Environment`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/core/env/Environment.html) interface
...
The [`@Profile`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/context/annotation/Profile.html)
...
a search over a set of [`PropertySource`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/core/env/PropertySource.html)
objects. A `PropertySource` is a simple abstraction over any source of key-value pairs, and
Spring’s [`StandardEnvironment`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/core/env/StandardEnvironment.html)
...
> applications. [`StandardServletEnvironment`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/web/context/support/StandardServletEnvironment.html)
> is populated with additional default property sources including servlet config, servlet
> context parameters, and a [`JndiPropertySource`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/jndi/JndiPropertySource.html)
...
[`MutablePropertySources`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/core/env/MutablePropertySources.html)
...
The [`@PropertySource`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/context/annotation/PropertySource.html)
