...
source: "ROOT:core/beans/java/bean-annotation.adoc"
---
...
- [name](../definition.md#beans-beanname)
- [init-method](../factory-nature.md#beans-factory-lifecycle-initializingbean)
- [destroy-method](../factory-nature.md#beans-factory-lifecycle-disposablebean)
- [autowiring](../dependencies/factory-autowire.md)
...
(unless a different [bean name generator](#beans-java-customizing-bean-naming) is
...
injection. See
[the relevant section](../dependencies/factory-collaborators.md#beans-constructor-injection)
for more details.
...
[JSR-250 annotations](../annotation-config/postconstruct-and-predestroy-annotations.md) for further
details.

The regular Spring [lifecycle](../factory-nature.md) callbacks are fully supported as
well. If a bean implements `InitializingBean`, `DisposableBean`, or `Lifecycle`, their
respective methods are called by the container.

The standard set of `*Aware` interfaces (such as [BeanFactoryAware](../beanfactory.md),
[BeanNameAware](../factory-nature.md#beans-factory-aware),
[MessageSourceAware](../context-introduction.md#context-functionality-messagesource),
[ApplicationContextAware](../factory-nature.md#beans-factory-aware), and so on) are also fully supported.
...
[Bean Scopes](../factory-scopes.md) section.
...
[scoped proxies](../factory-scopes.md#beans-factory-scopes-other-injection). The easiest way to create
...
[scoped proxies](../factory-scopes.md#beans-factory-scopes-other-injection)) to our `@Bean` using Java,
...
[`ConfigurationBeanNameGenerator`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/context/annotation/ConfigurationBeanNameGenerator.html)
when bootstrapping the context or configuring component scanning. For example,
[`FullyQualifiedConfigurationBeanNameGenerator`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/context/annotation/FullyQualifiedConfigurationBeanNameGenerator.html)
...
As discussed in [Naming Beans](../definition.md#beans-beanname), it is
...
[`@Description`](https://docs.spring.io/spring-framework/docs/7.0.9/javadoc-api/org/springframework/context/annotation/Description.html)
