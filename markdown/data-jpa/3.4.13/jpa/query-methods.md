...
Generally, the query creation mechanism for JPA works as described in [Query Methods](https://docs.spring.io/spring-data/commons/reference/3.4/repositories/query-methods.html). The following example shows what a JPA query method translates into:
...
You can add custom modifying behavior by using the custom method facilities described in [Custom Implementations for Spring Data Repositories](https://docs.spring.io/spring-data/commons/reference/3.4/repositories/custom-implementations.html).
