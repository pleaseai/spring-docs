...
1. This references the application context configuration presented earlier (in the [Configuration](../envers.md#envers.configuration) section).
...
You should also check out the [Javadoc for `RevisionRepository`](https://docs.spring.io/spring-data/commons/reference/3.5.3/api/java/org/springframework/data/repository/history/RevisionRepository.html) and related classes.
