...
For a fine-grained control over selection, you can configure [`QueryEnhancerSelector`](https://docs.spring.io/spring-data/jpa/docs/4.0.4/api/org/springframework/data/jpa/repository/query/QueryEnhancerSelector.html) using `@EnableJpaRepositories`:
...
`QueryEnhancerSelector` is a strategy interface intended to select a [`QueryEnhancer`](https://docs.spring.io/spring-data/jpa/docs/4.0.4/api/org/springframework/data/jpa/repository/query/QueryEnhancer.html) based on a specific query.
