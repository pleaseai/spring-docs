...
To actually use Spring Data Envers, make one or more repositories into a [`RevisionRepository`](https://docs.spring.io/spring-data/commons/docs/3.2.12/api//org/springframework/data/repository/history/RevisionRepository.html) by adding it as an extended interface:
