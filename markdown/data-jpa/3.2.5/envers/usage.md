...
You should also check out the [Javadoc for `RevisionRepository`](https://docs.spring.io/spring-data/commons/docs/3.2.5/api//org/springframework/data/repository/history/RevisionRepository.html) and related classes.
