...
You should also check out the [Javadoc for `RevisionRepository`](https://docs.spring.io/spring-data/commons/reference/3.4/api/java/org/springframework/data/repository/history/RevisionRepository.html) and related classes.
