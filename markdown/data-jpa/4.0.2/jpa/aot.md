...
<a id="aot.repositories.jpa"></a>

## JPA Ahead of Time Repositories

AOT repositories filter methods that are eligible for AOT processing.
These are typically all query methods that are not backed by an [implementation fragment](../repositories/custom-implementations.md).
