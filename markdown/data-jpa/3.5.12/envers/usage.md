...
1. This references the application context configuration presented earlier (in the [Configuration](configuration.md#envers.configuration) section).

<a id="envers.resources"></a>
...
You should also check out the [Javadoc for `RevisionRepository`](https://docs.spring.io/spring-data/commons/reference/3.5/api/java/org/springframework/data/repository/history/RevisionRepository.html) and related classes.
