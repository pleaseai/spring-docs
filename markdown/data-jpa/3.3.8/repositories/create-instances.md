...
<a id="jpa.configuration"></a>

# Configuration

This section describes configuring Spring Data JPA through either:

- “[Annotation-based Configuration](#jpa.java-config)” (Java configuration)
- “[Spring Namespace](#repositories.create-instances.xml)” (XML configuration)

<a id="jpa.java-config"></a>
...
<a id="jpa.namespace.custom-namespace-attributes"></a>
...
<a id="jpa.bootstrap-mode.recommendations"></a>
